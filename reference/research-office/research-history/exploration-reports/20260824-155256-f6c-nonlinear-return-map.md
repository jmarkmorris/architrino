...
All twenty releases produced analyzable certified histories. Eleven passed the declared nontrivial excursion-and-turn marker, three contained a radial turn, and nine contained a cadence turn. No history coordinated both a radial and cadence turn, and no nearest direct action entered a nonzero winding cell.

The nearest reflected row had six-coordinate-and-rate RMS residual $0.44337316160666435$ at $T=0.173$. Its exact action was the proper rotation $\operatorname{diag}(-1,-1,1)$ with same-polarity module permutation $[3,2,1,0]$. It was equivalent only after that quotient action, not as a labeled history. The dominant mismatch was the positive-sector cadence rate, $1.2381455459724209$; the negative-sector radial-rate mismatch was $-0.3152027210490148$. Its lifted winding was $(0,0)$, its sixty-four release root rows were resolved with maximum multiplicity one, its minimum transmitter factor was $0.6769129443567189$, its minimum pair distance was $0.23531828047676134$, its maximum member speed was $0.5688099316774379$, and its maximum measured manifold leakage was $4.73665\times10^{-16}$ in position and $3.3604\times10^{-15}$ in velocity.

An independently rerun refinement of that row reduced the integrator step from $0.002$ to $0.001$ and the minimum step from $0.0005$ to $0.00025$. The refined residual was $0.4433731395091129$ at the same time, a change of approximately $2.21\times10^{-8}$. The dominant cadence and radial-rate mismatches persisted, all sixty-four release roots remained resolved with multiplicity one, and the history retained its cadence turn without acquiring a radial turn or nonzero winding.

Plainly: refinement confirms that the nearest row is a real, numerically resolved near miss. It does not turn the near miss into a cycle: one cadence mismatch remains larger than one, the needed radial-and-cadence coordination is absent, and the path never executes a nonzero winding.
...
Plainly: the useful negative result is a pruning rule. More resolution around this near miss is unlikely to close it; the missing behavior is coordinated breathing, not numerical accuracy.
