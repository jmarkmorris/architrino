...
**Problem:**
- Multiple Research Office roles may inspect or propose changes to the same document.
- Concurrent work can produce redundant or conflicting edits.
- The Principal Investigator must keep ownership and integration explicit.
...
3. **Consolidation Step**: Before an authorized repository edit, **each lead owner** must:
...
4. **Integration Step**: The Principal Investigator assigns one implementation owner per file and integrates accepted material once.
