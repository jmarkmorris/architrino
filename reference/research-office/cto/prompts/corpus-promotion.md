...
4. Cross-link within the corpus only. Do not link authored chapters to `reference/priorities`; restate the needed substance inside the chapter instead. Do not use Research Office workflow or Specialist names in corpus prose.
