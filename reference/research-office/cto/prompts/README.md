...
| [../../research-lead/review-packets/README.md](../../research-lead/review-packets/README.md) and `reference/research-office/research-history/review-packets/*.md` | Historical self-contained review packets. Keep in place as review artifacts, not reusable prompt templates. |
