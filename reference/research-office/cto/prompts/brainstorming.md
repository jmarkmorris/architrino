...
- Examine each question from the substrate law and geometry of $\mathbb{A}\mathbb{A}\mathbb{A}$. Connect relevant master-equation, braid, sea, Lorentz, cosmology, quantum, and reaction work through explicit assumptions, examples, limits, and thought experiments.
...
Follow the operator explanation standard for live priority capture and recommended next actions.
