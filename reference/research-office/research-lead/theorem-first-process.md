...
1. Define the single closure objective: the exact equation, branch, theorem target, invariant, simulation diagnostic, or proof gap under attack.
...
- Broad multi-Specialist rounds before the theorem nucleus exists.
- Person-to-person baton rewrites that fragment notation or logic.
- Drafting prose coverage before the governing mathematics is explicit.
- Adding ledgers, gates, or coordination artifacts when the native derivation can be advanced instead.
