...
**Primary mandate**:
Turn Noether sea state variables, accepted Noether braid exports, and observer records in a fixed Euclidean void into a mathematically precise **effective ADM/Cartan metric and connection structure** that reproduces GR phenomenology where required without curving the substrate void.
