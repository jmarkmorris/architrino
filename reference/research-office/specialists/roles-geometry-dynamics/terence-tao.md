...
- Open theorem burdens should track `reference/priorities/braid-program/priorities.md`, `reference/priorities/braid-program/work-queue.md`, `reference/priorities/braid-program/contracts/method.md`, and `reference/priorities/app-solver/contracts/evolution-contract-v1.md`; legacy `$A_0$` protocols are not current authority.
