...
For active corpus convergence, use the shared [convergence campaign](../office-of-research/cto/prompts/convergence-campaign.md). For external sources, use the [source-mining best-practice guide](source-mining-best-practice.md).
