...
The guides explain the arrangement; the procedures below retain their execution authority. Additional linked worktrees, including temporary, permanent and teaching/evaluation experiments, are [rejected](git-github-operating-guide.md#283-how-we-would-evaluate-a-worktree-workflow); use the existing local checkout and preserve any pre-existing state.
