...
- Apply targeted label polish to `theory-mapping` and `major-thinkers`, then do publication-style prose smoothing on the most important drafted chapter next.
- After that, work the chapter queue in this order:
  1. `Assembly Atlas`
