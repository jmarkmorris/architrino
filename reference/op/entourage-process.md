...
• Best strategy is a hybrid, not full baton and not full-group free-for-all.
  ...
  1. I write Draft v1 of doc.md to textbook quality baseline (definitions, regimes, equations, observables, $\mathbb{A}\mathbb{A}\mathbb{A}$ mapping goals, falsifiable checks).
