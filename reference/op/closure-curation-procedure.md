...
- **Derivation and research history.** The supported derivation belongs in the canonical explanation; the chronology of attempts remains in its research records.
...
- **Promote** the frozen derivation into its canonical `content/markdown/aaa` chapter after preparing and reviewing its reader-facing explanation. Preserve ready prose, exact mathematics, assumptions, and remaining obligations; make only necessary placement, link, and navigation adjustments during transfer.
...
## Historical Curation Example — 2026-07-10

The following snapshot records the July 10 planning distinction. Its statements about confirmed results and unfinished closures are historical, not current promotion authority. Before a new curation pass, establish the live claim status and accepted milestone from the scientific owners; apply the procedure above to that verified state.
