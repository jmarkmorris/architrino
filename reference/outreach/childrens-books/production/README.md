...
- `patterns-that-hold`: 15 Electra/Poz source images generated; landscape pages, first-draft PDF, 4:5 derivatives, 9:16 derivatives, and review contact sheet exported; QA approved by operator review.
- `the-tiny-transceivers`: 17 Electra/Poz source images generated; landscape pages, first-draft PDF, 4:5 derivatives, 9:16 derivatives, and review contact sheet exported; QA is pending operator review.
