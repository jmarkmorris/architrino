...
MANIFEST = REPO / "reference/outreach/childrens-books/production/generation-manifest.json"
...
def main() -> None:
    ...
    qa_root = REPO / "reference/outreach/childrens-books/production/qa" / args.book
