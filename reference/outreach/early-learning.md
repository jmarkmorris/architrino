...
| The room is not empty. | Noether sea | Ambient Noether braid assemblies provide the medium context for clocks, rulers, signal propagation, and observer-level reconstruction. |
