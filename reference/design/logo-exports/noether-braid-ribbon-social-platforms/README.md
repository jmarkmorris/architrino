...
- Upload assets are RGB PNG files.
- `circle-crop-preview` files are transparent preview aids for platforms that render avatars in circular masks; use the corresponding square avatar/icon file for upload unless the platform specifically asks for a circular PNG.

## Avatar And Icon Assets

- YouTube: `../../../../content/assets/images/brand/noether-braid-youtube-avatar-800x800.png`
- LinkedIn profile: `../../../../content/assets/images/brand/noether-braid-linkedin-profile-avatar-400x400.png`
- LinkedIn company logo: `../../../../content/assets/images/brand/noether-braid-linkedin-company-logo-300x300.png`
- Reddit community icon: `../../../../content/assets/images/brand/noether-braid-reddit-community-icon-512x512.png`, `../../../../content/assets/images/brand/noether-braid-reddit-community-icon-256x256.png`
- Discord server icon: `../../../../content/assets/images/brand/noether-braid-discord-server-icon-512x512.png`
- Cross-platform master: `../../../../content/assets/images/brand/noether-braid-all-platforms-avatar-master-1024x1024.png`
