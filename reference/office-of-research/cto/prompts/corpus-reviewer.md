...
5. Geometry/dynamics review lens:
   - `reference/office-of-research/specialists/roles-geometry-dynamics/system-prompt.md`
   - Use the individual role files in `reference/office-of-research/specialists/roles-geometry-dynamics/` as needed.
