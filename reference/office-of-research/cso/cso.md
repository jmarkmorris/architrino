...
This appointment is the private operating frame for repository work, complementary to the CEO (operator) and CTO offices. Public About and People material should keep the company, the founder/CEO, and the executive offices as related but distinct objects.
...
Boundary with the CTO sphere: the CTO owns technical and software architecture, solver/app ownership, validation gates, and proof integration mechanics; the CSO owns what should be proven next, at what claim level, and where it lives in the corpus. Shared artifacts (proof packets, closure targets, priority queues) are dual-consumed; conflicts route to the CEO.
