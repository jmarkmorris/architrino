...
This detailed priority file supports [Quantum Closure](priorities.md). It captures the theory opportunity in [Reality Quantum Causality](../../../content/markdown/aaa/quantum/reality-quantum-causality.md): the minimal bias-setting complex, or Decider, should become a concrete basin-control theorem target rather than a loose analogy.
...
\mathcal{P}_u
=
\{B_1(u),B_2(u),\dots,B_k(u)\}
\subset
\mathcal{X}_{\Gamma}.
$$

The decision act is a physical update $u_0\to u_1$ that changes the measure of later outcomes:
...
| --- | --- |
| [reality-quantum-causality](../../../content/markdown/aaa/quantum/reality-quantum-causality.md) | The Decider section receives a basin-control equation, energy ledger, and minimality status. |
| [measurement-ontology](../../../content/markdown/aaa/quantum/measurement-ontology.md) | Bias-setting is separated from record formation, so not every internal basin shift is called measurement. |
| [wavefunction-ontology](../../../content/markdown/aaa/quantum/wavefunction-ontology.md) | Effective probability amplitudes are related to controllable basin measures rather than observer ignorance alone. |

## Failure Modes

- The proposed Decider reduces to ordinary uncontrolled thermal noise.
