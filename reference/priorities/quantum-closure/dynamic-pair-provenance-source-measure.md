...
| photon-measurement-bell-gates (legacy-braid ref: `braid-angular-momentum-spin/photon-measurement-bell-gates.md`) | Angular-momentum, Stern-Gerlach, photon Gate B, and Bell placement. | Supplies the quantum-closure side of the pair-provenance source-measure contract. |
