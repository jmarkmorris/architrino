...
- Current tracker next build burden remains `build-native-wake-history-and-boundary-residual-fixture`: extend the native zombie-solver contract and bridge for retained wake/interaction rows, row-conservation counts, boundary-to-central residual rows, and acceleration-contribution diagnostics without app-local physics.
