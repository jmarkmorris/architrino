...
- **Dependency / duplicate:** this is the same recurring binding-pin issue recorded in the former second- and third-pass addenda. Keep one owner under `app-solver`; do not duplicate it in the Borg work queue.
