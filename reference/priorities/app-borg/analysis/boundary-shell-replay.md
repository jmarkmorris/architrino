...
- Source requirements: [requirements-and-design](../contracts/requirements-and-design.md)
- Source manifest: [borg-dataset-manifest.v1](../contracts/borg-dataset-manifest.v1.md)
