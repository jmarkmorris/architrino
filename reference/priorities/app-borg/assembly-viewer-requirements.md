...
- Classify each source as a named family member, boundary member, frequency variant, or parameter variant. A boundary member does not count as a new braid family, and a frequency or radius change does not acquire a new family name merely by receiving a catalog entry.
