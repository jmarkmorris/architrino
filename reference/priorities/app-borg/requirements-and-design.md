...
The current boundary records reuse the illustrative spindle's declared radii, angular frequency, phases, polarity assignments, record interval, and frame. The planar record changes only the three canon-defined cap angles to $0$; the full-cap record changes only those angles to $\pi/2$. This is a controlled boundary construction, not a numerical selection of a new braid family.
