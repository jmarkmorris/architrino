...
The Supergalactic Plane (SGP) is one of the most prominent features of the local cosmic web, a flattened concentration of galaxy clusters, groups, and filaments extending roughly a billion light-years across. Identified by Gérard de Vaucouleurs in the 1950s from the spatial distribution of bright galaxies in the Shapley–Ames Catalog, it remains the defining structure of the local large-scale universe.

The principal observational facts are:

- The Virgo Cluster, the Great Attractor region (Norma–Centaurus), the Coma Cluster, the Perseus–Pisces Supercluster, the Hydra Cluster, and the Shapley Concentration all lie close to the SGP.
- The SGP is nearly perpendicular to the Milky Way's disk (inclination $\approx 84°$).
- The plane separates two large underdensities: the Northern and Southern Local Supervoids.
- Giant elliptical galaxies dominate the SGP; bright disk (spiral) galaxies are underrepresented in the densest regions of the plane.
- Beyond $\sim$40 $h^{-1}$ Mpc the structure grades into the broader cosmic web of filaments and sheets rather than persisting as a single coherent pancake.

Standard $\Lambda$CDM structure formation accounts for the SGP as a natural outcome of anisotropic gravitational collapse: in a Gaussian random density field, the first axis to go nonlinear produces a sheet (the Zel'dovich pancake mechanism), and subsequent accretion along filaments feeds the clusters embedded in that sheet. The morphological mix—ellipticals in the dense plane, spirals in lower-density surroundings—follows from the standard galaxy-formation paradigm in which frequent mergers in cluster environments transform disks into ellipticals.
...
The SGP is not created by this process—its origin is the primordial density field—but SMBH jet feedback may sharpen and maintain the sheet–void contrast over cosmic time. This is a quantitative prediction: the energy content of the voids flanking the SGP should correlate with the integrated jet power of the clusters on the plane.

### Testable consequences

The feedback-sharpening hypothesis yields three observationally accessible predictions:
...
| Elliptical dominance on the plane | Merger-driven decoherence of Noether braid angular-momentum alignment | Consistent re-expression of standard environmental transformation |
