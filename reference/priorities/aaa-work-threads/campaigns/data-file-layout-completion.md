...
**AWT-015 is complete, September 12, 2026.** Both layout stages and the subsequent source-binding, runtime and generated-dependency repairs meet the [recorded completion boundary](../evidence/awt-015-post-merge-repair-2026-09-12.md#completion). Full ordinary Node passes 2,716 tests with one declared optional skip, slow Node passes 124/124, shared-venv Python passes 1,685/1,685, and maintenance-inclusive integrity passes all 36 required checks. A fresh 32-row destination check and exact former-path search across the declared consumer scope pass. The live queue item is removed; the [work log](../work-log.md#2026-09-12--awt-015-complete) preserves closure. Earlier instructions below retain original campaign context and do not authorize new work or Git publication.
