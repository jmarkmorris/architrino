...
| [spacetime-models-and-noether-sea.md](../../../content/markdown/aaa/theory-bridges/spacetime-models-and-noether-sea.md) | Add Maldacena as boundary-data and scale-coordinate discipline. | Must avoid importing AdS/CFT ontology. |
