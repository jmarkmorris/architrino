...
- [reference/priorities/mapping-benchmarks/benchmarks/cosmological-redshift-distance-ladder.md](../../mapping-benchmarks/benchmarks/cosmological-redshift-distance-ladder.md)
- [reference/priorities/mapping-benchmarks/benchmarks/effective-metric-deformation.md](../../mapping-benchmarks/benchmarks/effective-metric-deformation.md)
- [reference/priorities/mapping-benchmarks/benchmarks/lorentz-invariance-test-suite.md](../../mapping-benchmarks/benchmarks/lorentz-invariance-test-suite.md)
...
| Captured body-frame orbit | [asymmetric counter-breathing representative Geometry](../../braid-program/configurations/f6c-geometry.md#how-six-captured-orbits-could-enter-a-face-calculation): $\boldsymbol\xi_e$ in orbital area rate. | Candidate $\boldsymbol\xi_{\mathrm{cap},e}$, with no initial matches. Check origin/frame against internal displacement before deciding whether they should share a family. |
...
| Muon-decay parameter | [Weak Flavor Event Ledger](../../mapping-standard-model/benchmarks/weak-flavor-event-ledger-benchmark-packet.md): $\xi$ in the stated muon-spectrum benchmark. | Explicit comparison mapping, or $\xi_{\mathrm{mu}}$ in mixed working formulas; no initial qualifier matches. Keep observational-constraint status, not a native premise. |
| Wave-energy flux vector | [Gravitational Waves](../../mapping-benchmarks/benchmarks/gravitational-waves.md): $\xi^\beta$ in a boundary flux. | Candidate $\xi_{\mathrm{gw}}^\beta$, with no initial matches. Identify time-flow and normalization; do not assume it is the horizon vector. |
