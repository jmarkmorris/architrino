...
- **AWT-015 residual validation:** paused for operator repository actions at the [September 12 checkpoint](evidence/awt-015-post-merge-repair-2026-09-12.md#checkpoint-results). Current caller/runtime and original-source replay repairs pass 102 focused controls; full Node/Python gates retain three test-boundary issues, the pending OPS-030 decision and concurrent corpus/generated drift. The owned-compute closeout is clear. The [live queue](work-queue.md#awt-015--data-file-layout-completion) retains the full completion boundary; no scientific status or ranking changes.
