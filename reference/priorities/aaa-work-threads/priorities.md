...
| ---: | ------------- | ------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------- | ---: | ------: | -------: | -------: | -----: | ----: | ---: | --------: | ---: | ----: | ---: | ---: |
|    1 | Workstream    | [`master-equation-closure`](../master-equation-closure/master-equation-closure.md)                              | Tractable master-equation stack for Lorentz / GR bridge, quantum, and core closure            | 10.0 |    1.55 |      -56 |     1.56 |   1.50 | 36.27 |    6 |         5 |    5 |     6 |  5.5 | 6.59 |
|    2 | Workstream    | [`simulations`](../simulations/simulations.md)                                                                  | Simulations, regularization, convergence, and shell numerics                                  |  8.8 |    1.45 |      -67 |     1.67 |   1.25 | 26.64 |    5 |         3 |    4 |     5 |  4.1 | 6.50 |
|    3 | Workstream    | [`proof-programs`](../proof-programs/proof-programs.md)                                                         | Proof programs: breather certificate and planar bridge closure                                | 10.0 |    1.55 |      -42 |     1.42 |   1.25 | 27.51 |    5 |         4 |    3 |     5 |  4.3 | 6.40 |
|    4 | Workstream    | [`mass-map`](../mass-map/mass-map.md)                                                                           | Noether-core stability, shielding, exposure, medium response, and first mass map              | 10.0 |    1.55 |      -56 |     1.56 |   1.15 | 27.81 |    5 |         4 |    5 |     6 |  4.9 | 5.68 |
|    5 | Workstream    | [`tri-binary-causal-closure`](../tri-binary-causal-closure/tri-binary-causal-closure.md)                        | Tri-binary causal closure synthesis, photon/QED gate, and transition routing                  | 10.0 |    1.60 |      -67 |     1.67 |   1.08 | 28.86 |    5 |         5 |    6 |     6 |  5.4 | 5.34 |
|    6 | Workstream    | [`angular-momentum-spin`](../angular-momentum-spin/angular-momentum-spin.md)                                    | Fundamental angular-momentum, spin, photon Gate B, measurement, and Bell prerequisites        |  9.5 |    1.45 |      -67 |     1.67 |   1.05 | 24.15 |    5 |         5 |    5 |     6 |  5.2 | 4.64 |
|    7 | Shared packet | [`exposure-quotient-theorem`](../mass-map/exposure-quotient-theorem.md)                                         | Shared sector exposure / quotient theorem                                                     |  9.5 |    1.65 |      -56 |     1.56 |   0.75 | 18.34 |    4 |         4 |    4 |     5 |  4.2 | 4.37 |
|    8 | Shared packet | [`residual-routing-event-ledger`](../tri-binary-causal-closure/residual-routing-event-ledger.md)                | Shared residual-to-channel routing and event-ledger theorem                                   |  9.5 |    1.70 |      -67 |     1.67 |   0.65 | 17.53 |    4 |         4 |    4 |     5 |  4.2 | 4.17 |
|    9 | Shared packet | [`pressure-dependent-noether-sea-constitutive-response`](../mass-map/pressure-dependent-noether-sea-constitutive-response.md) | Shared pressure-dependent Noether-Sea constitutive-response packet                            |  8.8 |    1.50 |      -56 |     1.56 |   0.95 | 19.56 |    4 |         5 |    5 |     5 |  4.8 | 4.08 |
|   10 | Shared packet | [`transfer-operator-basin-measure`](../quantum-closure/transfer-operator-basin-measure.md)                      | Shared transfer-operator and basin-measure theorem                                            |  9.0 |    1.70 |      -67 |     1.67 |   0.90 | 23.00 |    5 |         7 |    5 |     7 |  6.1 | 3.77 |
|   11 | Workstream    | [`validation-gates`](../validation-gates/validation-gates.md)                                                   | Cross-sector acceptance intersections and no-go routing                                       |  8.5 |    1.65 |      -67 |     1.67 |   0.65 | 15.22 |    4 |         4 |    6 |     5 |  4.6 | 3.31 |
|   12 | Workstream    | [`standard-model-closure`](../standard-model-closure/standard-model-closure.md)                                 | Remaining Standard Model assembly gaps, flavor mixing, confinement, weak, and nuclear closure |  8.5 |    1.30 |      -67 |     1.67 |   0.95 | 17.53 |    6 |         6 |    6 |     7 |  6.2 | 2.83 |
|   13 | Workstream    | [`dyadic-lock`](../dyadic-lock/dyadic-lock.md)                                                                  | Dyadic resonance lock reduced-map program                                                     |  7.0 |    1.25 |      -16 |     1.16 |   0.95 |  9.64 |    4 |         4 |    4 |     5 |  4.2 | 2.30 |
|   14 | Workstream    | [`animator`](../animator/animator.md)                                                                           | Scene animator and visual reasoning surface                                                   |  7.0 |    1.20 |      -15 |     1.15 |   0.85 |  8.21 |    5 |         4 |    4 |     4 |  4.3 | 1.91 |
|   15 | Workstream    | [`strong-field-closure`](../strong-field-closure/strong-field-closure.md)                                       | Black-hole / strong-field quantitative closure                                                |  6.0 |    1.20 |      -67 |     1.67 |   0.85 | 10.22 |    6 |         6 |    6 |     7 |  6.2 | 1.65 |
|   16 | Workstream    | [`quantum-closure`](../quantum-closure/quantum-closure.md)                                                      | Deferred Born-rule / quantum closure with Bell hard tests                                     |  6.0 |    1.35 |      -67 |     1.67 |   0.80 | 10.82 |    6 |         8 |    7 |     8 |  7.3 | 1.48 |
|   17 | Op queue      | [`chapter-authoring`](../chapter-authoring/chapter-authoring.md)                                                | Unified chapter authoring queue and source-material mining                                    |  4.0 |    1.10 |      -15 |     1.15 |   0.75 |  3.80 |    4 |         2 |    3 |     2 |  2.7 | 1.41 |
|   18 | Workstream    | [`cosmology-closure`](../cosmology-closure/cosmology-closure.md)                                                | Cosmology transfer-function closure                                                           |  3.5 |    1.20 |      -67 |     1.67 |   0.80 |  5.61 |    6 |         7 |    7 |     8 |  7.0 | 0.80 |
...
| `ellipsoid` | [ellipsoid.md](../ellipsoid/ellipsoid.md) | Residual routing surface for old ellipsoid notes plus the Ideal Core app idea. | Shape-plus-scale deformation is already owned by the corpus; retire this candidate after raw notes and app routing have destinations. |
...
- Workstream `master-equation-closure`: remains ranked first after the 2026-05-20 rescore because the priority surface is still equation-engine-first. The delayed-interior characteristic-tail kernel has endpoint-clear normalization, receiver-gradient cancellation, and energy/momentum/angular-momentum wake-history increments fixed at the local action-kernel level. The sampled VP-1 spiral ledger now gives a concrete failing non-circular candidate: positive Jacobian floors and finite memory survive, but the weighted tangential-drive row is positive, so the active work is a stronger spiral/non-circular branch certificate or obstruction before Lorentz / GR bridge derivation.
- Workstream `simulations`: remains second by ROI because it is the lowest-intuition way to discipline the equation engine. The campaign object and $A_0$ protocol surface now carry classified and event-locked self-root `fold-layer` diagnostics, accepted-history source coverage, a fail-closed validation observer, and a direct fold-layer-locked one-period runner. The May 18 compact-fixture run executed `963815` retained steps without trajectory abort, then failed state/root/phase/speed/drift/energy-like residual closure while preserving the lock ledger. The next simulation work is a corrected one-period branch-equation attempt driven by the residual-balance ledger and emitted $\mathbf{d}_\ell(t)$ correction packet, not another replay or budget-reduction pass.
- Workstream `proof-programs`: remains top-three because potential/action closure still carries a major validated-closure deficit and certified branches are the first hard evidence that the dynamics have nonempty structure. The dual-mollified master-equation law and doubled four-arc itinerary parity pass are completed state. The current executable gate is now certified row-tube/source-slice coverage or direct row quadrature for the finite fold impulse ceiling before the sixteen fold-layer rows and six fold-adjacent parent-boundary leftovers can pass.
- Workstream `mass-map`: the $A_0$ Tier 0 / Tier 1 scaffold now emits quotient coordinates, residuals, blocked accepted-history output, weak-retained fail-closed behavior, weak-emitter fail-closed behavior, direct-root branch retention, branch surplus tracking, an event-local fold-layer lock, a source-coverage-passing fold-layer-locked attempt packet, a direct one-period failure, a scalar relation-weight no-go, sampled forcing, a Fourier correction packet, and center-preserving waveform replay. The active calculation is the corrected one-period residual closure for the non-circular carrier correction $\mathbf{d}_\ell(t)$ or a richer branch-native interaction basis before monodromy, eta-ladder, energy, shielding, finite envelope-Hessian extraction, or accepted-history emission.
...
- App-local `ideal-core`: keep the local Lorentz-core lesson queue active in its own file, but do not treat it as global rank 1. It becomes globally ranked only if the app is selected as a validation, authoring, or proof-inspection dependency.
...
1. Drive `master-equation-closure` first: consume the normalized delayed-interior characteristic-tail Noether increments on real branch charts, use the VP-1 sampled failure to select or certify the next non-circular branch candidate, then extend the tractable master-equation stack until Lorentz / GR bridge work, quantum closure, and first-principles mass work have equations rather than only routing language.
2. Use simulation work as the low-intuition path to make proof certificates, convergence checks, regularization choices, and shell numerics executable enough to discipline the theory queues.
3. Close the current breather pre-ledger obstruction: certify row-tube/source-slice coverage or direct quadrature for the finite fold impulse ceilings $I^{\mathrm{fold}}_{\eta,\epsilon_c,\Sigma}$ on $\Sigma_1,\ldots,\Sigma_4$ from a dual-mollified acceleration bound $A_{\Sigma,\eta,\epsilon_c}$ and transversality constant $C_\Sigma$; then promote the fold-layer rows and six fold-adjacent parent-boundary leftovers into accepted rows, or reject the cosine template before branch-chart work.
4. Rerun the residual-balanced $A_0$ branch-equation correction now that the Fourier correction packet and center-preserving body-update waveform are specified: use `a0-tier1-residual-balance-ledger/v1` and the emitted $\mathbf{d}_\ell(t)$ packet to test corrected one-period residual closure, and only then attempt quotient monodromy / $\Delta_{\mathbf{k}}$, eta-ladder persistence, and finite envelope-Hessian rows for the compensated-family scanner.
