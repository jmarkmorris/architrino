...
- **Research insight recovery, focused follow-up complete:** the [assessment and completed entry improvements](evidence/research-insight-recovery-pilot-2026-09-09.md#authorized-follow-up-constitutive-response-and-entry-improvements) preserve developed documents and topic collections while clarifying the Lattice Lab cancellation result and FSC disposition. The constitutive-response comparison finds that BP-005's nonlinear and collective-transport leads are routed but not answered by the small static pressure test. Two exact scope paragraphs for the pressure packet remain proposed for discussion; no scientific queue, rank, promotion, relocation, or consolidation changes.
