...
| U6 | [`strong-field hypothesis bank`](../strong-field-closure/hypothesis-bank.md) | Can stay as a watchlist under `strong-field-closure`, separate from quantitative closure. |
| U7 | [`deferred`](../deferred/legacy-insights.md) | Archive indexing and parking-lot cleanup are organizational. |
| U8 | [`3x3`](../deferred/3x3/3x3.md) | Deferred binary-slot matrix notes can remain parked unless a target corpus destination is chosen. |
| U9 | [`phenomenological-heuristics`](../dyadic-lock/phenomenological-heuristics.md) | Archive/source material for dyadic lock can stay sibling reference material rather than an active reduced-map proof. |
...
| U6 | `strong-field hypothesis bank` | [hypothesis-bank.md](../strong-field-closure/hypothesis-bank.md) | Strong-field and Noether swarm hypothesis watchlist. | Merged under `strong-field-closure`; not a ranked top-level workstream. |
| U7 | `deferred` | [legacy-insights.md](../deferred/legacy-insights.md) | Archive and parking lot for non-current material. | Needs a deferred index later. |
| U8 | `3x3` | [3x3.md](../deferred/3x3/3x3.md) | Deferred binary-slot matrix note. | Keep deferred unless a target $\mathbb{A}\mathbb{A}\mathbb{A}$ document is selected. |
| U9 | `phenomenological-heuristics` | [phenomenological-heuristics.md](../dyadic-lock/phenomenological-heuristics.md) | Dyadic resonance lock archive source. | Keep as sibling archive unless a shared archive convention is adopted. |
