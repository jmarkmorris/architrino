...
Status. Team-agent worker packet for the VP-1 root-transport residual lane. This packet consumes [spiral-branch-chart-certificate](spiral-branch-chart-certificate.md), [spiral-vp1-root-jacobian-proof](spiral-vp1-root-jacobian-proof.md), and [spiral-vp1-inactive-memory-proof](spiral-vp1-inactive-memory-proof.md). It stays inside the VP-1 candidate history and does not edit the executable runner or generated report.
