# Spiral A1 Post-Benchmark User-Facing Recommendations

Status. Reset after the receiver-normal Master EOM correction.

Current recommendation. Keep A1 out of reader-facing benchmark-success prose
until a receiver-normal branch table exists. A1 may appear only as a retained
topology restart target whose force/action rows are pending.
