...
- Mass and inertia material, including [mass-map](../braid-mass-response-map/braid-mass-response-map.md) and [Particle Masses](../../../content/markdown/aaa/assemblies/particle-masses.md), defines assembly-level internal energy, shielding, and medium-response tensor targets. Those sources do not declare $\kappa q_1^2$ relative to $r_\ast^3\Omega^2$ for VP-1.
