...
| [spiral-a1-retained-memory-profile](spiral-a1-retained-memory-profile.md) | Constructive turn-center retained-memory witness. | Gives a positive $C^2$ inverse-rate profile that retains the old A1 turn-center offsets, restores the constant-rate source-speed factors at those offsets, and satisfies $B_r=-0.005994753659205029$, $T_0=-0.007585821333186402$, and $T_0/\Gamma=-1.0072663739809324$; it is a pointwise search target, not an interval branch certificate. |
