...
| [lorentz-invariance-test-suite](../mapping-benchmarks/lorentz-invariance-test-suite.md) | RMS rows separate Michelson-Morley, Kennedy-Thorndike, and Ives-Stilwell residuals, so two-way isotropy cannot hide clock/ruler coefficient splits. |
...
| [gravitational-redshift-clock-tests](../mapping-benchmarks/gravitational-redshift-clock-tests.md) | Precision clock comparisons use the dressed observer speed $c_0=c_{\text{eff}}(\infty)$ unless a primitive branch calculation proves a special identification with $c_f$. |
| [shapiro-time-delay](../mapping-benchmarks/shapiro-time-delay.md), [gravitational-lensing](../mapping-benchmarks/gravitational-lensing.md), and [perihelion-precession](../mapping-benchmarks/perihelion-precession.md) | PPN rows must bind redshift, Shapiro delay, lensing, and orbital phase to one effective metric response. |
