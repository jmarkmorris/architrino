...
MEC-008 is `In progress` and owns that reachability question. Its analytical owner is [coincide-or-not.md](coincide-or-not.md), which derives the symmetric pair-center secular sign, the sign-indefinite general absolute-frame correction, a conditional populated invariant tube, a uniform-sub-field radial first-exit obstruction, a locally affine root-existence classification, a bounded-history self-root theorem, a regular-chart DDE lemma, the local same-transmitter chord expansion, and the regularization reparameterization obstruction. It also records the bounded three-architrino turn arc and the failed four-body causal-shadow diagnostics at their exact evidence grades.
