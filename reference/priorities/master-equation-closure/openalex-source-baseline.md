# OpenAlex Source Baseline for Master-Equation Closure
...
1. For `circular_asymptotics`, require branchwise asymptotics to report whether the reduced formula is delayed-state or derivative-sensitive on the retained history chart.
