...
**Depends on:** [temperature](../mapping-benchmarks/benchmarks/temperature.md), SF-001.
...
Prove and scope the conditional barrel lemma in [terminal-barrel-horizon-release-scope-decision.md](decisions/terminal-barrel-horizon-release-scope-decision.md): a common-cadence spindle with every layer on the $c_f$ rail has one cylindrical radius, while dynamical existence and retention remain separate.
