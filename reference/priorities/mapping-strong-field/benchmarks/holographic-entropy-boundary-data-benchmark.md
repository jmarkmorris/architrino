...
| [entropy.md](../../mapping-benchmarks/benchmarks/entropy.md) | Keep the RT minimal-surface target and $\eta_H$ as an entropy benchmark. | Must define the native label ensemble before claiming area scaling. |
