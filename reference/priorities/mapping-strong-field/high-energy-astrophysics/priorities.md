...
- Kind: `mapping-strong-field supporting packet`
...
4. `geometry_handoff_map` - Route event-scale clues into [mapping-strong-field](../priorities.md), [EQ-07A](../../mapping-equations/analysis/eq-07a-compact-star-support-collapse-scale-residual.md), [EQ-07B](../../mapping-equations/analysis/eq-07b-black-hole-accretion-jet-release-horizon-thermodynamics.md), [EQ-07C](../../mapping-equations/analysis/eq-07c-black-hole-horizon-interface-noether-braid-map.md), [EQ-11A](../../mapping-equations/analysis/eq-11a-gravitational-wave-source-recovery.md), [EQ-23A](../../mapping-equations/analysis/eq-23a-stellar-explosive-nucleosynthesis-shock-reaction-networks.md), [EQ-25 CMB thermalization](../../mapping-equations/analysis/eq-25-theta-therm-cmb-source-field-map.md), radiation, cosmology, and nuclear / Standard Model closure without promoting observations as native geometry. Status: `pending`. Depends on: `source_window_carrier_map`.
...
- Do not duplicate strong-field closure. This bucket routes high-energy event evidence; [mapping-strong-field](../priorities.md) owns native horizon-interface and compact-region geometry.
...
- [mapping-strong-field](../priorities.md)
...
- [mapping-nuclear-atomic-molecular](../../dormant-deferred/mapping-nuclear-atomic-molecular/priorities.md)
