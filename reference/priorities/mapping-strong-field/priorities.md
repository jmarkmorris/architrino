...
| [holographic-entropy-boundary-data-benchmark.md](holographic-entropy-boundary-data-benchmark.md) | Source-mined RT/Maldacena benchmark packet for horizon-wrapping entropy, finite boundary data, and scale-coordinate discipline. | [black-holes](../../../content/markdown/aaa/spacetime/black-holes.md), [entropy](../mapping-benchmarks/entropy.md), [spacetime-models-and-noether-sea](../../../content/markdown/aaa/philosophy-history/theory-bridges/spacetime-models-and-noether-sea.md) |
| [embedded-horizon-interface-boundary-conditions.md](embedded-horizon-interface-boundary-conditions.md) | SF-001 finite-data contract for an embedded native horizon-interface problem, including typed inputs, component residuals, failure codes, output schema, and consumer gates. | Supplies the priority contract consumed by SF-002 through SF-004; it does not promote a horizon solution into the corpus. |
...
| --- | --- | --- | --- |
| `embedded_boundary_conditions` | [embedded-horizon-interface-boundary-conditions.md](embedded-horizon-interface-boundary-conditions.md) | [black-holes](../../../content/markdown/aaa/spacetime/black-holes.md) and [singularity-resolution](../../../content/markdown/aaa/spacetime/singularity-resolution.md) | Complete at priority-contract grade: horizon-interface solutions are formulated as one embedded Noether sea boundary problem with named $\rho_{\text{NS}}$, canonical $\Sigma_{\text{sea}}$, $\mathbf{u}_{\text{sea}}$, $\Lambda_{\text{NS}}^H$, and $\partial\Omega$ data. A scientific solution remains open. |
...
| `horizon_entropy_packet` | [horizon-interface-label-entropy-enumerator-contract.md](horizon-interface-label-entropy-enumerator-contract.md) and [holographic-entropy-boundary-data-benchmark.md](holographic-entropy-boundary-data-benchmark.md) | [black-holes](../../../content/markdown/aaa/spacetime/black-holes.md) and [singularity-resolution](../../../content/markdown/aaa/spacetime/singularity-resolution.md) | The derived counting contract is complete. Scientific promotion requires an admitted source-bound $\mathcal O_H$, terminal enumeration of $\Lambda_{\mathrm{NS}}^H$ over a declared block sequence, an independently checked area coefficient, and same-record Page-compatible release accounting. |
...
- Use the completed [SF-001 embedded boundary contract](embedded-horizon-interface-boundary-conditions.md) for $F_H[\rho_{\text{NS}},\Sigma_{\text{sea}},\mathbf{u}_{\text{sea}},\Lambda_{\text{NS}}^H;\partial\Omega]=0$; no observer-level strong-field prediction may advance until one source-bound carrier fills its finite history, wake, ledger, label, embedding, and provenance rows.
