...
The locally ranked strong-field tasks, deferred quantitative obligations, and watchlist rows live in [work-queue.md](work-queue.md).

The completed SF-014 [hypothesis-bank review](brainstorming.md#hypothesis-bank-review--2026-09-02) keeps the terminal barrel, horizon alignment, `4:2:1`, dark-sector release, maximal-curvature continuation, packed-interior, mechanism-discriminator, and planarity ideas at their exact evidence grades. It changes no scientific status and promotes no hypothesis.
...
| [holographic-entropy-boundary-data-benchmark.md](benchmarks/holographic-entropy-boundary-data-benchmark.md) | Source-mined RT/Maldacena benchmark packet for horizon-wrapping entropy, finite boundary data, and scale-coordinate discipline. | [black-holes](../../../content/markdown/aaa/spacetime/black-holes.md), [entropy](../mapping-benchmarks/benchmarks/entropy.md), [spacetime-models-and-noether-sea](../../../content/markdown/aaa/philosophy-history/theory-bridges/spacetime-models-and-noether-sea.md) |
| [embedded-horizon-interface-boundary-conditions.md](contracts/embedded-horizon-interface-boundary-conditions.md) | SF-001 finite-data contract for an embedded native horizon-interface problem, including typed inputs, component residuals, failure codes, output schema, and consumer gates. | Supplies the priority contract consumed by SF-002 through SF-004; it does not promote a horizon solution into the corpus. |
| [observer-level-strong-field-projection-contract.md](contracts/observer-level-strong-field-projection-contract.md) | SF-002 observer projection contract with a gated six-component prediction vector, instrument records, same-record residuals, and falsifiers. | Supplies structural constraints and consumer gates only; numerical prediction remains blocked on an accepted source-bound horizon-interface carrier. |
| [horizon-interface-label-entropy-enumerator-contract.md](contracts/horizon-interface-label-entropy-enumerator-contract.md) | SF-003 admitted quotient ensemble, extendable block-label family, exact area-coefficient reduction, terminal-enumerator output, and Page/identification falsifiers. | Supplies a derived counting contract only; no label enumeration, coefficient, thermal limit, or Page curve is established. |
| [EQ-07C black-hole horizon-interface map](../mapping-equations/analysis/eq-07c-black-hole-horizon-interface-noether-braid-map.md) | Working black-hole-proper carrier contract that keeps terminal alignment, light-ring/null-orbit recovery, and planar-photon recovery separate until one source-backed carrier derives coincidence. | [black-holes](../../../content/markdown/aaa/spacetime/black-holes.md), [singularity-resolution](../../../content/markdown/aaa/spacetime/singularity-resolution.md), [general-relativity](../../../content/markdown/aaa/spacetime/general-relativity.md) |
...
| --- | --- | --- | --- |
| `embedded_boundary_conditions` | [embedded-horizon-interface-boundary-conditions.md](contracts/embedded-horizon-interface-boundary-conditions.md) | [black-holes](../../../content/markdown/aaa/spacetime/black-holes.md) and [singularity-resolution](../../../content/markdown/aaa/spacetime/singularity-resolution.md) | Complete at priority-contract grade: horizon-interface solutions are formulated as one embedded Noether sea boundary problem with named $\rho_{\text{NS}}$, canonical $\Sigma_{\text{sea}}$, $\mathbf{u}_{\text{sea}}$, $\Lambda_{\text{NS}}^H$, and $\partial\Omega$ data. A scientific solution remains open. |
| `observer_predictions` | [observer-level-strong-field-projection-contract.md](contracts/observer-level-strong-field-projection-contract.md) | [black-holes](../../../content/markdown/aaa/spacetime/black-holes.md), [General Relativity](../../../content/markdown/aaa/spacetime/general-relativity.md), and [gravitational-waves](../../../content/markdown/aaa/spacetime/gravitational-waves.md) | Contract complete; promotion remains blocked until an accepted source-bound embedded carrier produces at least one numerical observer row with frozen nuisance data and an independent comparison. |
| `horizon_entropy_packet` | [horizon-interface-label-entropy-enumerator-contract.md](contracts/horizon-interface-label-entropy-enumerator-contract.md) and [holographic-entropy-boundary-data-benchmark.md](benchmarks/holographic-entropy-boundary-data-benchmark.md) | [black-holes](../../../content/markdown/aaa/spacetime/black-holes.md) and [singularity-resolution](../../../content/markdown/aaa/spacetime/singularity-resolution.md) | The derived counting contract is complete. Scientific promotion requires an admitted source-bound $\mathcal O_H$, terminal enumeration of $\Lambda_{\mathrm{NS}}^H$ over a declared block sequence, an independently checked area coefficient, and same-record Page-compatible release accounting. |
| `release_channel_selection` | This file and residual-routing-event-ledger | [black-holes](../../../content/markdown/aaa/spacetime/black-holes.md) | Jets, diffuse outflow, dark-sector escape, and candidate dark-sector photon-like modes are separated as release channels with event-ledger and information-accounting consequences. |
...
| `hypothesis_bank_review` | [brainstorming.md](brainstorming.md) | [black-holes](../../../content/markdown/aaa/spacetime/black-holes.md), [singularity-resolution](../../../content/markdown/aaa/spacetime/singularity-resolution.md), and [nested-shell-braid-dynamics](../../../content/markdown/aaa/noether-braid/zero-axial-offset-three-binary-dynamics-and-interpretation.md#a1-dynamics) | Preserved hypotheses remain explicitly non-foundational until they acquire a boundary condition, equation, simulation target, or observable. |
...
- Use the completed [SF-001 embedded boundary contract](contracts/embedded-horizon-interface-boundary-conditions.md) for $F_H[\rho_{\text{NS}},\Sigma_{\text{sea}},\mathbf{u}_{\text{sea}},\Lambda_{\text{NS}}^H;\partial\Omega]=0$; no observer-level strong-field prediction may advance until one source-bound carrier fills its finite history, wake, ledger, label, embedding, and provenance rows.
- If a black-hole interior branch is modeled as a self-hit regime, certify it with the same self-hit wall used elsewhere: same-transmitter root existence, transversality, nonzero transmitter-side floor, same-record transmitter-side acceleration weight, separate signed root playback, regularization convention, and a bounded energy-like branch functional under the strong-field boundary data. Otherwise retain the self-hit interior reading as a candidate regime map rather than a promoted strong-field mechanism.
