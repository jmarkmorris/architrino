...
This is the active-development workbench for [Nested Shell Braid Causal Closure](nested-shell-braid-causal-closure.md). Its job is to make the proof ladder explicit before the synthesis is promoted into deployed or textbook-facing material.
...
The next pass over [Nested Shell Braid Causal Closure](nested-shell-braid-causal-closure.md) should check the chapter against this dependency map in order:
