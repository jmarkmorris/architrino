...
| [nn-corridor-overlap-first-evaluation.md](nn-corridor-overlap-first-evaluation.md) | First reduced numerical evaluation of $\Delta E_{\mathrm{corr}}^{NN}(r)$ for $p+n$ and $p+p$ channels with orientation, branch-interface mismatch, Coulomb rows, and native $\mathcal B_{ij}^{\mathrm{int}}$ channel extraction included. | [nuclear-binding](../../../content/markdown/aaa/nuclear-atomic/nuclear-binding.md), [nucleon-structure](../../../content/markdown/aaa/nuclear-atomic/nucleon-structure.md), [mesons](../../../content/markdown/aaa/assemblies/mesons/mesons.md) |
