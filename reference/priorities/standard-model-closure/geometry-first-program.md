...
For sector visibility, this packet consumes the shared exposure-quotient theorem (legacy-braid ref: `braid-mass-response-map/exposure-quotient-theorem.md`). It owns the Standard Model geometry, color exceptionality, and confinement-facing exposure questions; the shared packet owns the projection/quotient grammar that decides which internal geometry becomes visible to mass, weak, color, photon, or vector-corridor sectors.
