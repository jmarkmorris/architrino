...
This workstream owns the remaining Standard Model-facing closure tasks that are not already carried by mass-map (legacy-braid ref: `braid-archive/braid-mass-response-map/priorities.md`), angular-momentum-spin (legacy-braid ref: `braid-archive/braid-angular-momentum-spin/priorities.md`), or [quantum-closure](../quantum-closure/priorities.md).
