...
This workstream owns the remaining Standard Model-facing closure tasks that are not already carried by mass-map, angular-momentum-spin, or [quantum-closure](../quantum-closure/priorities.md).
