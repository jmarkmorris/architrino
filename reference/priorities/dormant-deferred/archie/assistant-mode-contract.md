...
| `archie_reference` | `reference/learning-office/` planning, public descriptions, comics, children's books, briefs, and assets | Public-program planning, messaging, and source-material routing. | Not published corpus authority unless the substance is promoted into `content/markdown/aaa/`. |
