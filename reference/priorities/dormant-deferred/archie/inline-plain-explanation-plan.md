...
Check [codex-multiprompt.md](../../../op/codex-multiprompt.md) and [core-geometry-theorem-reviewer.md](../../../office-of-research/cto/prompts/core-geometry-theorem-reviewer.md) for parallel communication sections and apply the same pointer if present.
