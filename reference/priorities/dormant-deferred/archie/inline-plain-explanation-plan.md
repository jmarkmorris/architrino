...
Check [codex-multiprompt.md](../../../op/codex-multiprompt.md) and [core-geometry-theorem-reviewer.md](../../../research-office/cto/prompts/core-geometry-theorem-reviewer.md) for parallel communication sections and apply the same pointer if present.
