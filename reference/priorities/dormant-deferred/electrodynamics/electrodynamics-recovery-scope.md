# Electrodynamics Recovery Scope
...
| Layer | Permitted role | Not permitted |
| --- | --- | --- |
| Substrate | Master Equation acceleration contributions, delayed path histories, causal-root ledgers, polarity, Euclidean void plus absolute time | Primitive electric or magnetic fields, point-charge ontology, a magnetic cross-product acceleration rule, imported relativistic spacetime |
| Assembly and Noether sea | Retained assembly state, shielding and exposure, polarization, circulation, density, delay, and material-response records | Independently fitted response constants for every target or an assumed continuum field ontology |
...
3. the independent reference or measurement;
4. the regime and tolerance or theorem boundary;
