...
It does not specify causal-root locations, source-normal root-chart diagnostics, receiver-normal branch strengths, separation lengths, tangent projections, root multiplicities, or phase-dependent cancellations. Those quantities remain force-ledger data, not inventory data.
