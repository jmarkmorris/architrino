...
The rigid octahedral all-pairs source ledger now has a frozen-ledger speed-ODE diagnostic in [Octahedral Speed Ode Diagnostic](../neutral-braid/octahedral-speed-ode-diagnostic.md). It deliberately stays on the fixed-speed source ledger and therefore reports
