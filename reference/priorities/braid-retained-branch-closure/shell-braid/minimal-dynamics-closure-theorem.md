...
3. **Force regularity.** H4 and H5 keep inverse-square factors, source-normal root-chart diagnostics, and receiver-normal branch-strength rows away from singular values, so each retained line-of-action force is $C^1$ in the branch chart.
