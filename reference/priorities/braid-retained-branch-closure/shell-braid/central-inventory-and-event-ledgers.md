...
Source posture: read this packet with [Braid Architecture](braid-architecture.md) and [Braid](../braid-retained-branch-closure.md). The equations below are closure targets, not completed conservation proofs.
