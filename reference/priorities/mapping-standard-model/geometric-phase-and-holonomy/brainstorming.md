...
The [live registry](../../braid-program/candidate-registry.md) contains six-worldline Family-A and Family-B geometries, twelve-worldline Family-C records, the sector-differential three-pair geometry SD3, the F-series extensions, and the eight-member F6c geometry. Family A and SD3 provide different multi-direction and internal-deformation charts; Family B has one common axis; the opposed-circulation Family-C members supply a different possible relative-mode structure. F1–F4 explore independent circulation, coupled triads, mode/permutation structure, and framed counterflow; F5 has a twelve-member phase-varying prescribed construction; F6c has six polarity-resolved coordinates on its exact symmetry surface. These are geometry opportunities, not established gauge representations.
...
At the inspected state, the adjudication leaves retained-branch requirement H5 unresolved throughout. It preserves bounded ordinary-release evidence for selected A3, SD3, and F6c histories, prescribed evidence for other rows, and scoped negatives for the common-cadence circular F5 realization and F6b. This synthesis does not rerun or independently revalidate those dynamical results and draws no broader family rejection from them. The two accessory continuations are specifically a three-binary braid plus six accessories, and F6c plus six accessories in a two-axial/four-transverse arrangement. They imply twelve and fourteen total members respectively, not a universal six-member core with six additions.
