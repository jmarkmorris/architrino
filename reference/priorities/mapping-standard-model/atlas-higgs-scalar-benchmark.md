...
| mass-map.md | Use the scalar residual as a downstream mass-map benchmark after branch, shielding, and medium-response records are fixed. | Must not use observed Higgs properties as branch-search or shielding inputs. |
