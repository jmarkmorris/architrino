...
12. manifest service contracts for typed service-boundary inputs/outputs, validator order, endpoint contracts, fail-closed manifest shape, provider capability context, speech sync, token receipts, issue mining, and contract fixtures;
...
6. `manifest_driven_service_architecture` - Turn the manifest-driven service architecture map into service components, endpoint contracts, validator order, and fail-closed behavior. Status: `long-term`.
7. `manifest_service_contracts` - Encode typed service-boundary inputs/outputs, validator order, endpoint contracts, fail-closed manifest shape, and contract fixtures. Status: `long-term`.
...
Scope:
- Inspect `reference/priorities/archie/priorities.md`, `reference/priorities/archie/assistant-mode-contract.md`, `reference/priorities/archie/service-platform.md`, `reference/priorities/archie/service-deployment-option-decision.md`, `reference/priorities/archie/service-deployment-architecture.md`, `reference/priorities/archie/service-scaffolding-and-fixtures.md`, `reference/priorities/app-archie-interface/answer-artifact-manifest.md`, `reference/priorities/app-archie-interface/manifest-driven-service-architecture.md`, `reference/priorities/app-archie-interface/manifest-service-contracts.md`, `reference/priorities/app-archie-interface/source-ingestion-retrieval-context-contract.md`, `reference/priorities/app-archie-interface/answer-engine-source-contract.md`, `reference/priorities/app-archie-interface/model-provider-capability-registry-contract.md`, `reference/priorities/app-archie-interface/token-ledger-privacy-contract.md`, `reference/priorities/app-archie-interface/issue-mining-signal-contract.md`, `reference/priorities/app-archie-interface/observability-public-status-incident-contract.md`, `reference/priorities/app-archie-interface/action-broker-confirmation-contract.md`, `reference/priorities/app-archie-interface/saved-notebook-account-history-contract.md`, `reference/priorities/app-archie-interface/service-terms-account-policy-contract.md`, `reference/priorities/app-archie-interface/service-native-speech-presentation-contract.md`, `reference/priorities/app-archie-interface/corporate-media-standards.md`, `reference/priorities/app-archie-interface/corporate-media-acceptance-fixtures.md`, `content/markdown/aaa/archie/system-card.md`, `README.md`, deployment files, and runtime entry points.
