...
2. `character_ensemble` - Promote the draft STEAM-undergrad ensemble into approved character sheets with names, roles, appearances, voice directions, visual references, and cross-media continuity rules. Status: `active`. Depends on: `first_prototype_decision_stack`.
