...
- The write set is limited to mapping documentation and the priorities index. Protected F6c readiness, configuration, record, numerical-source, control, launch-plan, and ignored-evidence files are outside this move; no generated artifacts were written.
