...
The focused integration and derivation program is the [Fine-Structure Coupling Map](../mapping-electromagnetism/fine-structure.md). This section retains the scored equation row and compact closure contract.
