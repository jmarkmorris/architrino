...
This manifest narrows the first source-acquisition object for [EQ-12 Theta-Gamma Packet Source Shell](../analysis/eq-12-theta-gamma-packet-source-shell.md). It records the smallest retained-evidence intake object that could make CERN Open Data record 6005 checker-consumable after a local mirror and extraction pass. It does not mark `theta_gamma_packet` or any child row accepted, and it does not replace the photon packet checker.
