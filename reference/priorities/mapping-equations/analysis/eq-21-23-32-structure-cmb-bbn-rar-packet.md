...
- [Cosmology Transfer-Function Closure](../../dormant-deferred/mapping-cosmology/priorities.md) supplies the shared comparison record $\theta_{\mathrm{sea}}=(\theta_{\mathrm{clock}},\theta_{\mathrm{prop}},\theta_{\mathrm{therm}},\theta_{\mathrm{ac}},\theta_{\mathrm{growth}},\theta_{\mathrm{frame}})$ and the residual rows for CMB, BAO, supernova/$H_0$, weak lensing/RSD, and kSZ force-law profiles.
