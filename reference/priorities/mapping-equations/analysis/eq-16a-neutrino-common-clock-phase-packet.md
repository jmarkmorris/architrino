...
- [neutrino-oscillations.md](../../mapping-benchmarks/benchmarks/neutrino-oscillations.md): the cross-theory packet names the phase, weak projection, PMNS import, and matter-effect failure modes.
- [weak-sector-gauge-closure.md](../../mapping-standard-model/analysis/weak-sector-gauge-closure.md): PMNS recovery must use the same weak-exposure domain as `V-A`, CKM overlap, and weak-reaction provenance.
