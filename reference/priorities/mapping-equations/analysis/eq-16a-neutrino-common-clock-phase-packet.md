...
- [neutrino-oscillations.md](../../mapping-benchmarks/analysis/neutrino-oscillations.md): the cross-theory packet names the phase, weak projection, PMNS import, and matter-effect failure modes.
