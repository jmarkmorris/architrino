...
The equation map now also feeds the stable Noether braid program through Equation-Map Bearing On Braid Configuration Search. Candidate frequency families are search coordinates, not acceptance criteria. A retained candidate should be judged by the same root, geometry/energy, phase-operator, event-ledger, wake/recoil, stability, and observation residual rows. Role-assigned frequency triples use $I:M:O$; raw generator labels remain generic until the solver supplies a nested-role map.
...
[Mapping Electromagnetism](../mapping-electromagnetism/priorities.md) is the electromagnetic integration consumer for the EQ-13, EQ-15, EQ-26A, and EQ-27 rows. Its [Fine-Structure Coupling Map](../mapping-electromagnetism/analysis/fine-structure.md) owns the cross-row derivation program for $\alpha_{\mathrm{ref}}$ and $\mathcal K_{\mathrm{EM}}$. Mapping Electromagnetism also owns Maxwell cases and inverse constraints on braid, electron, and Noether sea structure; Equation Mapping retains the exact equation carriers, scores, source-field packets, and executable controls.
...
The locally ranked equation objects, live blockers, and completion boundaries live in [work-queue.md](work-queue.md).
...
- Current score and acceptance routing: [Equation Mapping Detail](analysis/equation.md), [Equation Score-5 Closure Ladder](analysis/equation-score-5-closure-ladder.md), and the [Shared Equation And Mapping Architecture](../mapping/contracts/mapping-method.md).
...
- Lorentz and retained-domain packets: [EQ-02 Through EQ-04 S_eq Retained-Domain Evidence Object](analysis/eq-02-04-s-eq-retained-domain-evidence-object.md) and [EQ-02 Through EQ-04 Translating Binary Shared-Record Instantiation](analysis/eq-02-04-translating-binary-shared-record-instantiation.md).
- Effective metric, Noether sea, and cosmology packets: [EQ-07 Through EQ-10 And EQ-17 Through EQ-19 Effective Metric / Cosmology Packet](analysis/eq-07-10-17-19-effective-metric-cosmology-packet.md), [EQ-11/20 Gravity And Dark-Energy Packet](analysis/eq-11-20-gravity-dark-energy-packet.md), [EQ-10 Theta-W Source-Field Map](analysis/eq-10-theta-w-source-field-map.md), [EQ-17 Theta-Transfer Source-Field Map](analysis/eq-17-theta-transfer-source-field-map.md), [EQ-18 And EQ-19 Theta-Cos Source-Field Map](analysis/eq-18-19-theta-cos-source-field-map.md), [EQ-24 Theta-Sea Rho-NS Source-Field Map](analysis/eq-24-theta-sea-rho-ns-source-field-map.md), [EQ-25 Theta-Therm CMB Source-Field Map](analysis/eq-25-theta-therm-cmb-source-field-map.md), and [EQ-21/EQ-22/EQ-23 Theta-Src Source-Field Map](analysis/eq-21-22-23-theta-src-source-field-map.md).
