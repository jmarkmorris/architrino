...
- Current score and acceptance routing: [Equation Mapping Detail](equation.md), [Equation Score-5 Closure Ladder](equation-score-5-closure-ladder.md), and the [Shared Equation And Mapping Architecture](equation-common-architecture-2026-06-23-c.md).
...
- Cross-workstream consumers: Equation-Map Bearing On Braid Configuration Search, [Mapping Benchmarks Priority Candidates](../mapping-benchmarks/priorities.md), [Cosmology Transfer-Function Closure](../cosmology-closure/priorities.md), Noether-Core Stability and First Mass Map, Braid, and Geometry Bridge.
