...
[Equation Closure Pass 2026-06-23 AE](equation-closure-pass-2026-06-23-ae.md) adds the score-neutral `EQ-14` Born-current projection and hardens the `EQ-31` null-separatrix/refinement sweep. It leaves the score table unchanged because both toy fixtures block first at `missing_accepted_W`.
