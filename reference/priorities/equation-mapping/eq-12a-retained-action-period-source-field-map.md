...
| Row | `EQ-12A` |
| Current score | `2` |
| Carrier | Retained action-period carrier: $\gamma_0\to\mathcal U\to h_\vartheta$, refined by locked equal-frequency `S_eq` three-binary evidence. |
