...
Readout independence is tested by comparing $h_E=E_\gamma/\nu$ against $h_\Phi=\oint_{\gamma_0}p\,dq$ under collocation refinement, Poincare-section relocation, and retained-mode variation. A $g$- or $\mu$-sweep should move $E$ and $\nu$ while leaving $h_\vartheta$ stable; otherwise the action unit is being fitted. Integrality is a retained-orbit selection condition, not the first theorem. The dedicated executable status is [constant-delay-retained-orbit-certificate.mjs](../../../scripts/equation-mapping/constant-delay-retained-orbit-certificate.mjs), with attempt fixture [constant-delay-retained-orbit-certificate-attempt.v1.json](../../../scripts/equation-mapping/constant-delay-retained-orbit-certificate-attempt.v1.json). The broader Planck/alpha bundle remains covered by [planck-alpha-braid-residual.mjs](../../../scripts/equation-mapping/planck-alpha-braid-residual.mjs). Both runs are score-neutral.
