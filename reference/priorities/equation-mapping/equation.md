...
Populate the `EQ-28A` path-frequency exchange carrier behind the solver residual. The next useful artifact is a source-backed carrier row that keeps local Compton exchange, SZ calibration, photon Gate A/B handoff, recoil/remnant updates, and finite-window thermal state on one retained path record.
...
Executable status: [eq29-radiation-source-ledger-residual.mjs](../../../scripts/equation-mapping/eq29-radiation-source-ledger-residual.mjs) now evaluates the direct `EQ-29` radiation source-ledger residual for a synchrotron source packet. Its source-attempt fixture [eq29-radiation-source-carrier-source-attempt.v1.json](../../../scripts/equation-mapping/eq29-radiation-source-carrier-source-attempt.v1.json) reports `status: blocked_missing_rows`, `nextBlocker: missing_accepted_radiation_source_carrier`, `sourceLedgerNumericPass: true`, and `negativeControlPassCount: 6`; no score movement follows because the radiation source rows remain attempt-level. Its coordination-source negative control [eq29-radiation-source-ledger-coordination-source-negative-control.v1.json](../../../scripts/equation-mapping/eq29-radiation-source-ledger-coordination-source-negative-control.v1.json), probe-source negative control [eq29-radiation-source-ledger-probe-source-negative-control.v1.json](../../../scripts/equation-mapping/eq29-radiation-source-ledger-probe-source-negative-control.v1.json), and unrelated durable-source negative control [eq29-radiation-source-ledger-unrelated-durable-source-negative-control.v1.json](../../../scripts/equation-mapping/eq29-radiation-source-ledger-unrelated-durable-source-negative-control.v1.json) report `status: blocked_source_evidence`, `nextBlocker: accepted_without_evidence_source`, and `sourceEvidenceFailureCount: 15`, so priority/source-map files, probe fixtures, and durable files without EQ-29/radiation-source support metadata cannot satisfy accepted retained evidence rows.
