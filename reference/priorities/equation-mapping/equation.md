...
The iso-frequency Noether braid candidate in iso-frequency-energy-radius-candidate.md (legacy-braid ref: `braid-archive/braid-angular-momentum-spin/iso-frequency-energy-radius-candidate.md`) is therefore a good match only if it has the form
