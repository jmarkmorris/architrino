...
| Acoustic/elastic agreement | $c_{X,\mathrm{disp}}^2$ and $C_{1111}^X/\rho_{\text{NS}}$ agree within the refinement-error budget. | Separates a same-window response coefficient from a discretization artifact. |
