...
Until source-backed envelope, response, event-ledger, residual-budget, provenance, and no-hidden-retune rows exist, the correct disposition is no score movement.
