...
5. **Photon and finite event ledger:** `EQ-12`, `EQ-13`, `EQ-17`, `EQ-26`, `EQ-28`, and `EQ-29`. Compton/recoil is the smallest event replay with many consumers; the current executable replay is comparison-only until the native $\mathsf e_{\gamma e}^{0}$ rows are populated.
