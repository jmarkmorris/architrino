...
| Existing checker surface | [eq04a-koide-residual.mjs](../../../scripts/equation-mapping/eq04a-koide-residual.mjs) with the default attempt fixture plus direct-fit and split-generation negative controls. |
| Safe implementation target for this packet | Priority packet refinement: make the direct geometry readouts, same-record bindings, fail-closed controls, and smallest accepted evidence object explicit before any future source-backed mass-map probe is attempted. |
