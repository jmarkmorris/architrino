...
- planar-photon recovery rows for the coaxial contra-rotating polarity-conjugate planar pair when photon-path or light-ring evidence is consumed;
...
| $\Pi_{\gamma\mathrm{pl}}$ | Planar-photon recovery projection. | Tests whether photon-path or light-ring readouts use the coaxial contra-rotating polarity-conjugate planar pair and planar tri-binary reduced chart without substituting that row for the horizon carrier. |
...
| $\mathcal{R}_{\gamma\mathrm{pl}}$ | Checks the planar-photon recovery projection through the coaxial contra-rotating polarity-conjugate planar pair and planar tri-binary reduced chart when photon-path or light-ring evidence is used. |
...
- one planar-photon recovery row when photon-path or light-ring evidence is used, with the coaxial contra-rotating polarity-conjugate planar pair and planar tri-binary reduced chart tied to the same event ledger;
