...
| `pathConstraintBoundaryRelaxationSelectedCandidateKind` | Selected finite-difference relaxation candidate family, such as predictor, corrector, residual-defect, linearized-defect, local-Newton, blended, or center-of-mass-projected variants. |
