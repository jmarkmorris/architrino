...
Review date: September 12, 2026. Scope: validation recovery, agent dispatch and their operational documentation. Superseded A/B migration inventory and recommendations were removed under the September 14 retirement decision. This is a consolidation recommendation, not an authorization or record of moving, merging, deleting or rewriting the inventoried documents.
...
The inventory below was measured with `rg --files reference/priorities/development-process-review -g '*.md'` and selected operational-owner paths, with existence checks for those selected paths. The retained rows below concern operational documentation; the original inventory counts no longer describe the collection after retirement.
...
| --- | --- | --- |
| [README.md](../../../op/git/README.md) | Git reading index | Keep short and follow the current architecture owner. |
...
| Document | Consolidation assessment |
| --- | --- |
| [external-codex-storage-audit.md](external-codex-storage-audit.md) | Keep with its distinct incident or decision. Cross-link relevant lessons without merging distinct incidents. |
| [github-remote-incident-diagnosis.md](github-remote-incident-diagnosis.md) | Keep with its distinct incident or decision. Cross-link relevant lessons without merging distinct incidents. |
| [public-community-guidance-review.md](public-community-guidance-review.md) | Keep with its distinct incident or decision. Cross-link relevant lessons without merging distinct incidents. |
| [retention-health-review.md](retention-health-review.md) | Keep with its distinct incident or decision. Cross-link relevant lessons without merging distinct incidents. |
| [worktree-learning-and-experiment.md](worktree-learning-and-experiment.md) | Keep with its distinct incident or decision. Cross-link relevant lessons without merging distinct incidents. |
| [historical-voice-handoff-2026-08-01.md](../evidence/historical-voice-handoff-2026-08-01.md) | Keep with its distinct incident or decision. Cross-link relevant lessons without merging distinct incidents. |
