...
The [emission transport](emission-current-migration.md) now passes 42 Node and 11 Python controls plus both real metadata stages. These preserve the original producer and numerical verifier. The refined current transport remains separately scoped; no current runtime capability is presented as historical source or acceptance evidence.
