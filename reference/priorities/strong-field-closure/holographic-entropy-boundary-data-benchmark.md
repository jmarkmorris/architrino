...
| [strong-field-closure.md](strong-field-closure.md) | Use the packet as source support for `horizon_entropy_packet` and `observer_predictions`. | Must consume the embedded horizon-interface condition and release-channel ledger rather than adding a separate holography lane. |
