...
This file should not grow into a proof queue. Any hypothesis that becomes actionable should be promoted into [strong-field-closure](priorities.md), doubling-frequency-lock (legacy-braid ref: `braid-doubling-frequency-lock/priorities.md`), or another active workstream.
...
- phenomenological-heuristics (legacy-braid ref: `braid-doubling-frequency-lock/phenomenological-heuristics.md`)
