...
| File | Role |
| --- | --- |
| [categorical-contract-and-ownership-map.md](analysis/categorical-contract-and-ownership-map.md) | Verified CT-001 contract: complete history objects, lawful extension, symmetry, restriction, factorization obstruction, ownership, and stop conditions. |
| [worldline_history_morphism_contract.md](analysis/worldline_history_morphism_contract.md) | Verified bounded CT-004 contract: exact record composition, manufactured separating-pair instrument, symmetry square, simpler-tool comparison, and continue-or-pause decision. |
