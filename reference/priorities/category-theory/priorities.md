...
The [CT-004 worldline-history morphism contract](worldline_history_morphism_contract.md) is complete at bounded history-record contract grade. It instantiates the candidate boundary record, proves exact identity and three-interval compatible-union associativity, supplies an endpoint-matched manufactured delay-functional separating pair with positive and independence controls, and types the already-admitted full-history symmetry covariance square. The manufactured pair establishes instrument sensitivity to forgotten history, not a physical Master-Equation or retained-assembly witness.
...
| [worldline_history_morphism_contract.md](worldline_history_morphism_contract.md) | Verified bounded CT-004 contract: exact record composition, manufactured separating-pair instrument, symmetry square, simpler-tool comparison, and continue-or-pause decision. |
| [ct004-eom-restart-factorization-audit.md](ct004-eom-restart-factorization-audit.md) | First measured CT-004 application: EOM restart-object typing, omitted controller-memory obstruction, exact-cut separating control, and App Solver ownership handoff. |
