...
| Configuration atlas, finite-history scope, restrictions, uncertainty, and abstention | [Braid Program configuration chart](../braid-program/configuration-chart.md) and `BP-002` | Supplies atlas objects when ratified; receives no duplicate implementation here. | Atlas admission does not establish retention or physical realization. |
