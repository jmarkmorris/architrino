...
18. `geometry_centralization_inventory` - Identify duplicated or app-side solver geometry in Photon, Ideal Swarm, and Animator. Status: `active-first-inventory-check`. Depends on: `solver_contract`.
