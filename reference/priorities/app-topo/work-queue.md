# Wake Topography App Work Queue
...
2. Keep the scientific observable, Potential product, Wake Topography rendering, and EOM evolution as separate responsibilities.
...
Use this stable numbering for the current user-led Wake Topography review. Implementation and automated checks do not replace the named user test.
