...
prehistory-extension adjudication (legacy-braid ref: `braid-ideal/evidence/antipodal-binary-prehistory-extension-adjudication-2026-07-14.md`).
...
1. **Section 86 multi-seed collapse campaign.** The antipodal-binary prerequisite
   ...
   under the superseding design (legacy-braid ref: `braid-ideal/section-86-flutter-rerun-dispatch-packet.md#superseding-design--2026-07-14-multi-seed-collapse`).
   The preflight (legacy-braid ref: `braid-ideal/evidence/section-86-v5-collapse-campaign-preflight-2026-07-14.md`)
   ...
   endpoint; complete the middle self-root adjudication handoff (legacy-braid ref: `braid-ideal/section-86-self-root-adjudication-handoff.md`)
