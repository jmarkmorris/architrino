...
prehistory-extension adjudication (legacy-braid ref: `braid-archive/braid-ideal/evidence/antipodal-binary-prehistory-extension-adjudication-2026-07-14.md`).
...
1. **Section 86 multi-seed collapse campaign.** The antipodal-binary prerequisite
   ...
   under the superseding design (legacy-braid ref: `braid-archive/braid-ideal/section-86-flutter-rerun-dispatch-packet.md#superseding-design--2026-07-14-multi-seed-collapse`).
   The preflight (legacy-braid ref: `braid-archive/braid-ideal/evidence/section-86-v5-collapse-campaign-preflight-2026-07-14.md`)
   ...
   endpoint; complete the middle self-root adjudication handoff (legacy-braid ref: `braid-archive/braid-ideal/section-86-self-root-adjudication-handoff.md`)
...
**Program termination — 2026-07-15 (operator decision): Tiers 2–4 halted; cross-verification of legacy braid numbers is moot.** The operator ratified a fresh start on the braid search ([reference/priorities/braid-program/](../braid-program/README.md)): no proof, calculation, number, or verdict from the legacy braid workstreams is relied on going forward, so certifying those numbers no longer serves a consumer. Final standing: the three charge rows remain cross-verified; every other legacy T1 number remains at *single-instrument reduction* grade permanently, and any corpus prose citing them inherits that caveat until re-derived by the new program's own campaigns. Durable assets retained: the blind-authorship reduction layer and fixture firewall (`scripts/eom-verification/`), the wall-packet witness (engine critical path, unaffected by this termination), and the protocol lessons (owning definition is part of the fixture; blind authorship; fail-closed gates), which are adopted as standing method in the braid program's `method.md`.
