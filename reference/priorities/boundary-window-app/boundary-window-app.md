...
19. Define the dataset manifest as the first app-facing run cover sheet, but defer save, export, import, and load workflows until the first-screen contract and native-backed fixture are stable.
