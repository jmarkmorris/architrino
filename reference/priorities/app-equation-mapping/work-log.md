...
### 2026-08-24 — AEM-001 canonical contract implemented; generated surfaces await verification
...
- Moved `AEM-001` to awaiting verification. The generated textbook reading copies require authorized regeneration before link propagation can be checked there, and the iOS package check additionally reports pre-existing generated hash drift in six Archie guide references. No equation claim, proof status, or equation-mapping score changed.
