...
The executable packet is [octahedral-fold-aware-cross-binary-i1-compact-complement-directed-rounded-interval-enclosure.mjs](../../../scripts/neutral-swarm/octahedral-fold-aware-cross-binary-i1-compact-complement-directed-rounded-interval-enclosure.mjs). It emits:
