...
The companion test [neutral-swarm-octahedral-fold-aware-clock-length-profile-scan.test.js](../../../tests/neutral-swarm-octahedral-fold-aware-clock-length-profile-scan.test.js) verifies the source criterion, sampled positive clock profile, CLI validation, no fixed speed window, and non-retention guards.
