...
The companion test [neutral-swarm-octahedral-fold-aware-cross-binary-theta3minus-speed-dependent-regular-root-complement-slab-certificate.test.js](../../../tests/neutral-swarm-octahedral-fold-aware-cross-binary-theta3minus-speed-dependent-regular-root-complement-slab-certificate.test.js) validates schema, no-fixed-speed-window discipline, hybrid slab counts, raw and scaled sign margins, overclaim rejection, and CLI write/validate behavior.
