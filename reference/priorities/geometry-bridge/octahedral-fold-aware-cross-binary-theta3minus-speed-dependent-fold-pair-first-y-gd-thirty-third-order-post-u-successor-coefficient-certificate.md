...
seed coefficient, $h_{32,\varepsilon}$, and the induced thirty-third-order
...
| maximum $Q_G$ thirty-third-order coefficient loss on $0\le y\le0.001796875$ | $4.87859897457\times10^{-69}$ |
| maximum $Q_D$ thirty-third-order coefficient loss on $0\le y\le0.001796875$ | $1.60993766161\times10^{-67}$ |
