...
The companion test [neutral-braid-octahedral-fold-aware-cross-binary-theta3minus-speed-dependent-fold-pair-scaled-root-tube-cell-certificate.test.js](../../../tests/neutral-swarm-octahedral-fold-aware-cross-binary-theta3minus-speed-dependent-fold-pair-scaled-root-tube-cell-certificate.test.js) validates schema, no-fixed-speed-window discipline, cell counts, $K$ endpoint signs, $H$ endpoint signs, $J$ signs, Taylor argument bounds, overclaim rejection, and CLI write/validate behavior.
