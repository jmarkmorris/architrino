...
The companion test [neutral-braid-octahedral-fold-aware-cross-binary-theta3minus-speed-dependent-fold-pair-scaled-sampled-node-interval-certificate.test.js](../../../tests/neutral-swarm-octahedral-fold-aware-cross-binary-theta3minus-speed-dependent-fold-pair-scaled-sampled-node-interval-certificate.test.js) validates schema, no-fixed-speed-window discipline, endpoint brackets, $J$ signs, quotient budgets, overclaim rejection, and CLI write/validate behavior.
