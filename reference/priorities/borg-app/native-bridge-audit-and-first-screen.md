...
10. `nativeMasterEquationProbe.statusCode = native_solver_pending`, `firstFailureCode = native_master_equation_solver_pending`, `requiredNativeExport = architrino_solver_integrate_master_equation_motion_f64`, and `fallbackDecision = default-motion-baseline-selected`;
