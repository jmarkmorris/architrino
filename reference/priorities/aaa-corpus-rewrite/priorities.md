...
The substantive Foundations review opened on 2026-09-05 covers all nine files in textbook order under edition 1.1, with discussion after each small batch. All batch-1 recommendations and F2-1 through F2-5 have accepted, implemented, and verified corrections. Absolute Time now distinguishes numerical margins from singularities, direct contributions from indirect influence, and fixed duration structure from temporal dynamics. Euclidean Void conditionally defines its directional response while retaining cosmological and apparatus identifications as open recovery obligations; its frame-bundle definition now states the orientation restriction explicitly. The current discussion is F2-6, regular domains for curvilinear coordinates; F2-7's CMB citation correction also remains pending. Coverage is 4 of 9: 3 chapters with all recommended corrections accepted and verified (Ontology, Architrino, Absolute Time), 1 partially integrated chapter awaiting further decisions (Euclidean Void), and 5 not yet reviewed. The [full review, hashes, sequence, acceptance record, and pending discussion](work-queue.md#foundations-substantive-review--2026-09-05) own this work. Historical conversion completion and CRW-005's separate denominator remain unchanged; no deferred theory lane is reactivated.
