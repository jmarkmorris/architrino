...
The substantive Foundations review opened on 2026-09-05 covers all nine files in textbook order under edition 1.1, with discussion after each small batch. The operator accepted all batch-1 recommendations; Ontology and Architrino contain the verified corrections and scoped polarity deduction. Batch 2 has reviewed Absolute Time and Euclidean Void completely. F2-1 and the bounded F2-2 correction are accepted, implemented, and verified: numerical margins, singularities, and history boundaries are distinguished; the directional response is conditionally defined, with cosmological and apparatus identifications retained as open recovery obligations. The current discussion is F2-3, direct versus chained causal influence. Other pending findings address the affine time structure, frame-bundle orientation, curvilinear chart domains, and the CMB citation. Coverage is 4 of 9: 2 chapters with accepted corrections verified, 2 partially integrated chapters awaiting further decisions, and 5 not yet reviewed. The [full review, hashes, sequence, acceptance record, and pending discussion](work-queue.md#foundations-substantive-review--2026-09-05) own this work. Historical conversion completion and CRW-005's separate denominator remain unchanged; no deferred theory lane is reactivated.
