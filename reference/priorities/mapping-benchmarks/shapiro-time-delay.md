...
| --- | --- | --- |
| This file | [validation-gates](../dormant-deferred/validation-gates/priorities.md) | Add Shapiro delay as a gravity benchmark consuming the same $\mathcal{M}_{\mathrm{sea}}^{ab}$ as lensing and redshift. |
