...
| [Mapping the Planck Scale](../../../content/markdown/aaa/philosophy-history/theory-bridges/mapping-planck-scale-a1-geometry.md#thesis) and [Singularity Resolution](../../../content/markdown/aaa/spacetime/singularity-resolution.md#canonical-strong-field-alignment-condition) | Planck-scale language maps to an alignment condition in strong-field contexts; it should not be treated as a free continuum cutoff unless the alignment variables are present. |
