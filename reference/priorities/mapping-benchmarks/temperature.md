...
5. `cosmology_temperature_handoff` - Separate intrinsic Noether braid energy, local emissive ensemble temperature, and observer-inferred CMB temperature. Status: `draft`. Depends on: [mapping-cosmology](../dormant-deferred/mapping-cosmology/priorities.md), [validation-gates](../dormant-deferred/validation-gates/priorities.md).
...
| `kelvin_kb_bridge` | [architrino-si-base-units](../../../content/markdown/aaa/validation/architrino-si-base-units.md), mass-map, and [Noether sea](../../../content/markdown/aaa/spacetime/noether-sea.md) | $k_B$ is routed through Noether sea thermal equilibrium, effective assembly mass, and velocity-distribution width. |
