...
| --- | --- | --- |
| This file | [mapping-standard-model/weak-sector-gauge-closure](../../mapping-standard-model/analysis/weak-sector-gauge-closure.md) | Use neutrino oscillation as a PMNS and weak-projection closure target. |
| This file | [mapping-quantum/transfer-operator-basin-measure](../../mapping-quantum/analysis/transfer-operator-basin-measure.md) | Treat flavor outcome as detector basin projection after coherent propagation. |
