...
| --- | --- | --- |
| This file | [mapping-quantum/transfer-operator-basin-measure](../../mapping-quantum/analysis/transfer-operator-basin-measure.md) | Use interference as the first phase-sensitive basin-measure proof target. |
| This file | [mapping-quantum](../../mapping-quantum/priorities.md) | Map wavefunction ontology into path-history and detector-response records. |
