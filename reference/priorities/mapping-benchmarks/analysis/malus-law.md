...
| This file | [mapping-quantum/transfer-operator-basin-measure](../../mapping-quantum/analysis/transfer-operator-basin-measure.md) | Treat the photon analyzer kernel as a derived basin pullback, not an assumed $\cos^2\theta$ detector law. |
