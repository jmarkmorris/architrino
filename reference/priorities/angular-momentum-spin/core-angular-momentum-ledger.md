...
2. **Tri-binary layer roles.** [tri-binary-dynamics.md](../../../content/markdown/aaa/dynamics/tri-binary-dynamics.md), [noether-swarm.md](../../../content/markdown/aaa/noether-swarm/noether-swarm.md), and [noether-core-geometry.md](../../../content/markdown/aaa/spacetime/noether-core-geometry.md) already separate the inner self-hit engine, middle $v=c_f$ hinge, and outer shielding / interface layer. That makes the partition problem concrete: each layer has a role, speed regime, phase window, and exposure channel.
