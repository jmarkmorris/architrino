...
In the row ledgers, occupancies are listed in the fixed order `s, p, d, f`, but the subshell labels are omitted wherever the order already determines their meaning. Capacities use compact hexadecimal-style digits where `a = 10` and `e = 14`.

| Z | Element | Standard configuration | Full row notation | Abbreviated row notation |
|---|---|---|---|---|
| 1 | Hydrogen | `1s1` | `E1 1/2` | `E1 1/2` |
| 2 | Helium | `1s2` | `E1 2/2` | `E1 2/2`; `= [He]` |
| 3 | Lithium | `1s2 2s1` | `E1 2/2`; `E2 1/2` | `[He]`; `E2 1/2` |
| 4 | Beryllium | `1s2 2s2` | `E1 2/2`; `E2 2/2` | `[He]`; `E2 2/2` |
| 5 | Boron | `1s2 2s2 2p1` | `E1 2/2`; `E2 2/2 1/6` | `[He]`; `E2 2/2 1/6` |
| 6 | Carbon | `1s2 2s2 2p2` | `E1 2/2`; `E2 2/2 2/6` | `[He]`; `E2 2/2 2/6` |
| 7 | Nitrogen | `1s2 2s2 2p3` | `E1 2/2`; `E2 2/2 3/6` | `[He]`; `E2 2/2 3/6` |
| 8 | Oxygen | `1s2 2s2 2p4` | `E1 2/2`; `E2 2/2 4/6` | `[He]`; `E2 2/2 4/6` |
| 9 | Fluorine | `1s2 2s2 2p5` | `E1 2/2`; `E2 2/2 5/6` | `[He]`; `E2 2/2 5/6` |
| 10 | Neon | `1s2 2s2 2p6` | `E1 2/2`; `E2 2/2 6/6` | `[He]`; `E2 2/2 6/6`; `= [Ne]` |
| 11 | Sodium | `1s2 2s2 2p6 3s1` | `E1 2/2`; `E2 2/2 6/6`; `E3 1/2` | `[Ne]`; `E3 1/2` |
| 12 | Magnesium | `1s2 2s2 2p6 3s2` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2` | `[Ne]`; `E3 2/2` |
| 13 | Aluminium | `1s2 2s2 2p6 3s2 3p1` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 1/6` | `[Ne]`; `E3 2/2 1/6` |
| 14 | Silicon | `1s2 2s2 2p6 3s2 3p2` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 2/6` | `[Ne]`; `E3 2/2 2/6` |
| 15 | Phosphorus | `1s2 2s2 2p6 3s2 3p3` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 3/6` | `[Ne]`; `E3 2/2 3/6` |
| 16 | Sulfur | `1s2 2s2 2p6 3s2 3p4` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 4/6` | `[Ne]`; `E3 2/2 4/6` |
| 17 | Chlorine | `1s2 2s2 2p6 3s2 3p5` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 5/6` | `[Ne]`; `E3 2/2 5/6` |
| 18 | Argon | `1s2 2s2 2p6 3s2 3p6` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6` | `[Ne]`; `E3 2/2 6/6`; `= [Ar]` |
| 19 | Potassium | `1s2 2s2 2p6 3s2 3p6 4s1` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6`; `E4 1/2` | `[Ar]`; `E4 1/2` |
| 20 | Calcium | `1s2 2s2 2p6 3s2 3p6 4s2` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6`; `E4 2/2` | `[Ar]`; `E4 2/2` |
| 21 | Scandium | `1s2 2s2 2p6 3s2 3p6 4s2 3d1` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 1/a`; `E4 2/2` | `[Ar]`; `E3 1/a`; `E4 2/2` |
| 22 | Titanium | `1s2 2s2 2p6 3s2 3p6 4s2 3d2` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 2/a`; `E4 2/2` | `[Ar]`; `E3 2/a`; `E4 2/2` |
| 23 | Vanadium | `1s2 2s2 2p6 3s2 3p6 4s2 3d3` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 3/a`; `E4 2/2` | `[Ar]`; `E3 3/a`; `E4 2/2` |
| 24 | Chromium | `1s2 2s2 2p6 3s2 3p6 4s1 3d5` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 5/a`; `E4 1/2` | `[Ar]`; `E3 5/a`; `E4 1/2` |
| 25 | Manganese | `1s2 2s2 2p6 3s2 3p6 4s2 3d5` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 5/a`; `E4 2/2` | `[Ar]`; `E3 5/a`; `E4 2/2` |
| 26 | Iron | `1s2 2s2 2p6 3s2 3p6 4s2 3d6` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 6/a`; `E4 2/2` | `[Ar]`; `E3 6/a`; `E4 2/2` |
| 27 | Cobalt | `1s2 2s2 2p6 3s2 3p6 4s2 3d7` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 7/a`; `E4 2/2` | `[Ar]`; `E3 7/a`; `E4 2/2` |
| 28 | Nickel | `1s2 2s2 2p6 3s2 3p6 4s2 3d8` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 8/a`; `E4 2/2` | `[Ar]`; `E3 8/a`; `E4 2/2` |
| 29 | Copper | `1s2 2s2 2p6 3s2 3p6 4s1 3d10` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 1/2` | `[Ar]`; `E3 a/a`; `E4 1/2` |
| 30 | Zinc | `1s2 2s2 2p6 3s2 3p6 4s2 3d10` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2` | `[Ar]`; `E3 a/a`; `E4 2/2` |
| 31 | Gallium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p1` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 1/6` | `[Ar]`; `E3 a/a`; `E4 2/2 1/6` |
| 32 | Germanium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p2` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 2/6` | `[Ar]`; `E3 a/a`; `E4 2/2 2/6` |
| 33 | Arsenic | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p3` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 3/6` | `[Ar]`; `E3 a/a`; `E4 2/2 3/6` |
| 34 | Selenium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p4` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 4/6` | `[Ar]`; `E3 a/a`; `E4 2/2 4/6` |
| 35 | Bromine | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p5` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 5/6` | `[Ar]`; `E3 a/a`; `E4 2/2 5/6` |
| 36 | Krypton | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6` | `[Ar]`; `E3 a/a`; `E4 2/2 6/6`; `= [Kr]` |
| 37 | Rubidium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s1` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6`; `E5 1/2` | `[Kr]`; `E5 1/2` |
| 38 | Strontium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6`; `E5 2/2` | `[Kr]`; `E5 2/2` |
| 39 | Yttrium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d1` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 1/a`; `E5 2/2` | `[Kr]`; `E4 1/a`; `E5 2/2` |
| 40 | Zirconium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d2` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 2/a`; `E5 2/2` | `[Kr]`; `E4 2/a`; `E5 2/2` |
| 41 | Niobium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s1 4d4` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 4/a`; `E5 1/2` | `[Kr]`; `E4 4/a`; `E5 1/2` |
| 42 | Molybdenum | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s1 4d5` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 5/a`; `E5 1/2` | `[Kr]`; `E4 5/a`; `E5 1/2` |
| 43 | Technetium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d5` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 5/a`; `E5 2/2` | `[Kr]`; `E4 5/a`; `E5 2/2` |
| 44 | Ruthenium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s1 4d7` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 7/a`; `E5 1/2` | `[Kr]`; `E4 7/a`; `E5 1/2` |
| 45 | Rhodium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s1 4d8` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 8/a`; `E5 1/2` | `[Kr]`; `E4 8/a`; `E5 1/2` |
| 46 | Palladium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 4d10` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a` | `[Kr]`; `E4 a/a` |
| 47 | Silver | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s1 4d10` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a`; `E5 1/2` | `[Kr]`; `E4 a/a`; `E5 1/2` |
| 48 | Cadmium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a`; `E5 2/2` | `[Kr]`; `E4 a/a`; `E5 2/2` |
| 49 | Indium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p1` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a`; `E5 2/2 1/6` | `[Kr]`; `E4 a/a`; `E5 2/2 1/6` |
| 50 | Tin | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p2` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a`; `E5 2/2 2/6` | `[Kr]`; `E4 a/a`; `E5 2/2 2/6` |
| 51 | Antimony | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p3` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a`; `E5 2/2 3/6` | `[Kr]`; `E4 a/a`; `E5 2/2 3/6` |
| 52 | Tellurium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p4` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a`; `E5 2/2 4/6` | `[Kr]`; `E4 a/a`; `E5 2/2 4/6` |
| 53 | Iodine | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p5` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a`; `E5 2/2 5/6` | `[Kr]`; `E4 a/a`; `E5 2/2 5/6` |
| 54 | Xenon | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a`; `E5 2/2 6/6` | `[Kr]`; `E4 a/a`; `E5 2/2 6/6`; `= [Xe]` |
| 55 | Cesium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s1` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a`; `E5 2/2 6/6`; `E6 1/2` | `[Xe]`; `E6 1/2` |
| 56 | Barium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a`; `E5 2/2 6/6`; `E6 2/2` | `[Xe]`; `E6 2/2` |
| 57 | Lanthanum | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 5d1` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a`; `E5 2/2 6/6 1/a`; `E6 2/2` | `[Xe]`; `E5 1/a`; `E6 2/2` |
| 58 | Cerium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 5d1 4f1` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a 1/e`; `E5 2/2 6/6 1/a`; `E6 2/2` | `[Xe]`; `E4 1/e`; `E5 1/a`; `E6 2/2` |
| 59 | Praseodymium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f3` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a 3/e`; `E5 2/2 6/6`; `E6 2/2` | `[Xe]`; `E4 3/e`; `E6 2/2` |
| 60 | Neodymium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f4` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a 4/e`; `E5 2/2 6/6`; `E6 2/2` | `[Xe]`; `E4 4/e`; `E6 2/2` |
| 61 | Promethium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f5` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a 5/e`; `E5 2/2 6/6`; `E6 2/2` | `[Xe]`; `E4 5/e`; `E6 2/2` |
| 62 | Samarium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f6` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a 6/e`; `E5 2/2 6/6`; `E6 2/2` | `[Xe]`; `E4 6/e`; `E6 2/2` |
| 63 | Europium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f7` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a 7/e`; `E5 2/2 6/6`; `E6 2/2` | `[Xe]`; `E4 7/e`; `E6 2/2` |
| 64 | Gadolinium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f7 5d1` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a 7/e`; `E5 2/2 6/6 1/a`; `E6 2/2` | `[Xe]`; `E4 7/e`; `E5 1/a`; `E6 2/2` |
| 65 | Terbium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f9` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a 9/e`; `E5 2/2 6/6`; `E6 2/2` | `[Xe]`; `E4 9/e`; `E6 2/2` |
| 66 | Dysprosium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f10` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a a/e`; `E5 2/2 6/6`; `E6 2/2` | `[Xe]`; `E4 a/e`; `E6 2/2` |
| 67 | Holmium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f11` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a b/e`; `E5 2/2 6/6`; `E6 2/2` | `[Xe]`; `E4 b/e`; `E6 2/2` |
| 68 | Erbium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f12` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a c/e`; `E5 2/2 6/6`; `E6 2/2` | `[Xe]`; `E4 c/e`; `E6 2/2` |
| 69 | Thulium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f13` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a d/e`; `E5 2/2 6/6`; `E6 2/2` | `[Xe]`; `E4 d/e`; `E6 2/2` |
| 70 | Ytterbium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6`; `E6 2/2` | `[Xe]`; `E4 e/e`; `E6 2/2` |
| 71 | Lutetium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d1` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 1/a`; `E6 2/2` | `[Xe]`; `E4 e/e`; `E5 1/a`; `E6 2/2` |
| 72 | Hafnium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d2` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 2/a`; `E6 2/2` | `[Xe]`; `E4 e/e`; `E5 2/a`; `E6 2/2` |
| 73 | Tantalum | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d3` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 3/a`; `E6 2/2` | `[Xe]`; `E4 e/e`; `E5 3/a`; `E6 2/2` |
| 74 | Tungsten | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d4` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 4/a`; `E6 2/2` | `[Xe]`; `E4 e/e`; `E5 4/a`; `E6 2/2` |
| 75 | Rhenium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d5` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 5/a`; `E6 2/2` | `[Xe]`; `E4 e/e`; `E5 5/a`; `E6 2/2` |
| 76 | Osmium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d6` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 6/a`; `E6 2/2` | `[Xe]`; `E4 e/e`; `E5 6/a`; `E6 2/2` |
| 77 | Iridium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d7` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 7/a`; `E6 2/2` | `[Xe]`; `E4 e/e`; `E5 7/a`; `E6 2/2` |
| 78 | Platinum | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s1 4f14 5d9` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 9/a`; `E6 1/2` | `[Xe]`; `E4 e/e`; `E5 9/a`; `E6 1/2` |
| 79 | Gold | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s1 4f14 5d10` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a`; `E6 1/2` | `[Xe]`; `E4 e/e`; `E5 a/a`; `E6 1/2` |
| 80 | Mercury | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a`; `E6 2/2` | `[Xe]`; `E4 e/e`; `E5 a/a`; `E6 2/2` |
| 81 | Thallium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p1` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a`; `E6 2/2 1/6` | `[Xe]`; `E4 e/e`; `E5 a/a`; `E6 2/2 1/6` |
| 82 | Lead | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p2` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a`; `E6 2/2 2/6` | `[Xe]`; `E4 e/e`; `E5 a/a`; `E6 2/2 2/6` |
| 83 | Bismuth | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p3` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a`; `E6 2/2 3/6` | `[Xe]`; `E4 e/e`; `E5 a/a`; `E6 2/2 3/6` |
| 84 | Polonium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p4` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a`; `E6 2/2 4/6` | `[Xe]`; `E4 e/e`; `E5 a/a`; `E6 2/2 4/6` |
| 85 | Astatine | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p5` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a`; `E6 2/2 5/6` | `[Xe]`; `E4 e/e`; `E5 a/a`; `E6 2/2 5/6` |
| 86 | Radon | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a`; `E6 2/2 6/6` | `[Xe]`; `E4 e/e`; `E5 a/a`; `E6 2/2 6/6`; `= [Rn]` |
| 87 | Francium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s1` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a`; `E6 2/2 6/6`; `E7 1/2` | `[Rn]`; `E7 1/2` |
| 88 | Radium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s2` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a`; `E6 2/2 6/6`; `E7 2/2` | `[Rn]`; `E7 2/2` |
| 89 | Actinium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s2 6d1` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a`; `E6 2/2 6/6 1/a`; `E7 2/2` | `[Rn]`; `E6 1/a`; `E7 2/2` |
| 90 | Thorium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s2 6d2` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a`; `E6 2/2 6/6 2/a`; `E7 2/2` | `[Rn]`; `E6 2/a`; `E7 2/2` |
| 91 | Protactinium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s2 5f2 6d1` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a 2/e`; `E6 2/2 6/6 1/a`; `E7 2/2` | `[Rn]`; `E5 2/e`; `E6 1/a`; `E7 2/2` |
| 92 | Uranium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s2 5f3 6d1` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a 3/e`; `E6 2/2 6/6 1/a`; `E7 2/2` | `[Rn]`; `E5 3/e`; `E6 1/a`; `E7 2/2` |
| 93 | Neptunium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s2 5f4 6d1` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a 4/e`; `E6 2/2 6/6 1/a`; `E7 2/2` | `[Rn]`; `E5 4/e`; `E6 1/a`; `E7 2/2` |
| 94 | Plutonium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s2 5f6` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a 6/e`; `E6 2/2 6/6`; `E7 2/2` | `[Rn]`; `E5 6/e`; `E7 2/2` |
| 95 | Americium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s2 5f7` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a 7/e`; `E6 2/2 6/6`; `E7 2/2` | `[Rn]`; `E5 7/e`; `E7 2/2` |
| 96 | Curium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s2 5f7 6d1` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a 7/e`; `E6 2/2 6/6 1/a`; `E7 2/2` | `[Rn]`; `E5 7/e`; `E6 1/a`; `E7 2/2` |
| 97 | Berkelium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s2 5f9` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a 9/e`; `E6 2/2 6/6`; `E7 2/2` | `[Rn]`; `E5 9/e`; `E7 2/2` |
| 98 | Californium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s2 5f10` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a a/e`; `E6 2/2 6/6`; `E7 2/2` | `[Rn]`; `E5 a/e`; `E7 2/2` |
| 99 | Einsteinium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s2 5f11` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a b/e`; `E6 2/2 6/6`; `E7 2/2` | `[Rn]`; `E5 b/e`; `E7 2/2` |
| 100 | Fermium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s2 5f12` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a c/e`; `E6 2/2 6/6`; `E7 2/2` | `[Rn]`; `E5 c/e`; `E7 2/2` |
| 101 | Mendelevium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s2 5f13` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a d/e`; `E6 2/2 6/6`; `E7 2/2` | `[Rn]`; `E5 d/e`; `E7 2/2` |
| 102 | Nobelium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s2 5f14` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a e/e`; `E6 2/2 6/6`; `E7 2/2` | `[Rn]`; `E5 e/e`; `E7 2/2` |
| 103 | Lawrencium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s2 5f14 7p1` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a e/e`; `E6 2/2 6/6`; `E7 2/2 1/6` | `[Rn]`; `E5 e/e`; `E7 2/2 1/6` |
| 104 | Rutherfordium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s2 5f14 6d2` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a e/e`; `E6 2/2 6/6 2/a`; `E7 2/2` | `[Rn]`; `E5 e/e`; `E6 2/a`; `E7 2/2` |
| 105 | Dubnium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s2 5f14 6d3` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a e/e`; `E6 2/2 6/6 3/a`; `E7 2/2` | `[Rn]`; `E5 e/e`; `E6 3/a`; `E7 2/2` |
| 106 | Seaborgium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s2 5f14 6d4` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a e/e`; `E6 2/2 6/6 4/a`; `E7 2/2` | `[Rn]`; `E5 e/e`; `E6 4/a`; `E7 2/2` |
| 107 | Bohrium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s2 5f14 6d5` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a e/e`; `E6 2/2 6/6 5/a`; `E7 2/2` | `[Rn]`; `E5 e/e`; `E6 5/a`; `E7 2/2` |
| 108 | Hassium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s2 5f14 6d6` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a e/e`; `E6 2/2 6/6 6/a`; `E7 2/2` | `[Rn]`; `E5 e/e`; `E6 6/a`; `E7 2/2` |
| 109 | Meitnerium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s2 5f14 6d7` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a e/e`; `E6 2/2 6/6 7/a`; `E7 2/2` | `[Rn]`; `E5 e/e`; `E6 7/a`; `E7 2/2` |
| 110 | Darmstadtium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s2 5f14 6d8` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a e/e`; `E6 2/2 6/6 8/a`; `E7 2/2` | `[Rn]`; `E5 e/e`; `E6 8/a`; `E7 2/2` |
| 111 | Roentgenium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s2 5f14 6d9` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a e/e`; `E6 2/2 6/6 9/a`; `E7 2/2` | `[Rn]`; `E5 e/e`; `E6 9/a`; `E7 2/2` |
| 112 | Copernicium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s2 5f14 6d10` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a e/e`; `E6 2/2 6/6 a/a`; `E7 2/2` | `[Rn]`; `E5 e/e`; `E6 a/a`; `E7 2/2` |
| 113 | Nihonium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s2 5f14 6d10 7p1` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a e/e`; `E6 2/2 6/6 a/a`; `E7 2/2 1/6` | `[Rn]`; `E5 e/e`; `E6 a/a`; `E7 2/2 1/6` |
| 114 | Flerovium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s2 5f14 6d10 7p2` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a e/e`; `E6 2/2 6/6 a/a`; `E7 2/2 2/6` | `[Rn]`; `E5 e/e`; `E6 a/a`; `E7 2/2 2/6` |
| 115 | Moscovium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s2 5f14 6d10 7p3` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a e/e`; `E6 2/2 6/6 a/a`; `E7 2/2 3/6` | `[Rn]`; `E5 e/e`; `E6 a/a`; `E7 2/2 3/6` |
| 116 | Livermorium | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s2 5f14 6d10 7p4` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a e/e`; `E6 2/2 6/6 a/a`; `E7 2/2 4/6` | `[Rn]`; `E5 e/e`; `E6 a/a`; `E7 2/2 4/6` |
| 117 | Tennessine | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s2 5f14 6d10 7p5` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a e/e`; `E6 2/2 6/6 a/a`; `E7 2/2 5/6` | `[Rn]`; `E5 e/e`; `E6 a/a`; `E7 2/2 5/6` |
| 118 | Oganesson | `1s2 2s2 2p6 3s2 3p6 4s2 3d10 4p6 5s2 4d10 5p6 6s2 4f14 5d10 6p6 7s2 5f14 6d10 7p6` | `E1 2/2`; `E2 2/2 6/6`; `E3 2/2 6/6 a/a`; `E4 2/2 6/6 a/a e/e`; `E5 2/2 6/6 a/a e/e`; `E6 2/2 6/6 a/a`; `E7 2/2 6/6` | `[Rn]`; `E5 e/e`; `E6 a/a`; `E7 2/2 6/6` |
