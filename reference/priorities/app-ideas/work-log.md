...
- The focused regression home is [standalone-app-launch.test.js](../../../tests/standalone-app-launch.test.js), which records the work-in-progress app scene mappings, Applications-scene home route, and unknown-scene cases with a Not advanced disposition.
