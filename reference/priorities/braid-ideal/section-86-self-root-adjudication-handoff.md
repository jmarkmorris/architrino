...
For every disposition, update the Section 86 evidence packet, `reference/priorities/braid-ideal/work-log.md`, and the replacement row in `reference/priorities/app-solver/claims-triage-ledger-2026-07-12.md`, then run the scoped validators before retirement.
