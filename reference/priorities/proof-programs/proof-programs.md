...
| `proof_program_handoff` | This file | [master-equation-closure](../master-equation-closure/master-equation-closure.md), [swarm](../swarm/tri-binary.md), and [dyadic-lock](../dyadic-lock/dyadic-lock.md) | Downstream priority links and AAA theorem-program chapters are updated whenever a proof target is promoted, blocked, or retired. |
