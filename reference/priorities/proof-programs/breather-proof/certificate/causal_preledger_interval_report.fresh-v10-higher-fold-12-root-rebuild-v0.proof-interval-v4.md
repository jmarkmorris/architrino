# Higher-Fold Proof-Interval Preledger v4 Report
...
| --- | ---: |
| Base rows | 1250 |
| Empty rows accepted by this proof-interval-v4 sidecar | 1088 |
| Range-empty rows accepted by this sidecar | 1062 |
| Empty rows accepted by proof-interval-v3 | 1088 |
...
| Minimum simple-root memory-depth margin | 0.108567583510299 |
| Minimum simple-root horizon margin | 3.105377996331238 |

Because `causal_ledger.fresh-v10-higher-fold-12-root-rebuild-v0.proof-interval-v4.json` records
`branch_chart_authorized=false`, no `branch_chart.json` may be constructed
from this packet.

The exact backend certificate is
`preledger_interval_backend_certificate.fresh-v10-higher-fold-12-root-rebuild-v0.proof-interval-v4.json`; the engine audit is
