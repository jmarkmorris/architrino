...
1. Use `next_candidate_solver_target.md` to instantiate a fresh fold-adapted collocation candidate for `doubled_four_arc_generic`; do not attempt another mesh-only rescue of the rejected cosine packet.
