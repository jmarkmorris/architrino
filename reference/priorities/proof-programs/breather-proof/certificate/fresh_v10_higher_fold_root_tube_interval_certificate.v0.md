# Fresh v10 Higher-Fold Root-Tube Interval Certificate

## Scope

This packet translates the binary64 root-tube attempt for
`fresh-v10-higher-fold-12-root-rebuild-v0` into exact-rational interval checks for the same
...
- Status: `outward_rational_interval_12_root_certificate_passed`
...
- Minimum root derivative floor:
  `20.353739080283133119`
- Minimum complement residual margin:
  `0.023248692491025871`
...
`fresh-v10-higher-fold-12-root-rebuild-v0` packet identity. The branch chart remains blocked
