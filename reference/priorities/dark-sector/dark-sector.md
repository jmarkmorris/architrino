...
3. `dark_visible_reentry_gate` — Define the threshold where a dark-sector assembly can react, thermalize, shed ordinary photons, or re-enter a visible channel without violating conservation or cosmology gates. Status: `pending`. Depends on: `candidate_assembly_registry`, radiation Gate C.
