...
| `field_speed_action_self_hit_scan` | [simulations.md](simulations.md) and [nested-shell-braid-action-increment-protocol](../../../content/markdown/aaa/validation/simulations/a1-action-increment-protocol.md) | [nested-shell-braid-action-increment-protocol](../../../content/markdown/aaa/validation/simulations/a1-action-increment-protocol.md) and [well-posedness-and-regularization](../../../content/markdown/aaa/validation/simulations/action-energy/well-posedness-and-regularization.md) | The binary approach-to-$c_f$ scan reports causal-root multiplicity, root-ledger stability, Jacobian floor, and action-increment clustering on the same rows before any `candidate_h_recovery` promotion. |
