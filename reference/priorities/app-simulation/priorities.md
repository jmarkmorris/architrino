...
[simulations.md](simulations.md) remains the focused source for the existing campaign objects, acceptance contracts, and executable diagnostic definitions until each owning tracker adopts or supersedes the relevant section. [brainstorming.md](brainstorming.md) remains provisional material, and [work-log.md](work-log.md) preserves dated history.
