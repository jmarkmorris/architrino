...
The solver is using unequal curve lengths to improve force closure. A retained shell braid branch candidate cannot do that unless it declares rational winding data or solves a common-period constraint.
