...
| [neutral-knot-cloud-branch-model.md](../neutral-swarm/neutral-knot-cloud-branch-model.md) | generalizes the neutral Noether core to six labeled architrinos, three positive and three negative, on free-support bounded-speed paths with no mandatory pairing | exact-antipodal, same-level, nested, and hybrid rows are now sector reductions until a general all-pairs branch certificate is emitted |
