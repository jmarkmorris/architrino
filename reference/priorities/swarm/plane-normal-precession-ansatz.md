...
Claim level: deformation theorem-target and simulation-target material. This packet does not claim a retained branch. It supplies the curve family, arclength constraints, curvature terms, root-ledger variations, and residual entries that a retained same-level tri-binary dynamics packet would have to close.
