...
Use `brainstorming.md` for provisional ideas, insights, conceptual maps, and draft app-facing guidance. Use the main priority tracker in this directory for the compact current queue, blockers, promotion routing, and next action. Keep focused standards, app specs, and requirement notes in their own sibling files when they need a stable structure.
