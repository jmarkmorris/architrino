...
- **Evidence:** The [UI-008 browser receipt](evidence/ui-008-shared-navigation-icon-repair.2026-09-02.json) records the pre-repair zero-size glyph fault and post-repair desktop/mobile measurements for Lorentz Geometry, Braid Search, and Borg Library. Focused tests enforce SVG namespace and canonical sizing ownership.
