...
1. `nuclear_radiation_worked_example` — Build the Pu-238 alpha-decay to heat-channel provenance object from the existing nuclear-binding packet, keeping gamma/photon rows separate from alpha and heat rows.
