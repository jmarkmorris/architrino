...
| Beta-stability valley and neutron excess in heavy nuclei. | Weak-channel provenance plus Noether sea response penalties constrain proton-neutron imbalance. | Require accepted weak quotient, reaction-event, lepton/neutrino, recoil, and Noether sea update rows before using beta-stability terms as promotion evidence. |
