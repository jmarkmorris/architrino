...
3. `nuclear_radiation_worked_examples` — Track alpha, beta, gamma, radioisotope, and heat-channel worked examples as nuclear reaction provenance before routing photon-source details to `EQ-29`. Status: `next`. Depends on: `nuclear_binding_packet_ownership`.
