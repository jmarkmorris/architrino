...
2. `iron_group_binding_cusp_recovery` — Test whether the same reduced nuclear assembly rows can produce a finite binding-per-nucleon maximum in the Fe/Ni neighborhood without per-element tuning. Status: `executable-toy-sweep-started`. Depends on: `nuclear_binding_packet_ownership`.
...
| `iron_group_binding_cusp_recovery` | [iron-group-binding-cusp-recovery.md](iron-group-binding-cusp-recovery.md), [brainstorming.md](brainstorming.md#worked-recovery-target-iron-group-binding-cusp), and [iron-group-binding-cusp-toy-sweep.mjs](../../../scripts/nuclear-atomic/iron-group-binding-cusp-toy-sweep.mjs) | [nuclear-binding](../../../content/markdown/aaa/nuclear-atomic/nuclear-binding.md) | The same reduced row bundle that passes deuteron, diproton, and saturation checks places the binding-per-nucleon maximum inside the Fe/Ni window without hidden element-specific tuning or shielded-energy leakage. |
