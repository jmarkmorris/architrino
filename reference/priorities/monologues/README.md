...
This priority area collects monologue pages that can become reader-facing historical commentaries.
...
Each monologue file should be named for the primary historical or contemporary figure when there is one clear voice, for example `william-thurston.md`.
...
- Use `content/markdown/aaa/philosophy-history/critical-questions.md` as the shared prompt all production monologues answer.
