...
| This file | [nested-shell-swarm-causal-closure/radiation-gate-c-benchmarks](../nested-shell-swarm-causal-closure/radiation-gate-c-benchmarks.md) | Test photon-channel mode restrictions and event-ledger balance. |
