...
| --- | --- | --- |
| This file | mass-map/condensed-matter-medium-transport (legacy-braid ref: `braid-mass-response-map/condensed-matter-medium-transport.md`) | Route material boundary response through medium transport rather than empty-space ontology. |
