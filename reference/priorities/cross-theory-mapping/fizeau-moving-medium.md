...
| --- | --- | --- |
| This file | [mass-map/condensed-matter-medium-transport](../braid-mass-response-map/condensed-matter-medium-transport.md) | Add moving material as a transport benchmark for medium-dressed propagation. |
| This file | [braid](../braid-retained-branch-closure/braid-retained-branch-closure.md) | Use Fizeau as a velocity-addition check tied to Lorentz closure. |
