...
| This file | [tri-binary-causal-closure](../tri-binary-causal-closure/tri-binary-causal-closure.md) | Use Fizeau as a velocity-addition check tied to Lorentz closure. |
