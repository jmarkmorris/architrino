...
| --- | --- | --- |
| This file | angular-momentum-spin/photon-measurement-bell-gates (legacy-braid ref: `braid-angular-momentum-spin/photon-measurement-bell-gates.md`) | Keep Malus' law inside photon Gate B and derive the projector, capture measure, material measure, and detector-bias diagnostic there. |
