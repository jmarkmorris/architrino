...
| This file | nested-shell-braid-causal-closure/residual-routing-event-ledger (legacy-braid ref: `braid-nested-shell-causal-closure/residual-routing-event-ledger.md`) | Require source loss and propagating disturbance to close one event ledger. |
