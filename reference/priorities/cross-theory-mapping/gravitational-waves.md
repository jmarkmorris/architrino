...
| This file | [nested-shell-swarm-causal-closure/residual-routing-event-ledger](../nested-shell-swarm-causal-closure/residual-routing-event-ledger.md) | Require source loss and propagating disturbance to close one event ledger. |
