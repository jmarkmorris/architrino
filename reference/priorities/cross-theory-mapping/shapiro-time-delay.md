...
| This file | mass-map/a0-medium-response-tensor-probe (legacy-braid ref: `braid-mass-response-map/a0-medium-response-tensor-probe.md`) | Use delay as a direct probe of the response tensor. |
