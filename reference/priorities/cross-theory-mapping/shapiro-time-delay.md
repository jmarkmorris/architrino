...
| --- | --- | --- |
| This file | [validation-gates](../validation-gates/validation-gates.md) | Add Shapiro delay as a gravity benchmark consuming the same $\mathcal{M}_{\mathrm{sea}}^{ab}$ as lensing and redshift. |
| This file | [mass-map/a0-medium-response-tensor-probe](../mass-map/a0-medium-response-tensor-probe.md) | Use delay as a direct probe of the response tensor. |
| This file | [master-equation-closure](../master-equation-closure/master-equation-closure.md) | Tie the effective delay to causal-wake propagation and assembly response. |
