...
| This file | nested-shell-braid-causal-closure/residual-routing-event-ledger (legacy-braid ref: `braid-nested-shell-causal-closure/residual-routing-event-ledger.md`) | Treat orbital decay as a routed conservation-ledger problem. |
