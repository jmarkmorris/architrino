...
4. `horizon_label_entropy` - Route black-hole entropy through the horizon-interface label ensemble and Page-curve release-channel target. Status: `draft`. Depends on: [strong-field-closure](../strong-field-closure/strong-field-closure.md), `windowed_entropy_functional`.
...
| [Black Holes](../../../content/markdown/aaa/spacetime/black-holes.md#horizon-interface) | Horizon entropy should count admissible horizon-interface Noether-core closure labels and recover area scaling as a benchmark. | derivation-closure target |
...
| Black-hole entropy | Horizon area and generalized entropy benchmarks | Count compatible horizon-interface Noether-core label states plus accessible outgoing channels | Derive $\mathcal{B}_H(M,\mathbf{J},Q)$ and Page-curve-compatible release accounting |
...
The area law is a benchmark to recover. The native content is the count over admissible Noether-core labels and release-channel ledgers.
...
| Horizon area imported as ontology | The strong-field packet has treated GR comparison geometry as primitive instead of deriving the horizon-interface label capacity. |
