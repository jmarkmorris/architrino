...
| Thermal, radiative, and QED corrections | [blackbody-radiation](blackbody-radiation.md), [radiative-corrections-lamb-shift-g-minus-2](radiative-corrections-lamb-shift-g-minus-2.md), [casimir-effect](casimir-effect.md) | Radiation Gate C, regularization, mode sums, boundary-sensitive vacuum or medium response. |
