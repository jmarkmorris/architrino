...
| --- | --- | --- |
| This file | braid (legacy-braid ref: `braid-retained-branch-closure/priorities.md`) | Add rotation as a path-history observable outside the inertial Lorentz cancellation. |
