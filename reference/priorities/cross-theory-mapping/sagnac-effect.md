...
| --- | --- | --- |
| This file | [tri-binary-causal-closure](../tri-binary-causal-closure/tri-binary-causal-closure.md) | Add rotation as a path-history observable outside the inertial Lorentz cancellation. |
