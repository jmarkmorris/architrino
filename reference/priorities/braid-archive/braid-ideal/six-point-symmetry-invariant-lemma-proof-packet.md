...
node scripts/braid-ideal/six-point-symmetry-invariant-lemma-row.mjs --force-law-equivariance-proof-ref=priority-proof-packet:reference/priorities/braid-archive/braid-ideal/six-point-symmetry-invariant-lemma-proof-packet.md --pretty
node scripts/check-receiver-normal-clean-slate.mjs
```

## Promotion Classification

- Corpus promotion: defer with blocker; candidate destinations after operator review are [nested-shell-braid-dynamics](../../../../content/markdown/aaa/noether-braid/braid-families.md#nested-shell-braid-dynamics) and [neutral-braid](../../../../content/markdown/aaa/noether-braid/braid-families.md#the-neutral-braid-base-of-the-family-ladder) as a theorem-target restatement without priority links.
