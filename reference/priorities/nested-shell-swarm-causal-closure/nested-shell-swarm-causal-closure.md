# Nested Shell Swarm Causal Closure: Rest Mass, Proper Time, and Relativistic Limits
...
6. `structural_integrity_common_limit` — Populate the common matter-limit, Noether sea dressed clock/ruler speed, photon-channel speed, clock/ruler deformation, and two-way signal residual from one retained branch record. Status: `proof-route-scaffolded; branch-population-blocked`. Depends on: `shared_branch_certificate_contract`, `photon_gate_a_kinematics`, `lorentz_residual_packet`, `lorentz_gr_bridge`.
...
- `shared_branch_certificate_contract` promoted the shared causal-closure certificate target into [nested shell swarm dynamics](../../../content/markdown/aaa/noether-swarm/nested-shell-swarm-dynamics.md); population remains blocked until a retained branch supplies the clock, ruler, signal, metric, mass-response, sector, and event-ledger rows together.
- `rest_mass_proper_time_relativity_synthesis` promoted its mass, proper-time, relativity, and equivalence-principle substance into [energy](../../../content/markdown/aaa/dynamics/energy.md), [particle masses](../../../content/markdown/aaa/assemblies/particle-masses.md), [proper time and time dilation](../../../content/markdown/aaa/spacetime/proper-time-and-time-dilation.md), [special relativity and deformable Noether swarms](../../../content/markdown/aaa/philosophy-history/theory-bridges/special-relativity-noether-swarm.md), and [nested shell swarm dynamics](../../../content/markdown/aaa/noether-swarm/nested-shell-swarm-dynamics.md); remaining proof burdens are carried by the active rows above.
- `plain_language_relativity_bridge` promoted its clock/ruler/speed-limit bridge into [special relativity and deformable Noether swarms](../../../content/markdown/aaa/philosophy-history/theory-bridges/special-relativity-noether-swarm.md) and [proper time and time dilation](../../../content/markdown/aaa/spacetime/proper-time-and-time-dilation.md).
...
This workstream owns the synthesis bridge from tri-binary Noether swarm closure to rest mass, proper time, effective Lorentz/GR behavior, photon propagation, and measurement. It is a proof-architecture and routing surface: active-development claims can live here while the dependency ladder is being built, but unresolved claims must be closed, retained as explicit roadmap items, routed to another priority workstream, or cut before deployment.

The deployed dynamics baseline is [nested shell swarm dynamics](../../../content/markdown/aaa/noether-swarm/nested-shell-swarm-dynamics.md). That chapter owns the Noether swarm roles, speed-regime conventions, delay-envelope geometry, gradient response, local clock diagnostics, and stability tests. This priority document should import those mechanisms rather than re-defining them, then test whether they support the mass, time, relativity, photon, and measurement claims in the sibling synthesis file.

## Detailed Priority Files

| File | Role | Primary promotion targets |
| --- | --- | --- |
| [nested-shell-swarm-dependency-map.md](nested-shell-swarm-dependency-map.md) | Active proof-dependency map and deployment handoff table for open claims. | [nested-shell-swarm-dynamics](../../../content/markdown/aaa/noether-swarm/nested-shell-swarm-dynamics.md), [energy](../../../content/markdown/aaa/dynamics/energy.md), [master-equation](../../../content/markdown/aaa/dynamics/master-equation.md), [emergent-metric](../../../content/markdown/aaa/spacetime/emergent-metric.md) |
| [nested-shell-swarm-motion-model-eom-accepted.md](nested-shell-swarm-motion-model-eom-accepted.md) | Priority-only EOM-accepted conceptual model for shell identity, motion exchange, phase exchange, constraint retuning, and simulation variables. | [nested-shell-swarm-dynamics](../../../content/markdown/aaa/noether-swarm/nested-shell-swarm-dynamics.md), [noether-swarm](../../../content/markdown/aaa/noether-swarm/noether-swarm.md), [README](../../../content/markdown/aaa/validation/simulations/README.md) |
...
- [special-relativity-noether-swarm](../../../content/markdown/aaa/philosophy-history/theory-bridges/special-relativity-noether-swarm.md)
