...
| [Shared Branch Certificate Contract](nested-shell-swarm-causal-closure.md#shared-branch-certificate-contract) | The accepted branch package already carries $c_f$, $c_{\text{eff}}$, $c_\gamma$, $c_0$, active-root ledger, stability gaps, Lorentz residual, photon rows, medium response, and event ledger. |
