...
| Bucket | Status |
| --- | --- |
| Assumption | The Master EOM is accepted as the substrate dynamics for each architrino; absolute substrate time $t$, Euclidean distance, causal roots, source-normal denominators, and receiver-normal wake hits are the primitive calculation layer. |
