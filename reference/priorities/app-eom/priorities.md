...
- [master-eom-binding-v0.md](master-eom-binding-v0.md) is the frozen mathematical contract for the sharp and finite-width receiver-side-factor laws, core kernel, root aggregation, self-hit treatment, and caustic route.
