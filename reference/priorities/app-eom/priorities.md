...
- [evolution-contract-v1-amendment-1-million-path-scale.md](evolution-contract-v1-amendment-1-million-path-scale.md) is the frozen scale amendment requiring million-path manifests, complete compact pair accounting, certified sparse evolution, and fail-closed dense-workload handling.
...
- [evidence/borg-receiver-factor-contract-migration-2026-07-19.md](evidence/borg-receiver-factor-contract-migration-2026-07-19.md) records the current Borg request identity, certified-budget hashes, fail-closed negative controls, and complete receiver-factor migration rerun.
...
5. `million_path_performance_and_acceptance_gate` — Pass `eom_evolution_contract/v1/amendment-1` with complete compact accounting of all $10^{12}$ ordered relationships, exhaustive nested controls, heterogeneous parity, distributed restart, and dense-workload fail-closed evidence.
