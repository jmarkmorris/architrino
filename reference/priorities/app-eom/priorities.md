...
10. `consumer_migration` — Every consumer runs on EOM, conditional prescribed-history analysis, or visualization-only playback of recorded EOM datasets. Status: `complete`. Depends on: `eom_sole_engine`.
