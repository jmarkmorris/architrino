...
- [master-eom-binding-v0-common-domain-matching-amendment-proposal.md](master-eom-binding-v0-common-domain-matching-amendment-proposal.md) derives the positive-regulator common-domain matching remainder and stages a binding clarification pending operator ratification; it changes neither the frozen law nor current engine authority.
