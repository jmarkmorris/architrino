...
| --- | --- | --- | --- |
| Retired 2026-07-18 import-audit dispatch, P6/P6A | Stated that a 2026-07-09 native confirmation run measured a speed attractor near $c_f$; the statement is preserved here because the dispatch itself has been retired. | Reported measured claim. | No run artifact, executable identity, seed, speed trace, duration, tolerance, convergence ladder, retained history, root ledger, or $m$-stratum table is linked. A located immutable packet containing those records would upgrade this inventory. |
