...
observed 2:2 assembly) into headless, checkpointed, collapse-protocol-
compliant campaigns with a replay format the Borg app can visualize.

Live routing: [priorities.md](priorities.md). Provisional capture: [brainstorming.md](brainstorming.md). Governing discipline:
evidence-independence and claim-grading per AGENTS.md; endpoint-matched
prehistory collapse protocol.
