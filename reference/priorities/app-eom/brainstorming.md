...
### Candidate Assembly Formation

- **2026-07-20 operator observation, Display grade:** a 2-electrino/2-positrino run spontaneously separated into two visually distinct 1:1 opposite-polarity pairs. Both pairings remained recognizable roughly 2.5 minutes into simulation time, and the run continued to `T=186.3`. This is the first reported persistent candidate-assembly formation in Borg. It is encouraging exploratory evidence, not an accepted assembly result: Display grade has no claim authority, and visual persistence alone does not establish bounded relative motion, a retained branch, perturbation stability, or convergence.
