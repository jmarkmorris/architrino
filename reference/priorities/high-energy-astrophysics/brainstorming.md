...
3. Planar-photon recovery: photon-path or light-ring evidence must pass through the coaxial contra-rotating polarity-conjugate planar pair and planar tri-binary reduced chart without replacing the horizon-interface carrier.
