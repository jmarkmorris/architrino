...
- If the goal is the fastest validated-closure score increase, pair this workstream with [residual-routing-event-ledger](../tri-binary/residual-routing-event-ledger.md), [exposure-quotient-theorem](../mass-map/exposure-quotient-theorem.md), and [mass-map](../mass-map/mass-map.md) rather than treating prose coverage as the main lift.
