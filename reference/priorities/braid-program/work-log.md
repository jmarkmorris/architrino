...
- Moved [candidate requirement adjudication](braid-candidate-requirement-adjudication.md), [F6c geometry](f6c-geometry.md), [three-binary geometry](three-binary-orbiting-endpoint-comparison.md), [five-coordinate initialization](three-binary-five-coordinate-initialization-ledger.md), and the [bounded EOM comparison](three-binary-five-coordinate-bounded-eom-comparison.md) from Mapping Electromagnetism into this program. General [requirement inference](../mapping-equations/inferring-braid-requirements.md) moved to Equation Mapping.
- Moved the [F6c dual-turn](f6c-dual-turn-return-search-2026-08-24.json), [radial-frequency](f6c-radial-frequency-continuation-2026-08-24.json), and [three-binary comparison](three-binary-five-coordinate-bounded-eom-comparison-2026-08-25.json) JSON evidence alongside their documents without changing their bytes. Earlier campaign entries remain in the originating [Mapping Electromagnetism log](../mapping-electromagnetism/work-log.md).
