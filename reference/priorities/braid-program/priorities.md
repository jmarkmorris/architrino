...
- Engine: root-completeness certificate extension (owned by the app-solver wall packet) — gates any campaign whose windows cross field-speed folds.
- Instrument cross-verification tiers 2–4 (app-solver) — informs which quantities are cheap to re-establish fresh.
