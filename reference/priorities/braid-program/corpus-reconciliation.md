...
Status: DRAFT plan from the 2026-07-15 operator-requested review of all 11 `content/markdown/aaa/noether-braid/` files (5,202 lines; three parallel full-read reviewers plus direct verification of the headline items). Purpose: excise failed-campaign content from the reader-facing braid chapters and reorganize the scene, per the fresh-start decision. Execution is operator-gated per file; nothing here edits canon by itself.
