# Coincident-midpoint common-frequency three-axis circular configuration Narrow Retained-History Policy Extension Diagnostic
...
The earlier [history-edge boundary receipt](2026-07-28-coincident-midpoint-common-frequency-outer-radius-second-band-boundary.md) remains unchanged and retains its `counterexample-diagnostic` classification under $\chi=9/4$. Its protocol, result, and summary reproduced exactly with hashes `a051e8f4637302523a9c3732362085acd810295edb1450c2f9ed078cc66fb92c`, `55d64d083a315446c6ce4d7c107e2ff953a3ca8a407f887c59d0e75045adc80a`, and `a8e521ac0743c406ab4ec233957f5e170338808736ce7815ac9250d15857680e`. The old boundary owns the shared left endpoint.
...
The owner is the [history-extension protocol](../../../../src/prescribed-path-analysis/protocols/coincident-midpoint-common-frequency-outer-radius-history-policy-extension-protocol.v1.json). Its protocol hash is `4e864e3ff3e3bb6799e70e6715643fd23b902edde482b1f4591a8207ca6748ff`. The result hash is `89b3f68c47bec47f92e4faf0f8acb41dc7381e76f9893d3892af96662ea5aa11`. The [durable summary](coincident-midpoint-common-frequency-outer-radius-history-policy-extension-summary.v1.json) hash is `71015bcb1a5c83e850b17ea122b196bf2910f1cd9c2457c28b167c665fa55424`. The complete ignored ledger is `.local-data/braid-program/coincident-midpoint-common-frequency/coincident-midpoint-common-frequency-outer-radius-history-policy-extension.v1.json.gz` with raw-ledger hash `2bcd8952bc44205775cec5bd3348f24fcf2d89a60704cab23d5d09cafc888dc1`. The deterministic replay command is:

```bash
node scripts/prescribed-path-analysis/run-coincident-midpoint-common-frequency-outer-radius-history-policy-extension.mjs --check
```
