# F5 Independent Interpolation Enclosure

Status: **accepted independent enclosure** for the exact operator-approved phase-varying F5 prescribed row. This packet closes only the analytic-to-cubic uncertainty widths required by the clean `H3` restart predeclaration.

## Frozen identity

- Approved F5 source: `reference/priorities/braid-program/configurations/f5-phase-varying-campaign.v2.json`, SHA-256 `e92e450c8ea83086b60184d31ff5b07fe8a470b1e20088ea312592f2b38800fb`.
...
Plainly: every stored cubic segment may differ from the exact analytic F5 path by at most these declared position and velocity widths under this instrument. These widths are the uncertainty inputs for the separately authored root adapter; they are not zero-width nominal-copy tolerances.
...
This packet establishes an independent analytic-to-cubic interpolation enclosure for the frozen prescribed F5 row. It does not establish complete causal-root accounting, `H3`, ordinary EOM evolution, binding, retention, stability, candidate promotion, score change, particle identity, or physical realization.
...
Closure goal: preserve the exact enclosure and use it unchanged in the separately authored F5 `H3` adapter.
