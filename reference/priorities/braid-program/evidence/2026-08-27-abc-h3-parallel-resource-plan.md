# A/B/C Measured Parallel Resource Contract
...
| --- | ---: | --- | ---: |
| A1.1 | 1013.071 | within estimate | 1800 |
| A1.2 | 999.998 | within estimate | 1800 |
| A1.4 | 1013.191 | within estimate | 1800 |
| A2 | 1015.974 | within estimate | 1800 |
| A3.1 | 1020.919 | within estimate | 1800 |
| A3.2 | 1018.104 | within estimate | 1800 |
| A3.4 | 1035.267 | within estimate | 1800 |
| B1.1 | 1021.044 | within estimate | 1800 |
| B1.2 | 1027.130 | within estimate | 1800 |
| B1.3 | 1014.821 | within estimate | 1800 |
| C1 | 2130.590 | resource return | 3600 |
| C2 | 2129.028 | resource return | 3600 |
| C3 | 2138.593 | resource return | 3600 |
| C4 | 2141.604 | resource return | 3600 |
| C5 | 2133.617 | resource return | 3600 |
| C6 | 2137.211 | resource return | 3600 |
...
This document is the separately reviewed resource-return contract required by the [original pilot declaration](2026-08-27-abc-h3-pilot-predeclaration.md). For C1–C6 only, its accepted generation replaces the original 1,800-second per-rung ceiling with 3,600 seconds. That ceiling gives approximately 1.68 times the largest measured serial projection; it is a bounded operational allowance, not a runtime guarantee. A/B retain 1,800 seconds. The original declaration is preserved unchanged. A larger allowance than this contract, or a changed concurrency budget, requires another resource declaration before execution.
...
The machine-readable cohort ceiling overrides the top-level 1,800-second default only for a cohort whose increased ceiling has an independently accepted, hash-bound resource-return contract. Thus C1–C6 use 3,600 seconds only under this accepted contract, while A/B remain at 1,800 seconds. An ambiguous cohort partition or override rejects the plan before any job starts.
