...
The regular alternating $2N$-gon contains a prescribed acceleration-balanced candidate for every tested $N\in\{2,3,4,5,6\}$ under the default uncapped Master Equation with $c_f=1$. Exactly one of those five representative loci is B1.3: the $N=3$ regular alternating hexagon. The other regular polarity classes are bounded negatives on $0.05\leq\beta_f\leq20$. The nonuniform fixed-phase searches establish no additional nonregular solution and do not close their multidimensional domains; they remain unresolved. The dedicated equal-radius antipodal-neutral B1.3 phase search contains the verified regular candidate but does not establish the broader unequal-phase chart.

Plainly: five rigid regular rings pass the acceleration equation, one for each tested inventory size. Only the six-member ring has the exact three-neutral-binary inventory needed for B1.3. The wider phase searches are evidence of where this run looked, not proofs that no other arrangements exist.
...
| $N$ | Symmetry-inequivalent balanced classes | Alternating antipodes | Exact taxonomy of balanced representative | $\beta_f$ | $R/R_*$ | Directed roots | Max radial residual | Max tangential residual | Max axial residual | Max full residual | Tightened max full residual | Minimum Jacobian floor | Verdict |
| ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 2 | 2 | Like polarity | $2{:}2$ shared-circle assembly outside B1.3 | 2.1472456589006224 | 0.4161828083090951 | 24 | $4.440892098500626\times10^{-16}$ | $5.36654054528185\times10^{-13}$ | 0 | $5.366541004644862\times10^{-13}$ | $4.8905324234738146\times10^{-14}$ | 0.3171169078837861 | Balanced candidate |
| 3 | 3 | Neutral | B1.3 equal-radius planar locus | 2.974307176117306 | 0.5617317000713459 | 72 | $3.2862601528904634\times10^{-14}$ | $6.88338275267597\times10^{-14}$ | 0 | $7.62510728881475\times10^{-14}$ | $4.500069559058899\times10^{-12}$ | 0.11680602873827528 | Balanced candidate |
| 4 | 7 | Like polarity | $4{:}4$ shared-circle assembly outside B1.3 | 1.6595117714602787 | 1.7441728749235372 | 80 | $7.993605777301127\times10^{-15}$ | $2.8634872251132037\times10^{-12}$ | 0 | $2.8634872251132037\times10^{-12}$ | $5.389468480375884\times10^{-12}$ | 0.1379452644538317 | Balanced candidate |
| 5 | 13 | Neutral | $5{:}5$ shared-circle assembly outside B1.3 | 1.5556550244378213 | 2.7040642782802484 | 120 | $1.1546319456101628\times10^{-14}$ | $7.644551658358978\times10^{-12}$ | 0 | $7.644554186576438\times10^{-12}$ | $3.45619090729925\times10^{-11}$ | 0.1049072417723822 | Balanced candidate |
| 6 | 35 | Like polarity | $6{:}6$ shared-circle assembly outside B1.3 and outside C5/C6 | 1.484095961562689 | 3.842971035530748 | 168 | $1.2434497875801753\times10^{-14}$ | $1.8199219908865416\times10^{-11}$ | 0 | $1.8199219995557143\times10^{-11}$ | $7.628744473244363\times10^{-11}$ | 0.08372241039222517 | Balanced candidate |
...
## B1.3 Coordinate Gate

The $N=3$ alternating record maps to B1.3 label by label: six architrinos form three opposite-polarity antipodal pairs; every pair has midpoint at the common center; all paths lie in the same plane normal to one axis; all have the same radius, frequency, and circulation; and each binary has $h_a=0$ and $\rho_a=R_a$. Written by binary, the positive endpoints have phases $0$, $2\pi/3$, and $4\pi/3$, and their negative partners are shifted by $\pi$. This is the equal-radius phase-symmetric point inside the live B1.3 chart.

Plainly: the taxonomy name follows from the live coordinates, not from the ring looking hexagonal. The $N=2$, $4$, $5$, and $6$ records fail the B1.3 inventory gate before any dynamical result is considered.

The dedicated equal-radius antipodal-neutral chart reproduces the same B1.3 point at $\beta_f=2.974307176117306$ and $R/R_*=0.561731700071346$, with 72 directed roots, maximum full residual $8.133005053399885\times10^{-14}$, tightened maximum full residual $4.513593857146302\times10^{-12}$, and minimum Jacobian floor $0.11680602873827572$. Its broader unequal-phase verdict is `unresolved`. Unequal radii were outside this campaign.
...
The next genuine B1.3 blocker is a separately predeclared ordinary EOM-solver evolution from this balanced locus with complete retained prehistory, identical coupling, guarded root continuity, and a retained-branch decision. A claim about more than the regular locus separately requires controlled coverage of unequal phases and unequal radii.
