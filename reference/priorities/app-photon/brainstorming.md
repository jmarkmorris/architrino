...
Folded on 2026-09-05 from `app-photon/analysis/configuration-search-deep-comparison.md`, which was a separate file that had no reader and no promotion route. Content is unchanged apart from heading depth.
