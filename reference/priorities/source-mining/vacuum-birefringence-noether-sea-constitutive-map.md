...
| Source | Role | Traceability |
| --- | --- | --- |
| Anton Petrov, [NASA Proves Vacuum Turns Into a Quantum Crystal Around Magnetars](https://www.youtube.com/watch?v=GytF4hWjd9U), What Da Math, August 13, 2026, 15:48 | Popular overview and source lead. | English-original automatic-caption artifacts `/tmp/GytF4hWjd9U.en-orig.json3`, `/tmp/GytF4hWjd9U.en-orig.vtt`, and `/tmp/GytF4hWjd9U.en-orig.timestamped.txt`; caption JSON SHA-256 `0cb80ec84445d4ccfa01e4b81fe8fa654306c02a969751c7cbb1c3f7a1afe3ef`. |
| Michael Allen, [NASA's IXPE May Have Proven 90-Year-Old Theory](https://science.nasa.gov/missions/ixpe/nasas-ixpe-may-have-proven-90-year-old-theory/), NASA Science, August 5, 2026 | Mission summary and authority-bound public interpretation. | Local HTML `/tmp/pdfs/GytF4hWjd9U/nasa-ixpe.html`. |
| Rachael E. Stewart et al., [Vacuum birefringence and the polarized X-ray emission from a radio magnetar](https://arxiv.org/abs/2509.19446), arXiv:2509.19446v4, Nature (2026), DOI `10.1038/s41586-026-10859-z` | Primary observation and model-comparison source. | PDF `/tmp/pdfs/GytF4hWjd9U/2509.19446.pdf`, 33 pages, SHA-256 `b014e7c58c3ff1d4bb4732fe11d3ecbfb60221ed87cda47708420e7257f62368`; text and selected rendered pages in the same scratch directory. |
| Jeremy S. Heyl and Nir J. Shaviv, [Polarization Evolution in Strong Magnetic Fields](https://arxiv.org/abs/astro-ph/9909339), MNRAS 311 (2000) 555-564 | Polarization-state transport, adiabatic following, and freeze-out mathematics. | PDF `/tmp/pdfs/GytF4hWjd9U/astro-ph-9909339.pdf`, 23 pages, SHA-256 `84a9fe1e82d191466c198b8df9b1570a39cbfb3b5b2c5a951a6c886cbdb165b3`. |
| Jeremy S. Heyl, Nir J. Shaviv, and Don Lloyd, [The High-Energy Polarization-Limiting Radius of Neutron Star Magnetospheres I](https://arxiv.org/abs/astro-ph/0302118), MNRAS 342 (2003) 134-144 | Image-integrated polarization and polarization-limiting-radius source. | PDF `/tmp/pdfs/GytF4hWjd9U/astro-ph-0302118.pdf`, 23 pages, SHA-256 `87d346716764a60ac8c7d621467f33c01efeeeaa73670490e3fb6ad1fce3dfc1`. |
| Dong Lai and Wynn C. G. Ho, [Polarized X-Ray Emission from Magnetized Neutron Stars: Signature of Strong-Field Vacuum Polarization](https://arxiv.org/abs/astro-ph/0303596), PRL 91 (2003) 071101 | Two-mode resonance and energy-dependent mode-conversion source. | PDF `/tmp/pdfs/GytF4hWjd9U/astro-ph-0303596.pdf`, 4 pages, SHA-256 `39a6d684f09cf9e1b9c9f0c55af27aaaef7eb67293db9e137e2f7374c2f81129`. |
...
| Time | Signal | Disposition |
| --- | --- | --- |
| 00:35-01:48 | Vacuum is described as a physical crystal and lens, followed by a claim of definitive direct proof. | Preserve only the measured polarization and direction-dependent propagation signal. Reject the literal crystal and proof upgrade. |
| 02:10-04:53 | Ordinary crystal birefringence is explained as two polarization modes with different response. | Useful effective analogy for a two-eigenvalue response tensor; no lattice or material-crystal ontology transfer. |
| 05:04-07:02 | QED is narrated as virtual electron-positron pairs borrowing energy and shielding mass and charge. | Do not import. These are standard-theory interpretation and popularization, not an architrino-level mechanism. |
| 07:11-09:34 | A strong ordered loading is said to make propagation anisotropic. | High-value reframed map: derive an orientation-dependent Noether sea response from the same retained state that supplies the ordinary weak homogeneous limit. |
| 09:41-10:35 | The 2016 optical result for RX J1856.5-3754 is presented as an earlier hint. | Source lead only; its inference depends strongly on surface and viewing models. |
| 10:35-12:01 | The coordinated IXPE/NICER/Parkes campaign and high polarization are summarized. | Observer-level measurement record. Preserve phase, energy, Stokes, geometry, and instrument provenance. |
| 12:02-13:27 | High polarization, large propagation distance, and the energy-dependent dip are called direct QED confirmation. | Keep as model-comparison and mode-transport pressure. The source paper itself retains model dependence and asks for deeper observations. |
| 13:56-14:19 | Vacuum is declared a physical medium. | Not an ontological result. For $\mathbb{A}\mathbb{A}\mathbb{A}$, the data constrain photon transport through a strongly loaded region; they do not identify what the medium is. |
...
$$
\chi_{\gamma}^{ab}
(\omega,\mathbf{k};\theta_{\mathrm{sea}})
=
...
\frac{
\left\|
d\widehat{\boldsymbol{\Omega}}_{\gamma}/d\ell
\right\|
}{
\left\|
\boldsymbol{\Omega}_{\gamma}
...
=
\begin{pmatrix}
g(\ell,\omega)/2 & \kappa(\ell,\omega)\\
\kappa^*(\ell,\omega) & -g(\ell,\omega)/2
\end{pmatrix},
$$
...
$$
\operatorname{Re}\lambda_a(\omega)
=
\mathcal H
\left[
\operatorname{Im}\lambda_a
\right](\omega)
+
R_{\mathrm{KK},a}.
$$
...
| --- | --- | --- |
| Magnetized quantum vacuum | Reframe as a strongly loaded Noether sea region; do not identify the two ontologies. | [Pressure-dependent Noether sea constitutive response](../master-equation-closure/pressure-dependent-noether-sea-constitutive-response.md) |
...
| Vacuum resonance | Reframe as a possible avoided crossing of two derived response eigenmodes. | Same-record Noether sea plus local matter response |
| Virtual electron-positron pairs | Standard QED interpretation; barred as architrino-level premise. | Recovery comparison only |
| Crystal lattice or crystallized void | Popular analogy; reject as ontology. | No corpus destination |
