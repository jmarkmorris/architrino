...
- If the goal is the fastest validated-closure score increase, pair this workstream with residual-routing-event-ledger (legacy-braid ref: `braid-nested-shell-causal-closure/residual-routing-event-ledger.md`), exposure-quotient-theorem (legacy-braid ref: `braid-mass-response-map/exposure-quotient-theorem.md`), and mass-map (legacy-braid ref: `braid-mass-response-map/priorities.md`) rather than treating prose coverage as the main lift.
