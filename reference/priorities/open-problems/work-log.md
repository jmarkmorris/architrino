...
- Routed the micro/meso/macro bridge to [Mapping Benchmarks](../mapping-benchmarks/brainstorming.md), the drift-relaxed moving-branch instrument to [EOM](../app-solver/brainstorming.md), and the three-axis/Witten-chain proof gap to [Standard Model Closure](../standard-model-closure/brainstorming.md).
