...
This file records dated evidence-audit receipts, assumption decisions, route
adjudications, and handoffs. Detailed reasoning belongs in
[brainstorming.md](brainstorming.md); executable objects belong in
...
a detailed summary of the preceding discussion. The canonical four-file lane
was created with an explicit ownership boundary: it owns Bell assumptions,
experimental evidence, finite-speed/Bancal analysis, and route adjudication;
Quantum Closure continues to own detector, measure, correlation, and Bell-gate
derivations.

The discussion record preserves the 2026-07-28 primary-source audit and a
2026-08-05 recheck of the live owning pages. The lane is unranked and
`discussion-scoped`. No Bell mechanism was selected, no corpus claim was
promoted, and no generated artifact was changed.

The first unresolved object is the operator's intended assumption scope for
“decided at entanglement.”

### 2026-08-05 — Tim Maudlin Bell-foundations interview mined

The operator requested a best-practice source-mining pass over Curt
...
The pass sharpened EPRB-001, EPRB-002, and EPRB-004 without creating a new
gate. It did not accept Maudlin's methodological rejection of measurement
dependence as a theorem, did not broaden PBR beyond preparation independence,
and did not select nonlocality or a live finite-$c_f$ channel as the
$\mathbb{A}\mathbb{A}\mathbb{A}$ route. No reader-facing corpus or generated
artifact was changed. The operator's subsequent refinement—that Bell's early
papers support the EPR completion program and that Bell backed into the
obstruction through that investigation—was checked against Bell's 1964 and
1966 papers and retained with one boundary: the discovery route was
exploratory, while the published theorem deliberately closes the local
completion branch.
...
The retained advances are a scope guard between one-particle predecision and
two-wing Bell predecision, a warning that ontic definiteness does not supply
the Bell joint law, a separation of conservation constraints from response
mechanisms, and a conditional-information map of Bell factorization,
measurement independence, and no-signaling. No new gate or Bell route was
created. The lecture explicitly stops before its promised Bell derivation, so
it was not used as theorem or experiment evidence. No reader-facing corpus or
