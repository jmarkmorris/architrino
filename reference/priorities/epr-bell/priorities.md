...
Maintain the evidence-backed Bell-assumption ledger and adjudicate exactly
which mathematical or experimental assumption any proposed
$\mathbb{A}\mathbb{A}\mathbb{A}$ route changes. Keep Bell's theorem,
loophole-controlled experiments, finite-influence-speed bounds, the Bancal
...
- the primary-source experiment chronology and category-by-category evidence
  comparison;
- the proof boundary for “decided at entanglement”;
- finite-speed influence constraints and the Bancal-premise audit;
- the comparison map among passive shared record, live coordination,
  measurement dependence, retrocausality, global nonseparability, and
  apparatus/trial effects;
- reconstruction of Bell-route decisions, contradictions, alternatives, and
...
- Do not treat a conditional lower bound on a hypothetical influence speed as
  a measured universal constant or identify it with $c_f$ without an explicit
  model bridge.
- Do not assume loss of live-channel reach forces $S\to2$; the unreachable
  fallback law and timing mixture must be declared.
...
A route may become a canonical Bell mechanism only after its variables,
causal structure, changed Bell assumption, two-wing joint law, one-wing
marginals, trial-selection rule, preferred-frame timing law where applicable,
multipartite behavior, and operator-checkable falsifier are all explicit and
its required upstream Quantum Closure objects are accepted.
