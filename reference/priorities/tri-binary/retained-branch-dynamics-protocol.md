...
| `state_vector` | $X_q$, $\mathcal{H}_q$, support band, center gauge, polarities, and inventory |
...
| `optimization` | $\mathcal{J}$, active constraints, weights, barriers, and refinement result |
