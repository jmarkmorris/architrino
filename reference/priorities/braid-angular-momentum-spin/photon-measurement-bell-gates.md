...
3. **Planar-pair geometry.** Gate B depends on the coaxial contra-rotating polarity-conjugate planar pair: the pro/anti static exposures must cancel while a transverse oscillatory action ledger survives.
