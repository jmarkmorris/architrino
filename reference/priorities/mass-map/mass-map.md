...
| Dynamics baseline | [Nested Shell Swarm Dynamics](../../../content/markdown/aaa/noether-swarm/nested-shell-swarm-dynamics.md) | Noether-core roles, speed-regime conventions, delay geometry, stability diagnostics, and metric/connection reconstruction diagnostics. |
...
| Proof synthesis | [Swarm](../swarm/tri-binary.md) | Active-development migration bridge from the Tri-Binary model to rest mass, inertia, proper time, photon behavior, and effective geometry. |
