...
![Reverse text band](../../../content/assets/images/archie/childrens-books/text-layout-reverse-band-clean.png)
...
![Reverse band Shorts/TikTok version](../../../content/assets/images/archie/childrens-books/text-layout-reverse-band-shorts-tiktok-9x16.png)
...
This should be the default export for short-video-first public distribution. If a short is animated later, use the same safe-zone structure: moving art above, reverse text band below, no essential geometry at the extreme bottom or far right.

## Feed Portrait Version

![Reverse band portrait social version](../../../content/assets/images/archie/childrens-books/text-layout-reverse-band-social-portrait.png)
