...
def entry_paths(entry: dict) -> dict:
    ...
    return {
        ...
        "qa_json": f"reference/office-of-learning/childrens-books/production/qa/{slug}/{eid}.qa.json",
        "qa_markdown": f"reference/office-of-learning/childrens-books/production/qa/{slug}/{eid}.qa.md",
...
def build_manifest() -> dict:
    ...
    return {
        ...
        "root": "reference/office-of-learning/childrens-books",
