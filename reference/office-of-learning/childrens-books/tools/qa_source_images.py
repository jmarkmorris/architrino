...
MANIFEST = REPO / "reference/office-of-learning/childrens-books/production/generation-manifest.json"
...
def main() -> None:
    ...
    qa_root = REPO / "reference/office-of-learning/childrens-books/production/qa" / args.book
