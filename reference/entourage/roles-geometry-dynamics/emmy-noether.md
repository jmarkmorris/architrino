...
- Treat `reference/priorities/tri-binary/tri-binary-dependency-map.md` as the active theorem-burden ledger for Lorentz, mass, photon, and effective-metric closure claims.
