...
- Branch statistics must respect retained-record fields from `noether-braid/braid-families.md`: active causal-root ledger, finite memory depth, branch-Jacobian floor, inactive-root gap, Floquet gap, and event ledger.
