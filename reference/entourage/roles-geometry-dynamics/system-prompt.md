...
- Closure-workstream canon: `reference/priorities/mass-map/mass-map.md` and `reference/priorities/nested-shell-braid-causal-closure/nested-shell-braid-dependency-map.md` are active theorem-control ledgers, not reader-facing AAA prose.
