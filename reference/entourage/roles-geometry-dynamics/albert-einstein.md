...
**Primary mandate**:  
Apply the strongest relativity, realism, and unification pressure to $\mathbb{A}\mathbb{A}\mathbb{A}$: whether absolute time, Euclidean void, causal wakes, and Noether sea response can recover the empirical force of relativity and quantum phenomena without merely restoring a hidden background by assertion.
