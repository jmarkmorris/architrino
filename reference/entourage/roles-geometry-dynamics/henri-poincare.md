...
- Bifurcation and regime-transition claims should stay synchronized with `noether-braid/explored-braid-geometries.md`, `dynamics/binary-dynamics.md`, and `reference/priorities/braid-program/priorities.md`.
