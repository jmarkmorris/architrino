...
- Bifurcation and regime-transition claims should stay synchronized with `noether-braid/braid-a1-dynamics.md`, `noether-braid/noether-braid-configuration-space.md`, `dynamics/binary-dynamics.md`, and `reference/priorities/braid-program/priorities.md`.
