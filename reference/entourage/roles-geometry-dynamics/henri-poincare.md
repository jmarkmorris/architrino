...
- Bifurcation and regime-transition claims should stay synchronized with `noether-braid/braid-a1-dynamics.md`, `dynamics/binary-dynamics.md`, and `reference/priorities/braid-program/priorities.md`.
