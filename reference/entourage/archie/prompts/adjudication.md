...
- Confirm the discipline was kept: the central solver and other owned engines untouched; runner and fixture only where required; regression to the prior baseline exact; validation run; write set scoped; generator drift reported, not run.
