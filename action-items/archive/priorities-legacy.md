...
- The canonical references now live in [composer.md](../composer-reaction/composer.md), [reaction.md](../composer-reaction/reaction.md), and [pdg-solver.md](../composer-reaction/pdg-solver.md). Treat those notes as the implementation-aware references for the current composer, reaction, and PDG-solver surfaces rather than repeating the full completed baseline here.
