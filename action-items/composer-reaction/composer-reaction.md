...
- [pdg](./pdg.md) — PDG-facing ingest, normalization, and proposal-review work.
...
4. [pdg](./pdg.md): build `pdg.py`, fixtures, and the first normalized candidate export path into `solver-request/v1`.
