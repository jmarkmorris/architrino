...
function fixture(){
 ...
 return{configuration:c,template,admission,exported,self:bind(path.join(root,P.SELF)),configurationBinding:bind('/synthetic/configuration.json'),outDirectory:path.join(root,'.local-data/braid-analysis/synthetic-preparation'),C,B,sourceAdmission};
}
