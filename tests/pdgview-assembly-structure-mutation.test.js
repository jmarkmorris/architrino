...
import { splitPdgviewAssemblyGroup } from "../src/runtime/PdgviewAssemblyStructureMutationRuntime.js";

test("pdgview structure split group moves grouped members back to root space", () => {
  const assembly = {
    id: "assembly_1",
    members: [
  ...
  const nextAssembly = splitPdgviewAssemblyGroup(assembly, "subassembly_1");
...
test("pdgview structure split group preserves fallback spacing for unpositioned members", () => {
  const assembly = {
    id: "assembly_2",
