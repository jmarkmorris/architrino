...
class CaptureTests(unittest.TestCase):
    ...
    def test_closure_owner_exact_scope_and_output_generation(self):
        raw=('### Independently Accepted Actual Full asymmetric counter-breathing representative Conditional Cover\n'
        ...
        old=raw.replace(b'asymmetric counter-breathing representative',b'F6c')
        self.assertEqual(subject._owner_declaration(old),subject._owner_declaration(raw))
        with self.assertRaises(ValueError):subject._owner_declaration(raw+old)
...
class GenericParentTests(unittest.TestCase):
    ...
    def parent_chain(self,index=2):
        ...
        old_owner=('### Independently Accepted Actual Full asymmetric counter-breathing representative Conditional Cover\noriginal caller session `13512` '
