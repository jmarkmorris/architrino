...
import { splitAnimatorAssemblyGroup } from "../src/runtime/AnimatorAssemblyStructureMutationRuntime.js";

test("animator structure split group moves grouped members back to root space", () => {
  const assembly = {
    id: "assembly_1",
    members: [
  ...
  const nextAssembly = splitAnimatorAssemblyGroup(assembly, "subassembly_1");
...
test("animator structure split group preserves fallback spacing for unpositioned members", () => {
  const assembly = {
    id: "assembly_2",
