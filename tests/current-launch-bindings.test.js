...
for(const profile of ['run-f6c-root-cover-pilot','run-f6c-cached-root-cover-pilot','run-f6c-cached-root-cover-full','run-prescribed-response-pilot','run-f6c-acceleration-pilot']) {
