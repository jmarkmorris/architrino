...
const runtimeStartRegex = /createAnimator[A-Za-z0-9]+Runtime\(\{/g;
const issues = [];
...
if (issues.length) {
  console.error("animator runtime wiring check failed:");
...
console.log("animator runtime wiring check passed.");
