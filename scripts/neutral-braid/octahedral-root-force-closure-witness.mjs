...
export const OCTAHEDRAL_ROOT_FORCE_CLOSURE_WITNESS_SCHEMA =
  "neutral-braid-octahedral-root-force-closure-witness/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-braid/octahedral-root-force-closure-witness.mjs [options]",
    "",
    "Options:",
...
function main() {
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema: "neutral-braid-octahedral-root-force-closure-witness-schema/v1",
