...
export function buildOctahedralPhaseOffsetScan(options = {}) {
  ...
  return {
    ...
    sources: [
      "reference/priorities/braid-archive/braid-retained-branch-closure/shell-braid/rigid-carrier-dynamics-results.md",
      "reference/priorities/braid-archive/braid-retained-branch-closure/neutral-braid/octahedral-force-residual-diagnostic.md",
    ],
    artifact_claim: {
