...
export const OCTAHEDRAL_FOLD_AWARE_CROSS_BINARY_FOLD_COLLAR_SIGN_TRANSPORT_CERTIFICATE_SCHEMA =
  "neutral-braid-octahedral-fold-aware-cross-binary-fold-collar-sign-transport-certificate/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-braid/octahedral-fold-aware-cross-binary-fold-collar-sign-transport-certificate.mjs [options]",
    "",
    "Options:",
