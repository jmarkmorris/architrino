...
export const OCTAHEDRAL_FOLD_AWARE_CROSS_BINARY_I1_FORCING_BRACKET_INTERVAL_ENCLOSURE_SCHEMA =
  "neutral-braid-octahedral-fold-aware-cross-binary-i1-forcing-bracket-interval-enclosure/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-braid/octahedral-fold-aware-cross-binary-i1-forcing-bracket-interval-enclosure.mjs [options]",
    "",
    "Options:",
