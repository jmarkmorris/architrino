...
export const OCTAHEDRAL_FOLD_AWARE_CROSS_BINARY_FINITE_CANDIDATE_REDUCTION_SCHEMA =
  "neutral-braid-octahedral-fold-aware-cross-binary-finite-candidate-reduction/v1";
...
export function buildOctahedralFoldAwareCrossBinaryFiniteCandidateReduction(
  ...
  return {
    ...
    predecessor_packet:
      "reference/priorities/braid-archive/braid-geometry-export-bridge/octahedral-fold-aware-cross-binary-forcing-topology-atlas.md",
    priority_packet:
      "reference/priorities/braid-archive/braid-geometry-export-bridge/octahedral-fold-aware-cross-binary-finite-candidate-reduction.md",
...
function usage() {
  return [
    "Usage: node scripts/neutral-braid/octahedral-fold-aware-cross-binary-finite-candidate-reduction.mjs [options]",
    "",
    "Options:",
