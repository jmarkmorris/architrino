...
export const OCTAHEDRAL_FOLD_AWARE_CROSS_BINARY_INTERVAL_BRIDGE_PREDICATE_REDUCTION_SCHEMA =
  "neutral-braid-octahedral-fold-aware-cross-binary-interval-bridge-predicate-reduction/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-braid/octahedral-fold-aware-cross-binary-interval-bridge-predicate-reduction.mjs [options]",
    "",
    "Options:",
