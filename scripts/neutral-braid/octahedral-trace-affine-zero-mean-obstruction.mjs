...
export const OCTAHEDRAL_TRACE_AFFINE_ZERO_MEAN_OBSTRUCTION_SCHEMA =
  "neutral-braid-octahedral-trace-affine-partner-positive-row/v1";
...
export function buildOctahedralTraceAffineZeroMeanObstruction(options = {}) {
  ...
  return {
    ...
    priority_packet: "reference/priorities/braid-archive/braid-geometry-export-bridge/octahedral-trace-affine-zero-mean-obstruction.md",
    deformation: {
...
function usage() {
  return [
    "Usage: node scripts/neutral-braid/octahedral-trace-affine-zero-mean-obstruction.mjs [options]",
    "",
    "Options:",
...
function main() {
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema: "neutral-braid-octahedral-trace-affine-partner-positive-row-schema/v1",
