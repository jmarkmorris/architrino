...
export const OCTAHEDRAL_FOLD_AWARE_CLOCK_LENGTH_ORBIT_SYMMETRY_REDUCTION_SCHEMA =
  "neutral-braid-octahedral-fold-aware-clock-length-orbit-symmetry-reduction/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-braid/octahedral-fold-aware-clock-length-orbit-symmetry-reduction.mjs [options]",
    "",
    "Options:",
...
function main() {
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema: "neutral-braid-octahedral-fold-aware-clock-length-orbit-symmetry-reduction-schema/v1",
