...
export const OCTAHEDRAL_FOLD_AWARE_CROSS_BINARY_I1_BRACKET_LOCAL_ZERO_ISOLATION_MESH_COMPOSITION_SCHEMA =
  "neutral-braid-octahedral-fold-aware-cross-binary-i1-bracket-local-zero-isolation-mesh-composition/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-braid/octahedral-fold-aware-cross-binary-i1-bracket-local-zero-isolation-mesh-composition.mjs [options]",
    "",
    "Options:",
