...
export const OCTAHEDRAL_ROOT_LEDGER_SCHEMA = "neutral-braid-octahedral-root-ledger/v1";
...
export function buildOctahedralRootLedger(options = {}) {
  ...
  return {
    ...
    sources: [
      ...
      "reference/priorities/braid-archive/braid-retained-branch-closure/neutral-braid/neutral-braid-first-execution-ledger.md",
    ],
    artifact_claim: {
...
function usage() {
  return [
    "Usage: node scripts/neutral-braid/octahedral-root-ledger.mjs [options]",
    "",
    "Options:",
...
function main() {
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema: "neutral-braid-octahedral-root-ledger-schema/v1",
