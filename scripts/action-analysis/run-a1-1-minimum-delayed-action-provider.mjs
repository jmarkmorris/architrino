...
const defaultSummaryPath =
  ...
  "a1-1-minimum-delayed-action-provider-summary.v1.json";
...
const sealedA11Summary = await readJson(
  protocol.sealedA11Control.summaryPath,
);
const result = evaluateA11MinimumDelayedActionProvider({
  protocol,
  sealedA11Summary,
});
const summary = summarizeA11MinimumDelayedActionProvider(result);
