...
const FORBIDDEN_PATTERNS = [
  ...
  },
  {
    ...
    includeFiles: [/^(content\/markdown\/aaa|reference\/learning-office|src\/apps|src\/prescribed-path-analysis)\//],
  },
  {
    ...
    includeFiles: [/^(content\/markdown\/aaa|reference\/learning-office)\//],
  },
  {
    ...
    excludeFiles: [
      ...
      "reference/learning-office/childrens-books/production/generation-manifest.json",
    ],
  },
  {
