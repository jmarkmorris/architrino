...
const FORBIDDEN_PATTERNS = [
  ...
  },
  {
    ...
    includeFiles: [/^(content\/markdown\/aaa|reference\/office-of-learning|src\/apps|src\/prescribed-path-analysis)\//],
  },
  {
    ...
    includeFiles: [/^(content\/markdown\/aaa|reference\/office-of-learning)\//],
  },
  {
    ...
    excludeFiles: [
      ...
      "reference/office-of-learning/childrens-books/production/generation-manifest.json",
    ],
  },
  {
