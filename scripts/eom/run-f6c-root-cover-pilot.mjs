...
export function validatePlan(plan,root,launcherSha,entrySha) {
  ...
  check(c.scope==="pilot-cell-0"&&c.verifierSha256===SOURCE_BINDINGS[COMPARISON]&&
    c.declarationSha256===SOURCE_BINDINGS["reference/priorities/braid-program/evidence/2026-08-27-f6c-continuous-reception-root-cover-predeclaration.md"],"comparison contract differs");
