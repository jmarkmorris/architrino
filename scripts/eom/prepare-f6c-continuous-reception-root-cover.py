...
SOURCE_PATHS = {'rootLibrary': 'scripts/eom/oracle/continuous_reception_roots.py', 'historyReference': 'scripts/eom/oracle/certified_history.py', 'decimalReference': 'scripts/eom/oracle/decimal_interval.py'}
