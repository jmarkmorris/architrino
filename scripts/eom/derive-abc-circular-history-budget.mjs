...
const REFERENCE = ".local-data/braid-analysis/parallel-agent-search/parallel-braid-prescribed-search-20260826-v1/abc-root-reference-20260827-v1.json";
const REFERENCE_SHA = "c74bad1d7c5aeed4c9bb326ff711f87833ba43e39236bbc920afb2f375dc7e08";
const PRIMITIVE = "scripts/eom/derive-abc-subfield-root-reference.mjs";
const PRIMITIVE_SHA = "2c0242d36ca47f5fc53077b0baa3db90aa5e37a97a4b6089bdaa4b86fcbfdbee";
const sha = (data) => createHash("sha256").update(data).digest("hex");

try {
  if (process.argv.length !== 4 || process.argv[2] !== "--out") throw new Error("Usage: node scripts/eom/derive-abc-circular-history-budget.mjs --out <new-path>");
  ...
  const instrumentPaths = ["scripts/eom/derive-abc-circular-history-budget.mjs", "src/prescribed-path-analysis/CircularHistoryConformance.mjs", PRIMITIVE];
  ...
  const result = { schema: "braid-program/abc-circular-history-construction-budget.v1", accepted: results.every((row) => row.accepted),
