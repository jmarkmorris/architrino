...
def _unrestricted_residual(receiver: _ValidatedHistorySnapshot, transmitter: _ValidatedHistorySnapshot,
    ...
    xr = _history_state_over(receiver, reception).position
    xt = _history_state_over(transmitter, emission).position
...
def _root_geometry(receiver: PiecewisePolynomialHistory | _ValidatedHistorySnapshot,
    ...
    receiver_state = _history_state_over(receiver, reception)
    transmitter_state = _history_state_over(transmitter, emission)
