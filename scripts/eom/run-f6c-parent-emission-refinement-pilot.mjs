...
export const NAMED=Object.freeze({"declaration":["reference/priorities/braid-program/evidence/2026-08-27-f6c-parent-emission-refinement-reference.md","c9f0924cd24745bd10e2b51ee5b60a09c0c0576b5dec3bc14f647c9c7ee6fc47"],"producer":["scripts/eom/prepare-f6c-parent-emission-refinement.py",null],"producerControls":["tests/test_f6c_parent_emission_refinement_preparation.py",null],"proposalReference":["scripts/eom/f6c_parent_emission_refinement.py","d2653fd0dc74c7515ee7eccdd59c0f487903a481c6294cabce43e58b633c1406"],"proposalReferenceControls":["tests/test_f6c_parent_emission_refinement.py","f1650b5e73a06ecd7ed05bff10ba97949b42aa5330e84fb3514c2f868eff0fc2"],"verifier":["scripts/eom/verify-f6c-parent-emission-refinement.py",null],"verifierControls":["tests/test_f6c_parent_emission_refinement_verification.py",null],"comparisonReference":["scripts/eom/oracle/f6c_parent_emission_refinement_conformance.py","9bca879b94386d033597bb9d1e3a4ceeb9943925615c916299feb91e482391ad"],"comparisonReferenceControls":["tests/test_f6c_parent_emission_refinement_conformance.py","2eafcd7551a6d64c5f6c7bc6923507da8d27084af74bc5742583d63eb708aebb"]});
export const DEPENDENCIES=Object.freeze({"transport":["scripts/eom/verify-f6c-refined-acceleration.py","e2df205f5543775c61e90355cdc8e8aa74cd7dde68957e2692ae87c6f67128ae"],"transportControls":["tests/test_f6c_refined_acceleration.py","d65b86400a00fe333e88c624d5e4654b00187ffbcfed978cb385e862978d90fd"],"scientificDecoder":["scripts/eom/oracle/f6c_refined_acceleration_conformance.py","7574dc0fa7bec6e598e83ac7d8ad7670acaca6c10a41958b01487ac0af3ae85e"],"scientificDecoderControls":["tests/test_f6c_refined_acceleration_conformance.py","147800b0ddfc9b3bf4f5889058e6df9073b70cf90798b2ad9c536289bf9a9921"],"productionHelper":["scripts/eom/prepare-f6c-cached-continuous-reception-root-cover.py","7b81efbf67b67c78c759fcb1c49e757ffb7f513f75ca8489178bfda71f4f31c5"],"productionHelperControls":["tests/test_f6c_cached_continuous_reception_root_cover_preparation.py","3bee7599b03f2500ede6eeeea31c46e1aac82410f456e967102c13e820b93221"],"historyReference":["scripts/eom/oracle/certified_history.py","ca916b4bc979629a5e25c1490da07fd78a26b4e75cfba5677f35fbab658a29e7"],"decimalReference":["scripts/eom/oracle/decimal_interval.py","fffc17270e149e6213315c1c82b518caa739657eb649822fd1955b8a2820e38a"],"decimalControls":["tests/test_eom_decimal_interval.py","22242cb7335cdddeb56416b8584793972195ee1aa6b460d8a43ea6baeb693b44"],"rootLibrary":["scripts/eom/oracle/continuous_reception_roots_cached.py","daa4cc227cb8685de673fc400d817a19666b4fc7323e6c3a56f475a463b23acf"],"rootControls":["tests/test_eom_continuous_reception_roots_cached.py","a5ac7c8b26c5d0a193f20305f4bdbad93939756780bdaefd9cbf569f42a487eb"],"independentRootReference":["scripts/eom/verify-f6c-cached-continuous-reception-root-cover.py","3221c44ed626f0902cc1c6e4d439fc87669bc6fa9ec1397d111b2d1fc69bbfc7"],"independentRootControls":["tests/test_f6c_cached_continuous_reception_root_cover.py","09b5c51b2e43727b98adfffde6a080e8e9c92f1ffa7280d8f819d830c8f7e2a3"],"cacheEquivalence":["reference/priorities/braid-program/evidence/2026-08-27-f6c-call-local-state-cache-equivalence.md","a5d9ee0b77f436f5d8cf3b3f1895e94438d220543ee87c117996a704994dc34d"]});
...
export function validatePlan(input,{root,selfSha,python,git}){
 ...
 plan.unavailableHistoricalEnvironment=historicalEnvironment(input.unavailableHistoricalEnvironment,root);
...
function admitParent(job){
 ...
 if(job.stage==='producer'){
  ...
  keys(report,'schema scope accepted authority manifest queries rows pieces launchPlan verifier sourceBindings historicalSourceBindings historicalEvidenceVerification originalBindings acceptanceOwner priorCoverClosure parent analysis candidateClaims publicationRequires elapsedSecondsBeforePublication'.split(' '));
  check(report.schema==='braid-program/f6c-parent-emission-refinement-conformance.v2'&&report.scope===parentScope(plan.parentIndex)&&report.accepted===true&&report.analysis?.accepted===false&&same(report.candidateClaims,CLAIMS)&&same(report.manifest,manifestBinding)&&same(report.launchPlan,context.planBinding)&&same(report.verifier,plan.verifier)&&same(report.parent,manifest.parent)&&same(report.historicalSourceBindings,manifest.historicalSourceBindings)&&same(report.historicalEvidenceVerification,historicalEvidence(plan)),'conditional comparison/source identity');
  ...
  for(const b of uniqueBindings([...context.sources,...historicalPhysicalSources(manifest.historicalSourceBindings,plan),...layout.bindings]))check(reported.some(v=>same(v,b)),'comparison omits original/current source or candidate');
...
export const COORDINATOR=Object.freeze(['scripts/eom/f6c-bounded-operation.mjs','e100a96f0771d82664fa62b66865cbf5924cced1216588c631836ed361d6a252']);
export const HISTORICAL_ARCHIVES=Object.freeze({"scripts/eom/launch-abc-enclosed-root-pilot.mjs":["5aa154b1579909cc63f01d81023e2e1412c2a0bb277663d9e1cd118999795baa",39465],"scripts/eom/prepare-f6c-cached-continuous-reception-root-cover.py":["af53f5af2f9dd7eda4869af2a7533f869f4e3866003c90bf9a8487b2e5636386",38160],"scripts/eom/verify-f6c-cached-continuous-reception-root-cover.py":["19c57e9b638b0beb866c86b061b2325f9567add2a85608f0c42ef1f7612d9132",41336],"reference/priorities/braid-program/evidence/2026-08-27-f6c-cached-root-cover-full-resource-plan.md":["daeb71bee6260c38a6b7e5e6237110216d9315807fe23602fbd7cfcdddc5866b",10021],"tests/test_f6c_cached_continuous_reception_root_cover_preparation.py":["9abc7c3a80ad670e7bc7ad9f94a95f1fcd8924de425991032d6d26bba3372427",11113],"tests/test_f6c_cached_continuous_reception_root_cover.py":["2fd2080b3b4facdc80b85cdc65610c2bfeefdd8eab5f7234e207d3d4908bc117",11096],"reference/priorities/braid-program/evidence/2026-08-27-f6c-cached-root-cover-predeclaration.md":["7c2a8b0bb06f46da158e0dfe2cb313dd72e2edff3c411e87c1588aa6d028f9e4",12103],"reference/priorities/braid-program/evidence/2026-08-27-f6c-continuous-reception-enclosure-contract.md":["f20e4bdaaff8b6f0012fdc6135b15d568a817832fb55d5c42f80d8421a117f68",28340],"reference/priorities/braid-program/evidence/2026-08-27-f6c-accepted-frame-history-reconstruction.md":["6abbbbacc1671052bdd881790094dbd71ebb03d54904ac1f937edae1f3c9f936",21031],"tests/test_eom_continuous_reception_roots.py":["473cba3b039027879eeea6987515261faaadcf0833f3e4d2864fc610f5b7a144",32501],"scripts/eom/verify-f6c-accepted-frame-reconstruction.py":["80a96ebd0b306148b3eb96cb12e797c5cf80942e52ea457a8c6a72d58e8618a0",31153],"scripts/eom/verify-f6c-retained-history-guards.py":["efaed33a6d6e55be5788ffb7e4e6f596fbc0381466a8308154dbd550743896b9",31651],"reference/priorities/braid-program/evidence/2026-08-27-f6c-continuous-reception-root-cover-predeclaration.md":["765e6663cdd60323f84b9e1af52ba1399345322eb747727f2a0898b4dd0fd079",25546],"scripts/eom/verify-f6c-continuous-reception-root-cover.py":["2d25103e0fb6ab584485b7954465afe0fa5de556b3a7e111c56d20156b7011fd",39929],"reference/priorities/braid-program/evidence/2026-08-27-f6c-call-local-state-cache-equivalence.md":["798858e87058b5a1a2d478c89edad3154a2e4993f3c14cab089b4aabf3434ee3",10933],"reference/priorities/braid-program/evidence/2026-08-27-f6c-root-cover-full-resource-plan.md":["46a827d13a5e8f7a068e73e642f74d679ebf18e0b2e8f42ab53aab4de26598ef",13021],"reference/priorities/braid-program/evidence/2026-08-27-f6c-root-cover-pilot-resource-plan.md":["36b72681c116cedf1803cc89ead8b48a7d9604bae7f9bffd7b0f95b33c3bb9b4",6754],"scripts/eom/run-f6c-cached-root-cover-full.mjs":["1398a005510480d073d3882c7b9508b1cd2f91f0d7bb7ae5757b4893ed73352b",27166],"scripts/eom/launch-f6c-cached-root-cover-full.mjs":["0f11fe5e51ef52f95c02605b776fe6b94c72a67a4a5f2b69671870f5f548ae17",26659]});
export const HISTORICAL_HOSTS=Object.freeze({"/usr/bin/git":["179301dcb41ea78accc3fa0048a7e6f6710d891945a751a34addd622020c1818",118928],"/bin/ps":["472992c470606d28f577590decfecd7f4a20f832fd92c671bebc6d44790b5d02",170816],"/usr/bin/memory_pressure":["a1668e28505400a9e09ab9b2bd2558f04d038152dfdb05826576a0a0aa27fe56",135248]});
export function historicalRoutes(rows,root){
 ...
 return rows.map(r=>{keys(r,['original','physical']);const original=binding(r.original,root),physical=binding(r.physical,root);
  const expected=HISTORICAL_ARCHIVES[path.relative(root,original.path)]??HISTORICAL_HOSTS[original.path];
...
export function historicalEnvironment(rows,root){
 check(Array.isArray(rows)&&rows.length<=3,'bounded unavailable historical environment');const seen=new Set();
 return rows.map(raw=>{const b=binding(raw,root);check(same(HISTORICAL_HOSTS[b.path],[b.sha256,b.bytes])&&!seen.has(b.path),'exact unique unavailable historical host');seen.add(b.path);return b;});
}
export function historicalEvidence(plan){
 return{schema:'braid-program/retained-historical-evidence.v1',retainedScientificBytesVerified:true,recordedProvenanceVerified:true,
  fullOriginalEnvironmentVerified:plan.unavailableHistoricalEnvironment.length===0,unavailableHistoricalEnvironment:[...plan.unavailableHistoricalEnvironment].sort((a,b)=>a.path<b.path?-1:1),
...
export function historicalPhysicalSources(rows,plan){
 const missing=plan.unavailableHistoricalEnvironment??[],used=new Set();
 const physical=rows.flatMap(b=>{const m=missing.find(m=>m.path===b.path);if(!m)return[physicalSource(b,plan)];
  check(same(m,b)&&!plan.historicalDocumentRoutes.some(r=>r.original.path===b.path),'exact unavailable historical host identity');used.add(b.path);return[];});
 check(used.size===missing.length,'unused unavailable historical host');return physical;
}
...
export function makeBatchPlan({root,operationDirectory,parents,pythonCommand,git,hookModule,hookControls,sources,runtimeBindings,closureReserveBytes}){
 ...
 const configuration={schema:'braid-program/f6c-parent-emission-refinement-batch.v2',completionContract:'braid-program/f6c-bounded-operation-external-closure.v1',pythonCommand,git,parents,runtimeBindings,closureReserveBytes};
...
export function makeParentPlans({template,indices,sourceBindings,runtimeBindings,operationalBindings,acceptanceOwner,historicalDocumentRoutes,unavailableHistoricalEnvironment=[]}){
 ...
 keys(template,PLAN_KEYS.filter(k=>!(k==='historicalDocumentRoutes'&&template.schema.endsWith('.v1'))&&!(k==='unavailableHistoricalEnvironment'&&!template.schema.endsWith('.v3'))));
 ...
 return indices.map(parentIndex=>({...structuredClone(template),schema:'braid-program/f6c-parent-emission-refinement-launch.v3',scope:parentScope(parentIndex),parentIndex,
  ...structuredClone(current),runtimeBindings:structuredClone(runtimeBindings),operationalBindings:structuredClone(operationalBindings),acceptanceOwner:structuredClone(acceptanceOwner),historicalDocumentRoutes:structuredClone(historicalDocumentRoutes),unavailableHistoricalEnvironment:structuredClone(unavailableHistoricalEnvironment)}));
}
export function validateBatch(plan){
 ...
 check(c.schema==='braid-program/f6c-parent-emission-refinement-batch.v2'&&c.completionContract==='braid-program/f6c-bounded-operation-external-closure.v1'&&Array.isArray(c.parents)&&c.parents.length>0&&c.parents.length<=8,'bounded explicit parent batch');
