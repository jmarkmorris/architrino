...
if ('OPTION_B_PRODUCTION_IDENTITIES' not in globals()
        ...
        or len(OPTION_B_PRODUCTION_IDENTITIES) != 21):
...
FIXED = (
    ...
    ("rootLibrary", "scripts/eom/oracle/continuous_reception_roots_cached.py", OPTION_B_PRODUCTION_IDENTITIES[6]),
    ("rootControls", "tests/test_eom_continuous_reception_roots_cached.py", OPTION_B_PRODUCTION_IDENTITIES[7]),
    ...
    ("governingDeclaration", "reference/priorities/braid-program/evidence/2026-08-27-f6c-continuous-reception-root-cover-predeclaration.md", OPTION_B_PRODUCTION_IDENTITIES[12]),
    ("baselineRootLibrary", "scripts/eom/oracle/continuous_reception_roots.py", OPTION_B_PRODUCTION_IDENTITIES[13]),
    ("baselineRootControls", "tests/test_eom_continuous_reception_roots.py", OPTION_B_PRODUCTION_IDENTITIES[14]),
    ("baselineComparator", "scripts/eom/verify-f6c-continuous-reception-root-cover.py", OPTION_B_PRODUCTION_IDENTITIES[15]),
    ("baselineComparatorControls", "tests/test_f6c_continuous_reception_root_cover.py", OPTION_B_PRODUCTION_IDENTITIES[16]),
    ("cacheEquivalence", "reference/priorities/braid-program/evidence/2026-08-27-f6c-call-local-state-cache-equivalence.md", OPTION_B_PRODUCTION_IDENTITIES[17]),
    ("governingResourcePlan", "reference/priorities/braid-program/evidence/2026-08-27-f6c-root-cover-pilot-resource-plan.md", OPTION_B_PRODUCTION_IDENTITIES[18]),
    ("priorResourceReturn", "reference/priorities/braid-program/evidence/2026-08-27-f6c-root-cover-full-resource-plan.md", OPTION_B_PRODUCTION_IDENTITIES[19]),
)
KNOT_SHA = OPTION_B_PRODUCTION_IDENTITIES[20]
IDS = ("0+", "0-", "1+", "1-", "2+", "2-", "3+", "3-")
