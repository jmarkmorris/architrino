...
} from "../../src/prescribed-path-analysis/CoincidentMidpointCommonFrequencyReceiverPhaseProjectionMonotonicityCertifier.mjs";
...
const result = evaluateCoincidentMidpointCommonFrequencyReceiverPhaseProjectionMonotonicity({
  projectionProtocol,
  baseProtocol,
