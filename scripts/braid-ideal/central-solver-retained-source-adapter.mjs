  ...
  return {
    ...
    source_artifacts: {
      held_release_seed_path_rows: {
        ...
        first_missing_object: artifacts.seedArtifact?.first_missing_object ?? null,
        first_missing_field: artifacts.seedArtifact?.first_missing_field ?? null,
      },
      held_release_path_history_stream_manifest_set: {
        ...
        first_missing_object: artifacts.manifestSet?.first_missing_object ?? null,
        first_missing_field: artifacts.manifestSet?.first_missing_field ?? null,
      },
      central_solver_retained_history_row: {
        ...
        first_missing_object: artifacts.retainedHistoryRow?.first_missing_object ?? null,
        first_missing_field: artifacts.retainedHistoryRow?.first_missing_field ?? null,
      },
      central_solver_retained_history_provider_object: {
        ...
        first_missing_object: artifacts.providerObject?.first_missing_object ?? null,
        first_missing_field: artifacts.providerObject?.first_missing_field ?? null,
      },
    },
    same_record_binding: {
      required: true,
