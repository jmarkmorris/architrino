...
const GENERIC_SOURCE_PATHS = new Set([
  ...
  "reference/priorities/mapping-equations/analysis/eq-22b-recombination-acoustic-transfer.md",
  "reference/priorities/mapping-equations/analysis/eq-21-23-32-shared-observation-residual-packet.md",
