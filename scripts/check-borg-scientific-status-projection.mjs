...
if (currentExactBindings.length !== 23 || offCatalogExactBindings !== 1) {
  throw new Error(`Expected 23 current exact Borg adjudication bindings and one exact evidence row preserved off-catalog; found ${currentExactBindings.length} and ${offCatalogExactBindings}.`);
}
