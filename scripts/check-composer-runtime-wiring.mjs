...
const runtimeStartRegex = /createComposer[A-Za-z0-9]+Runtime\(\{/g;
const issues = [];
...
if (issues.length) {
  console.error("Composer runtime wiring check failed:");
...
console.log("Composer runtime wiring check passed.");
