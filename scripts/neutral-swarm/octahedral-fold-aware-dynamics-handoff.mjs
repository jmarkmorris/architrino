...
export const OCTAHEDRAL_FOLD_AWARE_DYNAMICS_HANDOFF_SCHEMA =
  "neutral-swarm-octahedral-fold-aware-dynamics-handoff/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-fold-aware-dynamics-handoff.mjs [options]",
    "",
    "Options:",
...
function main() {
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema: "neutral-swarm-octahedral-fold-aware-dynamics-handoff-schema/v1",
