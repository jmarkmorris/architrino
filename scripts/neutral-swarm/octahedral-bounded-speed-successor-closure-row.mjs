...
export const OCTAHEDRAL_BOUNDED_SPEED_SUCCESSOR_CLOSURE_ROW_SCHEMA =
  "neutral-swarm-octahedral-bounded-speed-successor-closure-row/v1";
...
export function buildOctahedralBoundedSpeedSuccessorClosureRow(options = {}) {
  ...
  return {
    ...
    source_diagonal_affine_solver:
      "scripts/neutral-swarm/octahedral-diagonal-affine-zero-mean-solver.mjs",
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-bounded-speed-successor-closure-row.mjs [options]",
    "",
    "Options:",
...
function main() {
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema: "neutral-swarm-octahedral-bounded-speed-successor-closure-row-schema/v1",
