...
export const OCTAHEDRAL_FOLD_AWARE_CROSS_BINARY_I1_BRACKET_DERIVATIVE_MESH_BARRIER_SCHEMA =
  "neutral-swarm-octahedral-fold-aware-cross-binary-i1-bracket-derivative-mesh-barrier/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-fold-aware-cross-binary-i1-bracket-derivative-mesh-barrier.mjs [options]",
    "",
    "Options:",
