...
export const OCTAHEDRAL_FOLD_AWARE_CROSS_BINARY_SOURCE_ATLAS_QUARTER_CELL_REDUCTION_SCHEMA =
  "neutral-swarm-octahedral-fold-aware-cross-binary-source-atlas-quarter-cell-reduction/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-fold-aware-cross-binary-source-atlas-quarter-cell-reduction.mjs [options]",
    "",
    "Options:",
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema:
            "neutral-swarm-octahedral-fold-aware-cross-binary-source-atlas-quarter-cell-reduction-schema/v1",
          artifact_schema:
            OCTAHEDRAL_FOLD_AWARE_CROSS_BINARY_SOURCE_ATLAS_QUARTER_CELL_REDUCTION_SCHEMA,
          promotion_status: PROMOTION_STATUS,
          packet_id: PACKET_ID,
