...
export const OCTAHEDRAL_AFFINE_EXPOSURE_PROBE_SCHEMA =
  "neutral-swarm-octahedral-affine-exposure-probe/v1";
...
export function buildOctahedralAffineExposureProbe(options = {}) {
  ...
  return {
    ...
    source_root_ledger: "scripts/neutral-swarm/octahedral-root-ledger.mjs",
    priority_packet: "reference/priorities/geometry-bridge/octahedral-affine-exposure-matrix.md",
    conventions: {
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-affine-exposure-probe.mjs [options]",
    "",
    "Options:",
...
function main() {
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema: "neutral-swarm-octahedral-affine-exposure-probe-schema/v1",
