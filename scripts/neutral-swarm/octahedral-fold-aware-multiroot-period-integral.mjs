...
export const OCTAHEDRAL_FOLD_AWARE_MULTIROOT_PERIOD_INTEGRAL_SCHEMA =
  "neutral-swarm-octahedral-fold-aware-multiroot-period-integral/v1";
...
export function buildOctahedralFoldAwareMultirootPeriodIntegral(options = {}) {
  ...
  return {
    ...
    predecessor_packet: "reference/priorities/geometry-bridge/octahedral-period-rescaled-fold-chart.md",
    priority_packet:
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-fold-aware-multiroot-period-integral.mjs [options]",
    "",
    "Options:",
...
function main() {
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema: "neutral-swarm-octahedral-fold-aware-multiroot-period-integral-schema/v1",
