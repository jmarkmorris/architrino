...
export const OCTAHEDRAL_FOLD_AWARE_CROSS_BINARY_FORCING_TOPOLOGY_ATLAS_SCHEMA =
  "neutral-swarm-octahedral-fold-aware-cross-binary-forcing-topology-atlas/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-fold-aware-cross-binary-forcing-topology-atlas.mjs [options]",
    "",
    "Options:",
