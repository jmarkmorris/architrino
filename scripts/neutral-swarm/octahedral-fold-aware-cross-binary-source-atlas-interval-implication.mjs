...
export const OCTAHEDRAL_FOLD_AWARE_CROSS_BINARY_SOURCE_ATLAS_INTERVAL_IMPLICATION_SCHEMA =
  "neutral-swarm-octahedral-fold-aware-cross-binary-source-atlas-interval-implication/v1";
...
function buildPromotionDecision() {
  return {
    ...
    intended_corpus_destination:
      "content/markdown/aaa/noether-swarm/nested-shell-swarm-dynamics.md",
  };
}
...
export function buildOctahedralFoldAwareCrossBinarySourceAtlasIntervalImplication(
  ...
  return {
    ...
    priority_packet:
      "reference/priorities/geometry-bridge/octahedral-fold-aware-cross-binary-source-atlas-interval-implication.md",
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-fold-aware-cross-binary-source-atlas-interval-implication.mjs [options]",
    "",
    "Options:",
