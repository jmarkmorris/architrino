...
const SCHEMA_ID = "neutral-swarm-finite-mode-artifact/v1";
const PACKET_ID = "neutral_swarm_finite_mode_search";
...
const FINITE_MODE_DECISIONS = [
  "neutral-swarm-finite-mode-candidate",
  "neutral-swarm-finite-mode-rejected",
  "neutral-swarm-finite-mode-open",
];

const FIRST_FAILURE_ORDER = [
  "neutral-swarm-finite-mode-schema-open",
...
export const ARTIFACT_SCHEMA = {
  schema: "neutral-swarm-finite-mode-artifact-schema/v1",
...
export function buildArtifact(options = {}) {
  ...
  return {
    schema: SCHEMA_ID,
    packet_id: PACKET_ID,
    artifact_id: "neutral_swarm_finite_mode_search.audit_shape.v1",
    promotion_status: PROMOTION_STATUS,
    sources: [
      "reference/priorities/swarm/neutral-swarm/neutral-swarm-finite-mode-search.md",
    ...
    optional_reductions: {
      ...
      shell_swarm: "not_claimed",
      nested_shell_swarm: "not_claimed",
    ...
    decision: {
      finite_mode_decision: "neutral-swarm-finite-mode-open",
...
export function validateArtifact(artifact) {
  ...
  assertField(artifact.decision?.finite_mode_decision === "neutral-swarm-finite-mode-open", "decision must be finite-mode open", errors);
...
function printHelp() {
  console.log(`Usage: node scripts/neutral-swarm/finite-mode-artifact.mjs [options]
...
This emits or validates the neutral swarm finite-mode search artifact shape. It
...
function main() {
  ...
  if (args.mode === "validate") {
    ...
    const summary = {
      schema: "neutral-swarm-finite-mode-artifact-validation/v1",
