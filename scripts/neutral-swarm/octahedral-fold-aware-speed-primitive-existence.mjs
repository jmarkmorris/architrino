...
export const OCTAHEDRAL_FOLD_AWARE_SPEED_PRIMITIVE_EXISTENCE_SCHEMA =
  "neutral-swarm-octahedral-fold-aware-speed-primitive-existence/v1";
...
export function buildOctahedralFoldAwareSpeedPrimitiveExistence(options = {}) {
  ...
  return {
    ...
    priority_packet:
      "reference/priorities/geometry-bridge/octahedral-fold-aware-speed-primitive-existence.md",
    successor_packet:
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-fold-aware-speed-primitive-existence.mjs [options]",
    "",
    "Options:",
...
function main() {
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema: "neutral-swarm-octahedral-fold-aware-speed-primitive-existence-schema/v1",
