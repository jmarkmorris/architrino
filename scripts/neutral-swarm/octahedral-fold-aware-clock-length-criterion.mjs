...
export const OCTAHEDRAL_FOLD_AWARE_CLOCK_LENGTH_CRITERION_SCHEMA =
  "neutral-swarm-octahedral-fold-aware-clock-length-criterion/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-fold-aware-clock-length-criterion.mjs [options]",
    "",
    "Options:",
...
function main() {
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema: "neutral-swarm-octahedral-fold-aware-clock-length-criterion-schema/v1",
