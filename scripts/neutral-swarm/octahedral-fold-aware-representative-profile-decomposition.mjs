...
export const OCTAHEDRAL_FOLD_AWARE_REPRESENTATIVE_PROFILE_DECOMPOSITION_SCHEMA =
  "neutral-swarm-octahedral-fold-aware-representative-profile-decomposition/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-fold-aware-representative-profile-decomposition.mjs [options]",
    "",
    "Options:",
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema:
            "neutral-swarm-octahedral-fold-aware-representative-profile-decomposition-schema/v1",
          artifact_schema:
            OCTAHEDRAL_FOLD_AWARE_REPRESENTATIVE_PROFILE_DECOMPOSITION_SCHEMA,
          promotion_status: PROMOTION_STATUS,
          packet_id: PACKET_ID,
