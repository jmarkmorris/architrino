...
export const OCTAHEDRAL_FOLD_AWARE_CROSS_BINARY_BRIDGE_PREDICATE_CERTIFICATE_SCHEMA =
  "neutral-swarm-octahedral-fold-aware-cross-binary-bridge-predicate-certificate/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-fold-aware-cross-binary-bridge-predicate-certificate.mjs [options]",
    "",
    "Options:",
