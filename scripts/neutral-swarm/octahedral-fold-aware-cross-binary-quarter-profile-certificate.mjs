...
export const OCTAHEDRAL_FOLD_AWARE_CROSS_BINARY_QUARTER_PROFILE_CERTIFICATE_SCHEMA =
  "neutral-swarm-octahedral-fold-aware-cross-binary-quarter-profile-certificate/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-fold-aware-cross-binary-quarter-profile-certificate.mjs [options]",
    "",
    "Options:",
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema:
            "neutral-swarm-octahedral-fold-aware-cross-binary-quarter-profile-certificate-schema/v1",
          artifact_schema:
            OCTAHEDRAL_FOLD_AWARE_CROSS_BINARY_QUARTER_PROFILE_CERTIFICATE_SCHEMA,
          promotion_status: PROMOTION_STATUS,
          packet_id: PACKET_ID,
