...
export const OCTAHEDRAL_PHASE_OFFSET_SCAN_SCHEMA = "neutral-swarm-octahedral-phase-offset-scan/v1";
...
export function buildOctahedralPhaseOffsetScan(options = {}) {
  ...
  return {
    ...
    sources: [
      "reference/priorities/swarm/shell-swarm/rigid-carrier-dynamics-results.md",
      "reference/priorities/swarm/neutral-swarm/octahedral-force-residual-diagnostic.md",
    ],
    artifact_claim: {
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-phase-offset-scan.mjs [options]",
    "",
    "Options:",
...
function main() {
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema: "neutral-swarm-octahedral-phase-offset-scan-schema/v1",
