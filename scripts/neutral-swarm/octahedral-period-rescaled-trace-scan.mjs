...
export const OCTAHEDRAL_PERIOD_RESCALED_TRACE_SCAN_SCHEMA =
  "neutral-swarm-octahedral-period-rescaled-trace-scan/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-period-rescaled-trace-scan.mjs [options]",
    "",
    "Options:",
...
function main() {
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema: "neutral-swarm-octahedral-period-rescaled-trace-scan-schema/v1",
