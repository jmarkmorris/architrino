...
export const OCTAHEDRAL_FORCE_RESIDUAL_SCHEMA = "neutral-swarm-octahedral-force-residual/v1";
...
export function buildOctahedralForceResidual(options = {}) {
  ...
  return {
    ...
    packet_id: PACKET_ID,
    artifact_id: "neutral_swarm_octahedral_force_residual.sampled_diagnostic.v1",
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-force-residual.mjs [options]",
    "",
    "Options:",
...
function main() {
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema: "neutral-swarm-octahedral-force-residual-schema/v1",
