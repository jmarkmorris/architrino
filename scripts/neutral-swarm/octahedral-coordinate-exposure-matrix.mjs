...
export const OCTAHEDRAL_COORDINATE_EXPOSURE_MATRIX_SCHEMA =
  "neutral-swarm-octahedral-coordinate-exposure-matrix/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-coordinate-exposure-matrix.mjs [options]",
    "",
    "Options:",
...
function main() {
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema: "neutral-swarm-octahedral-coordinate-exposure-matrix-schema/v1",
