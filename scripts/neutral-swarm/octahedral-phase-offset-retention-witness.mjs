...
export const OCTAHEDRAL_PHASE_OFFSET_RETENTION_WITNESS_SCHEMA =
  "neutral-swarm-octahedral-phase-offset-retention-witness/v1";
...
export function buildOctahedralPhaseOffsetRetentionWitness(options = {}) {
  ...
  return {
    ...
    packet_id: PACKET_ID,
    artifact_id: "neutral_swarm_octahedral_phase_offset_retention_witness.sampled_overread_rejection.v1",
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-phase-offset-retention-witness.mjs [options]",
    "",
    "Options:",
...
function main() {
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema: "neutral-swarm-octahedral-phase-offset-retention-witness-schema/v1",
