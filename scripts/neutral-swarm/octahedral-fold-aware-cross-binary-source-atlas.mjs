...
export const OCTAHEDRAL_FOLD_AWARE_CROSS_BINARY_SOURCE_ATLAS_SCHEMA =
  "neutral-swarm-octahedral-fold-aware-cross-binary-source-atlas/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-fold-aware-cross-binary-source-atlas.mjs [options]",
    "",
    "Options:",
...
function main() {
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema: "neutral-swarm-octahedral-fold-aware-cross-binary-source-atlas-schema/v1",
