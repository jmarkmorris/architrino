...
export const OCTAHEDRAL_FOLD_AWARE_CROSS_BINARY_FORCING_DERIVATIVE_ATLAS_SCHEMA =
  "neutral-swarm-octahedral-fold-aware-cross-binary-forcing-derivative-atlas/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-fold-aware-cross-binary-forcing-derivative-atlas.mjs [options]",
    "",
    "Options:",
