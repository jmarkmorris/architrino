...
export const OCTAHEDRAL_FOLD_AWARE_CROSS_BINARY_I1_DERIVATIVE_NEGATIVE_SPEED_ENVELOPE_SCAN_SCHEMA =
  "neutral-swarm-octahedral-fold-aware-cross-binary-i1-derivative-negative-speed-envelope-scan/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-fold-aware-cross-binary-i1-derivative-negative-speed-envelope-scan.mjs [options]",
    "",
    "Options:",
