...
export const OCTAHEDRAL_INVENTORY_CLOSURE_WITNESS_SCHEMA =
  "neutral-swarm-octahedral-inventory-closure-witness/v1";
...
export function buildOctahedralInventoryClosureWitness(options = {}) {
  ...
  return {
    ...
    packet_id: PACKET_ID,
    artifact_id: "neutral_swarm_octahedral_inventory_closure_witness.narrow_no_go.v1",
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-inventory-closure-witness.mjs [options]",
    "",
    "Options:",
...
function main() {
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema: "neutral-swarm-octahedral-inventory-closure-witness-schema/v1",
