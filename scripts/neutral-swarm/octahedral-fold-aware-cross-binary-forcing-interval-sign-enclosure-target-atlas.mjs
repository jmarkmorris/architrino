...
export const OCTAHEDRAL_FOLD_AWARE_CROSS_BINARY_FORCING_INTERVAL_SIGN_ENCLOSURE_TARGET_ATLAS_SCHEMA =
  "neutral-swarm-octahedral-fold-aware-cross-binary-forcing-interval-sign-enclosure-target-atlas/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-fold-aware-cross-binary-forcing-interval-sign-enclosure-target-atlas.mjs [options]",
    "",
    "Options:",
