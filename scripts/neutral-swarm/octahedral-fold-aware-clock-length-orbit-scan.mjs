...
export const OCTAHEDRAL_FOLD_AWARE_CLOCK_LENGTH_ORBIT_SCAN_SCHEMA =
  "neutral-swarm-octahedral-fold-aware-clock-length-orbit-scan/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-fold-aware-clock-length-orbit-scan.mjs [options]",
    "",
    "Options:",
...
function main() {
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema: "neutral-swarm-octahedral-fold-aware-clock-length-orbit-scan-schema/v1",
