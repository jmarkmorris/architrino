...
export const OCTAHEDRAL_ZERO_MEAN_CORRECTION_INTAKE_SCHEMA =
  "neutral-swarm-octahedral-zero-mean-correction-intake/v1";
export const OCTAHEDRAL_ZERO_MEAN_CANDIDATE_B_SCHEMA =
  "neutral-swarm-octahedral-zero-mean-candidate-b/v1";
export const OCTAHEDRAL_ZERO_MEAN_CANDIDATE_B_RANGE_PROBE_SCHEMA =
  "neutral-swarm-octahedral-zero-mean-candidate-b-range-probe/v1";
export const OCTAHEDRAL_ZERO_MEAN_LIVE_DERIVATIVE_COLUMN_INTAKE_SCHEMA =
  "neutral-swarm-octahedral-zero-mean-live-derivative-column-intake/v1";
export const OCTAHEDRAL_ZERO_MEAN_LIVE_DERIVATIVE_COLUMN_PREVIEW_RANGE_PROBE_SCHEMA =
  "neutral-swarm-octahedral-zero-mean-live-derivative-column-preview-range-probe/v1";
export const OCTAHEDRAL_ZERO_MEAN_LIVE_DERIVATIVE_MATRIX_CERTIFICATE_SCHEMA =
  "neutral-swarm-octahedral-zero-mean-live-derivative-matrix-certificate/v1";
export const OCTAHEDRAL_ZERO_MEAN_LIVE_CORRECTION_DIRECTION_CERTIFICATE_SCHEMA =
  "neutral-swarm-octahedral-zero-mean-live-correction-direction-certificate/v1";
...
export function buildOctahedralZeroMeanCorrectionIntake(options = {}) {
  ...
  const artifact = {
    ...
    packet_id: PACKET_ID,
    artifact_id: "neutral_swarm_octahedral_zero_mean_correction_intake.frozen_constant_vector.v1",
    promotion_status: PROMOTION_STATUS,
    sources: [
      "scripts/neutral-swarm/octahedral-speed-ode-diagnostic.mjs",
      "reference/priorities/swarm/shell-swarm/bounded-speed-factor-speed-ode-zero-mean-correction-target.md",
    ],
    artifact_claim: {
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-zero-mean-correction-intake.mjs [options]",
    "",
    "Options:",
