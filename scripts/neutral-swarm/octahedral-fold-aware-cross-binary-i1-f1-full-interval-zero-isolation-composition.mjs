...
export const OCTAHEDRAL_FOLD_AWARE_CROSS_BINARY_I1_F1_FULL_INTERVAL_ZERO_ISOLATION_COMPOSITION_SCHEMA =
  "neutral-swarm-octahedral-fold-aware-cross-binary-i1-f1-full-interval-zero-isolation-composition/v1";
...
export function buildOctahedralFoldAwareCrossBinaryI1F1FullIntervalZeroIsolationComposition(
  ...
  return {
    ...
    priority_packet:
      "reference/priorities/geometry-bridge/octahedral-fold-aware-cross-binary-i1-f1-full-interval-zero-isolation-composition.md",
