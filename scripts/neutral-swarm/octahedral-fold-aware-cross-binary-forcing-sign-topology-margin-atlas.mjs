...
export const OCTAHEDRAL_FOLD_AWARE_CROSS_BINARY_FORCING_SIGN_TOPOLOGY_MARGIN_ATLAS_SCHEMA =
  "neutral-swarm-octahedral-fold-aware-cross-binary-forcing-sign-topology-margin-atlas/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-fold-aware-cross-binary-forcing-sign-topology-margin-atlas.mjs [options]",
    "",
    "Options:",
