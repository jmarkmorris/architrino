...
export const OCTAHEDRAL_SAME_SOURCE_WITNESS_SCHEMA = "neutral-swarm-octahedral-same-source-witness/v1";
...
export function buildOctahedralSameSourceWitness(options = {}) {
  ...
  return {
    ...
    packet_id: PACKET_ID,
    artifact_id: "neutral_swarm_octahedral_same_source_positive_delay_witness.v1",
    promotion_status: PROMOTION_STATUS,
    source: "scripts/neutral-swarm/octahedral-same-source-witness.mjs",
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-same-source-witness.mjs [options]",
    "",
    "Options:",
...
function main() {
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema: "neutral-swarm-octahedral-same-source-witness-schema/v1",
