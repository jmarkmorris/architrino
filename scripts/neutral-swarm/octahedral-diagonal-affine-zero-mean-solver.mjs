...
export const OCTAHEDRAL_DIAGONAL_AFFINE_ZERO_MEAN_SOLVER_SCHEMA =
  "neutral-swarm-octahedral-diagonal-affine-zero-mean-solver/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-diagonal-affine-zero-mean-solver.mjs [options]",
    "",
    "Options:",
...
function main() {
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema: "neutral-swarm-octahedral-diagonal-affine-zero-mean-solver-schema/v1",
