...
export const OCTAHEDRAL_FOLD_AWARE_CLOCK_LENGTH_CHART_CLOSURE_PROOF_SCHEMA =
  "neutral-swarm-octahedral-fold-aware-clock-length-chart-closure-proof/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-fold-aware-clock-length-chart-closure-proof.mjs [options]",
    "",
    "Options:",
...
function main() {
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema: "neutral-swarm-octahedral-fold-aware-clock-length-chart-closure-proof-schema/v1",
