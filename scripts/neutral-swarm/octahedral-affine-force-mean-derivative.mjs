...
export const OCTAHEDRAL_AFFINE_FORCE_MEAN_DERIVATIVE_SCHEMA =
  "neutral-swarm-octahedral-affine-force-mean-derivative/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-affine-force-mean-derivative.mjs [options]",
    "",
    "Options:",
...
function main() {
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema: "neutral-swarm-octahedral-affine-force-mean-derivative-schema/v1",
