...
export const OCTAHEDRAL_PERIOD_RESCALED_FOLD_CHART_SCHEMA =
  "neutral-swarm-octahedral-period-rescaled-fold-chart/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-period-rescaled-fold-chart.mjs [options]",
    "",
    "Options:",
...
function main() {
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema: "neutral-swarm-octahedral-period-rescaled-fold-chart-schema/v1",
