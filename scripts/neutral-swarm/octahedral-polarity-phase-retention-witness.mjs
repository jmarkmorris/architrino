...
export const OCTAHEDRAL_POLARITY_PHASE_RETENTION_WITNESS_SCHEMA =
  "neutral-swarm-octahedral-polarity-phase-retention-witness/v1";
...
const SOURCE_PACKET = "reference/priorities/swarm/shell-swarm/polarity-phase-rigid-screen-results.md";
...
export function buildOctahedralPolarityPhaseRetentionWitness() {
  ...
  return {
    ...
    packet_id: PACKET_ID,
    artifact_id: "neutral_swarm_octahedral_polarity_phase_retention_witness.best_row_consumption.v1",
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-polarity-phase-retention-witness.mjs [options]",
    "",
    "Options:",
...
function main() {
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema: "neutral-swarm-octahedral-polarity-phase-retention-witness-schema/v1",
