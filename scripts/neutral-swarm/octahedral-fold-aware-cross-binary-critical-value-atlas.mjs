...
export const OCTAHEDRAL_FOLD_AWARE_CROSS_BINARY_CRITICAL_VALUE_ATLAS_SCHEMA =
  "neutral-swarm-octahedral-fold-aware-cross-binary-critical-value-atlas/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-fold-aware-cross-binary-critical-value-atlas.mjs [options]",
    "",
    "Options:",
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema:
            "neutral-swarm-octahedral-fold-aware-cross-binary-critical-value-atlas-schema/v1",
          artifact_schema:
            OCTAHEDRAL_FOLD_AWARE_CROSS_BINARY_CRITICAL_VALUE_ATLAS_SCHEMA,
          promotion_status: PROMOTION_STATUS,
          packet_id: PACKET_ID,
