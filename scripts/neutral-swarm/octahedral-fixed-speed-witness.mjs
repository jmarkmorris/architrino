...
export const OCTAHEDRAL_FIXED_SPEED_WITNESS_SCHEMA = "neutral-swarm-octahedral-fixed-speed-witness/v1";
...
export function buildOctahedralFixedSpeedWitness(options = {}) {
  ...
  return {
    ...
    packet_id: PACKET_ID,
    artifact_id: "neutral_swarm_octahedral_fixed_speed_witness.deterministic_nodes.v1",
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-fixed-speed-witness.mjs [options]",
    "",
    "Options:",
...
function main() {
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema: "neutral-swarm-octahedral-fixed-speed-witness-schema/v1",
