...
export const OCTAHEDRAL_FOLD_AWARE_CROSS_BINARY_FINITE_INTERVAL_CLOSURE_REDUCTION_SCHEMA =
  "neutral-swarm-octahedral-fold-aware-cross-binary-finite-interval-closure-reduction/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-fold-aware-cross-binary-finite-interval-closure-reduction.mjs [options]",
    "",
    "Options:",
