...
export const OCTAHEDRAL_FOLD_AWARE_CROSS_BINARY_FORCING_SIGN_BRACKET_CERTIFICATE_SCHEMA =
  "neutral-swarm-octahedral-fold-aware-cross-binary-forcing-sign-bracket-certificate/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-fold-aware-cross-binary-forcing-sign-bracket-certificate.mjs [options]",
    "",
    "Options:",
