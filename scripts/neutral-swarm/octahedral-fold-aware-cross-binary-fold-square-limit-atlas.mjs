...
export const OCTAHEDRAL_FOLD_AWARE_CROSS_BINARY_FOLD_SQUARE_LIMIT_ATLAS_SCHEMA =
  "neutral-swarm-octahedral-fold-aware-cross-binary-fold-square-limit-atlas/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-fold-aware-cross-binary-fold-square-limit-atlas.mjs [options]",
    "",
    "Options:",
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema:
            "neutral-swarm-octahedral-fold-aware-cross-binary-fold-square-limit-atlas-schema/v1",
          artifact_schema:
            OCTAHEDRAL_FOLD_AWARE_CROSS_BINARY_FOLD_SQUARE_LIMIT_ATLAS_SCHEMA,
          promotion_status: PROMOTION_STATUS,
          packet_id: PACKET_ID,
