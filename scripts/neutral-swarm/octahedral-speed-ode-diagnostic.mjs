...
export const OCTAHEDRAL_SPEED_ODE_DIAGNOSTIC_SCHEMA = "neutral-swarm-octahedral-speed-ode-diagnostic/v1";
...
export function buildOctahedralSpeedOdeDiagnostic(options = {}) {
  ...
  return {
    ...
    packet_id: PACKET_ID,
    artifact_id: "neutral_swarm_octahedral_speed_ode.frozen_fixed_ledger.v1",
    promotion_status: PROMOTION_STATUS,
    sources: [
      "scripts/neutral-swarm/octahedral-root-ledger.mjs",
      "scripts/neutral-swarm/octahedral-force-residual.mjs",
      "reference/priorities/swarm/shell-swarm/bounded-speed-factor-speed-ode-solvability.md",
      "reference/priorities/swarm/shell-swarm/bounded-speed-factor-all-pairs-ledger-handoff-contract.md",
    ],
    artifact_claim: {
    ...
    source_ledger_reference: {
      fixed_source_artifact_id: "neutral_swarm_octahedral_root_ledger.certified.v1",
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-speed-ode-diagnostic.mjs [options]",
    "",
    "Options:",
...
function main() {
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema: "neutral-swarm-octahedral-speed-ode-diagnostic-schema/v1",
