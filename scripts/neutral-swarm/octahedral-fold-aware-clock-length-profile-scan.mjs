...
export const OCTAHEDRAL_FOLD_AWARE_CLOCK_LENGTH_PROFILE_SCAN_SCHEMA =
  "neutral-swarm-octahedral-fold-aware-clock-length-profile-scan/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-fold-aware-clock-length-profile-scan.mjs [options]",
    "",
    "Options:",
...
function main() {
  ...
  if (args.schema) {
    process.stdout.write(
      printJson(
        {
          schema: "neutral-swarm-octahedral-fold-aware-clock-length-profile-scan-schema/v1",
