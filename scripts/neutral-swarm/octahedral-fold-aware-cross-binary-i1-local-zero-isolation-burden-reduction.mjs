...
export const OCTAHEDRAL_FOLD_AWARE_CROSS_BINARY_I1_LOCAL_ZERO_ISOLATION_BURDEN_REDUCTION_SCHEMA =
  "neutral-swarm-octahedral-fold-aware-cross-binary-i1-local-zero-isolation-burden-reduction/v1";
...
function usage() {
  return [
    "Usage: node scripts/neutral-swarm/octahedral-fold-aware-cross-binary-i1-local-zero-isolation-burden-reduction.mjs [options]",
    "",
    "Options:",
