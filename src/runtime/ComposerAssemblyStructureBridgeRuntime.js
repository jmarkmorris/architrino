          ...
          ? [
              {
                ...
                traits: { slot: slotName, variant: "composer_bridge" },
                children: [
                  ...(hasBinary
...
export function buildComposerAssemblyStructure(assembly = null) {
  if (!assembly?.id) {
...
export function summarizeComposerAssemblyStructure(root = null, validation = null) {
  if (!root) {
    return {
      nodeCount: 0,
      maxDepth: 0,
