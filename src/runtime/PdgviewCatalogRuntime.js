export const pdgviewSceneRoleOptions = [
  { value: "assembly", label: "Assembly" },
];

export const pdgviewAssemblyTemplateMenuRows = [
  [
...
export const pdgviewTimelineAddTypeEntries = [
...
export const pdgviewTimelineAddTypeIds = new Set(
  pdgviewTimelineAddTypeEntries.map((entry) => entry.id)
);
