...
import { getStructureNodeChildren, STRUCTURE_KINDS } from "../domain/structure/StructureSchema.js";
...
export function createComposerReactionBinaryInventoryRuntime(options = {}) {
