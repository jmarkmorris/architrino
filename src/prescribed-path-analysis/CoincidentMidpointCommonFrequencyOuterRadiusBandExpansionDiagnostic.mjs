import {
  ...
  createCoincidentMidpointCommonFrequencyInterBinaryRootFoldEvaluator,
...
} from "./CoincidentMidpointCommonFrequencyPrescribedStructuralRootLedger.mjs";
import {
...
} from "./CoincidentMidpointCommonFrequencyReceiverPhaseProjectionMonotonicityCertifier.mjs";
import {
  applyCoincidentMidpointCommonFrequencyRootSheetExecutionLimits,
  certifyCoincidentMidpointCommonFrequencyRootSheetAnchorInventory,
  certifyCoincidentMidpointCommonFrequencyRootSheetRepresentativeNoFold,
  evaluateCoincidentMidpointCommonFrequencyRootSheetMonotonicEnclosureTreatment,
  runCoincidentMidpointCommonFrequencyRootSheetEndpointAndSeamControl,
  runCoincidentMidpointCommonFrequencyRootSheetResourceExhaustionControl,
  runCoincidentMidpointCommonFrequencyRootSheetSyntheticFoldControl,
  summarizeCoincidentMidpointCommonFrequencyRootSheetMonotonicEnclosureTreatment,
} from "./CoincidentMidpointCommonFrequencyRootSheetMonotonicEnclosureCertifier.mjs";

export const COINCIDENT_MIDPOINT_COMMON_FREQUENCY_OUTER_RADIUS_EXPANSION_PROTOCOL_SCHEMA =
  "prescribed-path-analysis/coincident-midpoint-common-frequency-outer-radius-band-expansion-protocol.v1";
export const COINCIDENT_MIDPOINT_COMMON_FREQUENCY_OUTER_RADIUS_EXPANSION_RESULT_SCHEMA =
  "prescribed-path-analysis/coincident-midpoint-common-frequency-outer-radius-band-expansion-result.v1";
export const COINCIDENT_MIDPOINT_COMMON_FREQUENCY_OUTER_RADIUS_EXPANSION_SUMMARY_SCHEMA =
  "prescribed-path-analysis/coincident-midpoint-common-frequency-outer-radius-band-expansion-summary.v1";
export const COINCIDENT_MIDPOINT_COMMON_FREQUENCY_OUTER_RADIUS_SECOND_EXPANSION_PROTOCOL_SCHEMA =
  "prescribed-path-analysis/" +
  "coincident-midpoint-common-frequency-outer-radius-second-band-expansion-protocol.v1";
export const COINCIDENT_MIDPOINT_COMMON_FREQUENCY_OUTER_RADIUS_SECOND_EXPANSION_RESULT_SCHEMA =
  "prescribed-path-analysis/" +
  "coincident-midpoint-common-frequency-outer-radius-second-band-expansion-result.v1";
export const COINCIDENT_MIDPOINT_COMMON_FREQUENCY_OUTER_RADIUS_SECOND_EXPANSION_SUMMARY_SCHEMA =
  "prescribed-path-analysis/" +
  "coincident-midpoint-common-frequency-outer-radius-second-band-expansion-summary.v1";
export const COINCIDENT_MIDPOINT_COMMON_FREQUENCY_OUTER_RADIUS_HISTORY_EXTENSION_PROTOCOL_SCHEMA =
  "prescribed-path-analysis/" +
  "coincident-midpoint-common-frequency-outer-radius-history-policy-extension-protocol.v1";
export const COINCIDENT_MIDPOINT_COMMON_FREQUENCY_OUTER_RADIUS_HISTORY_EXTENSION_RESULT_SCHEMA =
  "prescribed-path-analysis/" +
  "coincident-midpoint-common-frequency-outer-radius-history-policy-extension-result.v1";
export const COINCIDENT_MIDPOINT_COMMON_FREQUENCY_OUTER_RADIUS_HISTORY_EXTENSION_SUMMARY_SCHEMA =
  "prescribed-path-analysis/" +
  "coincident-midpoint-common-frequency-outer-radius-history-policy-extension-summary.v1";
...
function validateScientificIdentity(protocol) {
  ...
  if (identity?.assemblyId !== "asm-2a289a6fe32f64922ab71bae973acc80" ||
    ...
    throw new TypeError(
      "outer-radius protocol requires the exact coincident-midpoint common-frequency scientific identity.",
    );
  }
}
...
const EXPECTED_REPRESENTATIVES = Object.freeze([
  ...
  "coincident-midpoint-common-frequency-binary-2-endpoint-1<-coincident-midpoint-common-frequency-binary-1-endpoint-1",
  "coincident-midpoint-common-frequency-binary-2-endpoint-1<-coincident-midpoint-common-frequency-binary-1-endpoint-2",
  "coincident-midpoint-common-frequency-binary-2-endpoint-1<-coincident-midpoint-common-frequency-binary-3-endpoint-1",
  "coincident-midpoint-common-frequency-binary-2-endpoint-1<-coincident-midpoint-common-frequency-binary-3-endpoint-2",
  "coincident-midpoint-common-frequency-binary-3-endpoint-1<-coincident-midpoint-common-frequency-binary-1-endpoint-1",
  "coincident-midpoint-common-frequency-binary-3-endpoint-1<-coincident-midpoint-common-frequency-binary-1-endpoint-2",
  "coincident-midpoint-common-frequency-binary-3-endpoint-1<-coincident-midpoint-common-frequency-binary-2-endpoint-1",
  "coincident-midpoint-common-frequency-binary-3-endpoint-1<-coincident-midpoint-common-frequency-binary-2-endpoint-2",
]);
...
export function validateCoincidentMidpointCommonFrequencyOuterRadiusExpansionProtocol(rawProtocol) {
  if (!rawProtocol || typeof rawProtocol !== "object" ||
      Array.isArray(rawProtocol)) {
    throw new TypeError("coincident-midpoint common-frequency three-axis circular configuration outer-radius expansion protocol must be an object.");
  }
  if (rawProtocol.schema !== COINCIDENT_MIDPOINT_COMMON_FREQUENCY_OUTER_RADIUS_EXPANSION_PROTOCOL_SCHEMA) {
    throw new TypeError(
      `coincident-midpoint common-frequency three-axis circular configuration outer-radius expansion requires schema ` +
      `${COINCIDENT_MIDPOINT_COMMON_FREQUENCY_OUTER_RADIUS_EXPANSION_PROTOCOL_SCHEMA}.`,
    );
  }
  ...
  if (rawProtocol.claimGrade !== "diagnostic" ||
    ...
    throw new TypeError(
      "coincident-midpoint common-frequency three-axis circular configuration outer-radius expansion must remain prescribed-only and null-score.",
    );
  }
  ...
  if (expansion?.order !== 1 ||
    ...
    throw new TypeError("coincident-midpoint common-frequency three-axis circular configuration expansion order or fixed-coordinate declaration drifted.");
  }
  ...
  if (rootSheet?.dependentVariable !== "dimensionlessDelay" ||
    ...
    throw new TypeError("coincident-midpoint common-frequency three-axis circular configuration expanded root-sheet declaration drifted.");
  }
  ...
  if (fold?.squaredResidualExclusionFloor !== 1e-10 ||
    ...
    throw new TypeError(
      "coincident-midpoint common-frequency three-axis circular configuration expanded fold treatment may not relax the certified baseline settings.",
    );
  }
  ...
  if (projection?.middleTransmitter?.positivePolynomialLowerBound !== 1 / 64 ||
      ...
      projection?.outerTransmitter?.projectionDerivativeUpperBound !==
        829 / 2) {
    throw new TypeError("coincident-midpoint common-frequency three-axis circular configuration expanded projection bounds drifted.");
  }
  ...
  if (controls?.baselineExactReplayRequired !== true ||
    ...
    throw new TypeError(
      "coincident-midpoint common-frequency three-axis circular configuration outer-radius verification/advancement controls drifted.",
    );
  }
  return structuredClone(rawProtocol);
}

export function validateCoincidentMidpointCommonFrequencyOuterRadiusSecondBandExpansionProtocol(rawProtocol) {
  if (!rawProtocol || typeof rawProtocol !== "object" ||
      Array.isArray(rawProtocol)) {
    throw new TypeError(
      "coincident-midpoint common-frequency three-axis circular configuration second outer-radius expansion protocol must be an object.",
    );
  }
  if (rawProtocol.schema !==
      COINCIDENT_MIDPOINT_COMMON_FREQUENCY_OUTER_RADIUS_SECOND_EXPANSION_PROTOCOL_SCHEMA) {
    throw new TypeError(
      `coincident-midpoint common-frequency three-axis circular configuration second outer-radius expansion requires schema ` +
      `${COINCIDENT_MIDPOINT_COMMON_FREQUENCY_OUTER_RADIUS_SECOND_EXPANSION_PROTOCOL_SCHEMA}.`,
    );
  }
  validateScientificIdentity(rawProtocol);
  ...
  if (rawProtocol.claimGrade !== "diagnostic" ||
      ...
      boundary?.candidateSelection !== false) {
    throw new TypeError(
      "coincident-midpoint common-frequency three-axis circular configuration second outer-radius expansion must remain prescribed-only " +
      "and null-score.",
    );
  }
  const expansion = rawProtocol.radiusExpansion;
  if (expansion?.order !== 2 ||
      ...
      expansion?.historyReachChi !== 9 / 4) {
    throw new TypeError(
      "coincident-midpoint common-frequency three-axis circular configuration second expansion order or fixed-coordinate declaration drifted.",
    );
  }
  exactArray(expansion.baseline?.alpha1, EXPECTED_ALPHA1, "baseline.alpha1");
  exactArray(expansion.baseline?.alpha2, [1, 1], "baseline.alpha2");
  ...
  if (rootSheet?.dependentVariable !== "dimensionlessDelay" ||
      ...
      rootSheet?.rootCountInvarianceTheorem?.id !==
        "connected-parameter-domain/no-root-endpoint/no-fold-root-count-invariance.v1") {
    throw new TypeError("coincident-midpoint common-frequency three-axis circular configuration second expanded root-sheet declaration drifted.");
  }
  const fold = rawProtocol.foldExclusion;
  if (fold?.squaredResidualExclusionFloor !== 1e-10 ||
      fold?.squaredDelayDerivativeExclusionFloor !== 1e-8 ||
      ...
      fold?.splitPolicy !== "largest-active-normalized-width.v1") {
    throw new TypeError(
      "coincident-midpoint common-frequency three-axis circular configuration second expanded fold treatment may not relax baseline settings.",
    );
  }
  const projection = rawProtocol.projectionCertificate;
  if (projection?.middleTransmitter?.positivePolynomialLowerBound !== 1 / 64 ||
    ...
    throw new TypeError("coincident-midpoint common-frequency three-axis circular configuration second expanded projection bounds drifted.");
  }
  const prior = rawProtocol.sealedPriorCombinedBox;
  if (prior?.protocolHash !==
      "01c117a21c2b5fe709bab3bcbffe7a07a8598227bf82e8baa77d517bd498e464" ||
      prior?.resultHash !==
        "ca80393d36b7866abb4af48f96e309dee93629804f15d723b95d9531df3425d7" ||
      prior?.summaryHash !==
        "a68b1f12cf3e79fe40e55f5b1b4fc750b00991ba2b4ac4b94a45d6d81f07c95e") {
    throw new TypeError("coincident-midpoint common-frequency three-axis circular configuration prior combined-box control identity drifted.");
  }
  const controls = rawProtocol.controls;
  if (controls?.baselineExactReplayRequired !== true ||
      ...
      rawProtocol.completionRule?.stopAfterThisBand !== true) {
    throw new TypeError(
      "coincident-midpoint common-frequency three-axis circular configuration second-band verification/advancement controls drifted.",
    );
  }
  return structuredClone(rawProtocol);
}

export function validateCoincidentMidpointCommonFrequencyOuterRadiusHistoryPolicyExtensionProtocol(
  rawProtocol,
) {
  if (!rawProtocol || typeof rawProtocol !== "object" ||
      Array.isArray(rawProtocol)) {
    throw new TypeError(
      "coincident-midpoint common-frequency three-axis circular configuration outer-radius history-policy extension protocol must be an object.",
    );
  }
  if (rawProtocol.schema !==
      COINCIDENT_MIDPOINT_COMMON_FREQUENCY_OUTER_RADIUS_HISTORY_EXTENSION_PROTOCOL_SCHEMA) {
    throw new TypeError(
      `coincident-midpoint common-frequency three-axis circular configuration outer-radius history-policy extension requires schema ` +
      `${COINCIDENT_MIDPOINT_COMMON_FREQUENCY_OUTER_RADIUS_HISTORY_EXTENSION_PROTOCOL_SCHEMA}.`,
    );
  }
  validateScientificIdentity(rawProtocol);
  ...
  if (rawProtocol.claimGrade !== "diagnostic" ||
      ...
      boundary?.candidateSelection !== false) {
    throw new TypeError(
      "coincident-midpoint common-frequency three-axis circular configuration history-policy extension must remain prescribed-only " +
      "and null-score.",
    );
  }
  ...
  if (history?.previousRetainedReachChi !== 9 / 4 ||
    ...
    throw new TypeError(
      "coincident-midpoint common-frequency three-axis circular configuration retained-history declaration or prior-boundary ownership drifted.",
    );
  }
  exactArray(
  ...
  if (expansion?.order !== 3 ||
    ...
    throw new TypeError(
      "coincident-midpoint common-frequency three-axis circular configuration history-policy extension scope or fixed coordinate drifted.",
    );
  }
  exactArray(expansion.baseline?.alpha1, EXPECTED_ALPHA1, "baseline.alpha1");
  exactArray(expansion.baseline?.alpha2, [1, 1], "baseline.alpha2");
  ...
  if (rootSheet?.dependentVariable !== "dimensionlessDelay" ||
      ...
      rootSheet?.rootCountInvarianceTheorem?.id !==
        "connected-parameter-domain/no-root-endpoint/no-fold-root-count-invariance.v1") {
    throw new TypeError("coincident-midpoint common-frequency three-axis circular configuration extended-history root-sheet declaration drifted.");
  }
  const fold = rawProtocol.foldExclusion;
  if (fold?.squaredResidualExclusionFloor !== 1e-10 ||
      fold?.squaredDelayDerivativeExclusionFloor !== 1e-8 ||
      ...
      fold?.splitPolicy !== "largest-active-normalized-width.v1") {
    throw new TypeError(
      "coincident-midpoint common-frequency three-axis circular configuration history-policy extension may not alter precision, tolerances, " +
      "or resources.",
    );
  }
  ...
  if (anchor?.point?.alpha1 !== 29 / 32 ||
    ...
    throw new TypeError("coincident-midpoint common-frequency three-axis circular configuration history-policy anchor or root gates drifted.");
  }
  const projection = rawProtocol.projectionCertificate;
  exactArray(
  ...
  if (projection?.middleTransmitter?.positivePolynomialLowerBound !== 1 / 64 ||
      ...
      projection?.outerTransmitter?.projectionDerivativeLowerBound !==
        33 / 30100 ||
      projection?.outerTransmitter?.projectionDerivativeUpperBound !== 430) {
    throw new TypeError("coincident-midpoint common-frequency three-axis circular configuration extended-history projection bounds drifted.");
  }
  const previous = rawProtocol.sealedPreviousBoundary;
  if (previous?.protocolHash !==
      "a051e8f4637302523a9c3732362085acd810295edb1450c2f9ed078cc66fb92c" ||
      previous?.resultHash !==
    ...
    throw new TypeError("coincident-midpoint common-frequency three-axis circular configuration previous boundary control identity drifted.");
  }
  const controls = rawProtocol.controls;
  if (controls?.previousBoundaryExactReplayRequired !== true ||
    ...
    throw new TypeError(
      "coincident-midpoint common-frequency three-axis circular configuration history-policy verification/advancement controls drifted.",
    );
  }
  return structuredClone(rawProtocol);
}
...
function runSameAndPartnerInventory({ protocol, baseProtocol, allChannels }) {
  ...
  const firstTopologyBoundary = outerSelfBoundaryInside
    ? {
      id: "coincident-midpoint-common-frequency-outer-self-history-edge-topology-boundary.v1",
  ...
  return {
    id: "coincident-midpoint-common-frequency-expanded-same-and-partner-root-inventory.v1",
    passed,
...
function runRefinedHistoryEdgeControl({
  ...
  const representativeRows = representatives.map((channel) => {
    ...
    for (const alpha1 of domain.alpha1) {
      for (const alpha3 of domain.alpha3) {
        ...
        const direct = recomputeCoincidentMidpointCommonFrequencySquaredCausalResidual({
          protocol: baseProtocol,
          receiver: channel.receiver,
          transmitter: channel.transmitter,
          alpha1,
  ...
  return {
    id: "coincident-midpoint-common-frequency-history-edge-phase-partition-refinement.v1",
    historyEdge,
    ...
    independentInstrument:
      "coincident-midpoint-common-frequency-squared-causal-residual-direct-coordinate-recomputation.v1",
...
function runExpandedInterBinaryInventory({
  ...
  const evaluator = createCoincidentMidpointCommonFrequencyInterBinaryRootFoldEvaluator(baseProtocol);
  const limits = applyCoincidentMidpointCommonFrequencyRootSheetExecutionLimits(treatment, executionLimits);
  ...
  const coarseEndpointAndSeam =
    runCoincidentMidpointCommonFrequencyRootSheetEndpointAndSeamControl(treatment);
  ...
  const endpointAndSeam = historyEdgeRefinement
    ...
    : coarseEndpointAndSeam;
  const syntheticFold = runCoincidentMidpointCommonFrequencyRootSheetSyntheticFoldControl(treatment);
  const resourceExhaustion = runCoincidentMidpointCommonFrequencyRootSheetResourceExhaustionControl({
    protocol: treatment,
  ...
  const passed =
    ...
    unresolved.length === 0;
  return {
    id: "coincident-midpoint-common-frequency-expanded-inter-binary-root-sheet-inventory.v1",
    passed,
...
function independentProjectionWitnesses({
  ...
  return {
    id: "coincident-midpoint-common-frequency-expanded-projection-independent-boundary-witnesses.v1",
...
function projectionEndpointInversion({
  ...
  return {
    id: "coincident-midpoint-common-frequency-expanded-projection-endpoint-inversion-control.v1",
    comparisonCount,
...
function projectionPhaseSeam({ protocol, channelById, evaluator }) {
  ...
  return {
    id: "coincident-midpoint-common-frequency-expanded-projection-phase-seam-control.v1",
    replayCount,
    maximumEnclosureEndpointDifference: maximumDifference,
    tolerance: 1e-12,
    passed: maximumDifference <= 1e-12,
...
function runProjectionCertificate({
  ...
  return {
    id: "coincident-midpoint-common-frequency-expanded-receiver-phase-projection-monotonicity.v1",
    passed,
...
function runBaselineReplay({
  ...
  const rootResult = evaluateCoincidentMidpointCommonFrequencyRootSheetMonotonicEnclosureTreatment({
    treatmentProtocol: baselineRootSheetProtocol,
    baseProtocol,
    sealedSummary: baselineContinuousSummary,
  });
  const rootSummary =
    summarizeCoincidentMidpointCommonFrequencyRootSheetMonotonicEnclosureTreatment(rootResult);
  const structuralResult = evaluateCoincidentMidpointCommonFrequencyPrescribedStructuralRootLedger({
  ...
  const structuralSummary =
    summarizeCoincidentMidpointCommonFrequencyPrescribedStructuralRootLedger(structuralResult);
  ...
  const projectionSummary =
    summarizeCoincidentMidpointCommonFrequencyReceiverPhaseProjectionMonotonicity(projectionResult);
  const controls = {
    rootSheet: {
  ...
  return {
    id: "coincident-midpoint-common-frequency-original-radius-box-exact-deterministic-replay.v1",
...
function runPriorCombinedBoxReplay({
  ...
  if (sha256CoincidentMidpointCommonFrequencyInterval(priorExpansionProtocol) !==
      declaration.protocolHash) {
    throw new TypeError("coincident-midpoint common-frequency three-axis circular configuration prior combined-box protocol hash drifted.");
  }
  validateSealedSummary(
    priorExpansionSummary,
    declaration,
  ...
  const result = evaluateCoincidentMidpointCommonFrequencyOuterRadiusBandExpansion({
  ...
  return {
    id: "coincident-midpoint-common-frequency-prior-combined-box-exact-deterministic-replay.v1",
    expectedProtocolHash: declaration.protocolHash,
    observedProtocolHash: sha256CoincidentMidpointCommonFrequencyInterval(priorExpansionProtocol),
...
function runPreviousBoundaryReplay({
  ...
  if (sha256CoincidentMidpointCommonFrequencyInterval(previousBoundaryProtocol) !==
      declaration.protocolHash) {
    throw new TypeError("coincident-midpoint common-frequency three-axis circular configuration previous boundary protocol hash drifted.");
  }
  validateSealedSummary(
    previousBoundarySummary,
    declaration,
  ...
  const summary = summarizeCoincidentMidpointCommonFrequencyOuterRadiusBandExpansion(result);
  return {
    id: "coincident-midpoint-common-frequency-previous-history-edge-boundary-exact-replay.v1",
    expectedProtocolHash: declaration.protocolHash,
    observedProtocolHash: sha256CoincidentMidpointCommonFrequencyInterval(previousBoundaryProtocol),
    expectedResultHash: declaration.resultHash,
    observedResultHash: result.resultHash,
    expectedSummaryHash: declaration.summaryHash,
    observedSummaryHash: summary.summaryHash,
...
function runHistoryPolicySufficiencyControl({
  ...
  return {
    id: "coincident-midpoint-common-frequency-outer-radius-retained-history-sufficiency.v1",
...
export function evaluateCoincidentMidpointCommonFrequencyOuterRadiusBandExpansion({
  ...
  const protocol = historyExtension
    ? validateCoincidentMidpointCommonFrequencyOuterRadiusHistoryPolicyExtensionProtocol(rawExpansionProtocol)
    : secondBand
      ? validateCoincidentMidpointCommonFrequencyOuterRadiusSecondBandExpansionProtocol(rawExpansionProtocol)
      : validateCoincidentMidpointCommonFrequencyOuterRadiusExpansionProtocol(rawExpansionProtocol);
  const baseProtocol = validateCoincidentMidpointCommonFrequencyContinuousRootInventoryProtocol(
    rawBaseProtocol,
  );
  const baseHash = sha256CoincidentMidpointCommonFrequencyInterval(rawBaseProtocol);
  if (baseHash !== protocol.sealedBaseline.baseProtocol.sha256) {
    throw new TypeError("coincident-midpoint common-frequency three-axis circular configuration expansion base protocol hash drifted.");
  }
  ...
  const completeChannelAccounting = {
    id: "coincident-midpoint-common-frequency-expanded-complete-36-ordered-channel-accounting.v1",
  ...
  const resultWithoutHash = {
    schema: historyExtension
      ? COINCIDENT_MIDPOINT_COMMON_FREQUENCY_OUTER_RADIUS_HISTORY_EXTENSION_RESULT_SCHEMA
      : secondBand
        ? COINCIDENT_MIDPOINT_COMMON_FREQUENCY_OUTER_RADIUS_SECOND_EXPANSION_RESULT_SCHEMA
        : COINCIDENT_MIDPOINT_COMMON_FREQUENCY_OUTER_RADIUS_EXPANSION_RESULT_SCHEMA,
    scientificIdentity: protocol.sourceConfiguration.scientificIdentity,
    evaluator: {
      id: historyExtension
        ? "coincident-midpoint-common-frequency-outer-radius-history-policy-extension-diagnostic"
        : secondBand
          ? "coincident-midpoint-common-frequency-outer-radius-second-band-expansion-diagnostic"
          : "coincident-midpoint-common-frequency-outer-radius-band-expansion-diagnostic",
      version: 1,
    ...
    expansionProtocolHash: sha256CoincidentMidpointCommonFrequencyInterval(rawExpansionProtocol),
...
export function summarizeCoincidentMidpointCommonFrequencyOuterRadiusBandExpansion(result) {
  if (!result ||
      ![
        COINCIDENT_MIDPOINT_COMMON_FREQUENCY_OUTER_RADIUS_EXPANSION_RESULT_SCHEMA,
        COINCIDENT_MIDPOINT_COMMON_FREQUENCY_OUTER_RADIUS_SECOND_EXPANSION_RESULT_SCHEMA,
    ...
    throw new TypeError(
      "result must use a supported coincident-midpoint common-frequency three-axis circular configuration outer-radius expansion schema.",
    );
  }
  const secondBand =
    result.schema === COINCIDENT_MIDPOINT_COMMON_FREQUENCY_OUTER_RADIUS_SECOND_EXPANSION_RESULT_SCHEMA;
  const historyExtension =
    result.schema === COINCIDENT_MIDPOINT_COMMON_FREQUENCY_OUTER_RADIUS_HISTORY_EXTENSION_RESULT_SCHEMA;
  const compactRepresentative = (row) => ({
    ...
    foldExclusion: {
      ...
      rawLedgerHash: sha256CoincidentMidpointCommonFrequencyInterval(row.foldExclusion.ledger),
    },
    anchorRootInventory: {
      ...
      rawLedgerHash: sha256CoincidentMidpointCommonFrequencyInterval(row.anchorRootInventory.ledger),
    },
  });
  const summaryWithoutHash = {
    schema: historyExtension
      ? COINCIDENT_MIDPOINT_COMMON_FREQUENCY_OUTER_RADIUS_HISTORY_EXTENSION_SUMMARY_SCHEMA
      : secondBand
        ? COINCIDENT_MIDPOINT_COMMON_FREQUENCY_OUTER_RADIUS_SECOND_EXPANSION_SUMMARY_SCHEMA
        : COINCIDENT_MIDPOINT_COMMON_FREQUENCY_OUTER_RADIUS_EXPANSION_SUMMARY_SCHEMA,
