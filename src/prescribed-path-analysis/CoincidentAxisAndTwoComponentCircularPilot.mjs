import {
  ...
  validateCoincidentAxisAndTwoComponentCircularConfigurationSpec,
} from "./CoincidentAxisAndTwoComponentCircularConfiguration.mjs";
...
export function createCoincidentAxisAndTwoComponentCircularConfigurationSpec({
  specId,
  label,
  geometryClass,
  radii,
  ...
  return validateCoincidentAxisAndTwoComponentCircularConfigurationSpec(spec);
}
...
function perturbReference(reference, seed) {
  ...
  return createCoincidentAxisAndTwoComponentCircularConfigurationSpec({
...
export function createCoincidentAxisAndTwoComponentCircularPilotInventory({
  seed = 20210102,
  ...
  const references = [
    createCoincidentAxisAndTwoComponentCircularConfigurationSpec({
      specId: "coincident-axis-three-binary-central-envelope-reference",
      label: "Coincident-axis three-binary central-envelope reference",
    ...
    createCoincidentAxisAndTwoComponentCircularConfigurationSpec({
      ...
      label:
        "Counter-rotating two-component circular central-envelope no-Accessory-Configuration reference",
    ...
    createCoincidentAxisAndTwoComponentCircularConfigurationSpec({
      ...
      label:
        "Counter-rotating two-component circular central-envelope six-architrino Accessory Configuration reference",
      geometryClass: "twelve-architrino",
      radii: twelveWorldlineEnvelope,
      spacings: equalDualSpacing,
    ...
    createCoincidentAxisAndTwoComponentCircularConfigurationSpec({
      specId:
        "counter-rotating-two-component-circular-equal-radius-no-accessory",
      label:
        "Counter-rotating two-component circular equal-radius no-Accessory-Configuration control",
      geometryClass: "twelve-architrino",
      radii: equalDual,
      spacings: equalDualSpacing,
    }),
    createCoincidentAxisAndTwoComponentCircularConfigurationSpec({
      specId: "counter-rotating-two-component-circular-reflection-broken",
      label:
        "Counter-rotating two-component circular reflection-broken adverse control",
      geometryClass: "twelve-architrino",
      radii: brokenRadii,
    ...
    createCoincidentAxisAndTwoComponentCircularConfigurationSpec({
      ...
      label:
        "Counter-rotating two-component circular central-envelope six-accessory crossed-pairing control",
      geometryClass: "twelve-architrino",
      radii: twelveWorldlineEnvelope,
      spacings: equalDualSpacing,
      additionalWorldlineCount: 6,
  ...
  const rows = references.map((spec) => ({
    ...
    spec,
    sourceRecord: createCoincidentAxisAndTwoComponentCircularExactSourceRecord(spec),
  }));
...
export function perturbCoincidentAxisAndTwoComponentCircularSpacingScale(rawSpec, delta) {
  ...
  return validateCoincidentAxisAndTwoComponentCircularConfigurationSpec(perturbed);
}

export const COINCIDENT_AXIS_AND_TWO_COMPONENT_CIRCULAR_SPACING_SENSITIVITY_ADAPTER = Object.freeze({
  coordinateId: "central-spacing-scale",
  coordinatePath: "spacingVector[*] about fixed train midpoint",
  perturbSpec: perturbCoincidentAxisAndTwoComponentCircularSpacingScale,
  createSourceRecord: (spec) => createCoincidentAxisAndTwoComponentCircularExactSourceRecord(spec),
});
