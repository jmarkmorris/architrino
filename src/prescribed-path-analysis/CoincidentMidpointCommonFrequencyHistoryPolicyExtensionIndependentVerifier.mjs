...
import {
  ...
  certifyCoincidentMidpointCommonFrequencyProjectionRepresentativeInterval,
  evaluateCoincidentMidpointCommonFrequencyReceiverPhaseProjectionMonotonicity,
  runCoincidentMidpointCommonFrequencyProjectionEndpointInversionControl,
  runCoincidentMidpointCommonFrequencyProjectionPhaseSeamControl,
  runCoincidentMidpointCommonFrequencyProjectionSyntheticControls,
...
export const COINCIDENT_MIDPOINT_COMMON_FREQUENCY_HISTORY_EXTENSION_INDEPENDENT_PROTOCOL_SCHEMA =
  "prescribed-path-analysis/" +
  "coincident-midpoint-common-frequency-history-policy-extension-independent-verifier-protocol.v1";
export const COINCIDENT_MIDPOINT_COMMON_FREQUENCY_HISTORY_EXTENSION_INDEPENDENT_RESULT_SCHEMA =
  "prescribed-path-analysis/" +
  "coincident-midpoint-common-frequency-history-policy-extension-independent-verifier-result.v1";
export const COINCIDENT_MIDPOINT_COMMON_FREQUENCY_HISTORY_EXTENSION_INDEPENDENT_SUMMARY_SCHEMA =
  "prescribed-path-analysis/" +
  "coincident-midpoint-common-frequency-history-policy-extension-independent-verifier-summary.v1";
...
function validateScientificIdentity(protocol) {
  ...
  if (identity?.assemblyId !== "asm-2a289a6fe32f64922ab71bae973acc80" ||
    ...
    throw new TypeError(
      "independent verifier requires the exact coincident-midpoint common-frequency scientific identity.",
    );
  }
}
...
const EXPECTED_ROOT_PROTOCOL_HASH =
  "a85f1d3b668f2aab7601ea2327613b193219feab109e210586354d7648bb9d3b";
...
const EXPECTED_PROJECTION_PROTOCOL_HASH =
  "d528d27f660b0e76eff2d7dc5f717420d2dfcf396b82befbdc719911fe767405";
const EXPECTED_PROJECTION_RESULT_HASH =
  "3cea3f991ba78f8b327cbf11c6b83a85162104a92220965e8f0921d73d5ed11d";
const EXPECTED_PROJECTION_SUMMARY_HASH =
  "f862fe2bc950d7026e0729b9a8dd7f9cbe7b992a16ae5c64050c207f7cd0947a";
...
const EXPECTED_SUBJECT_PROTOCOL_HASH =
  "4e864e3ff3e3bb6799e70e6715643fd23b902edde482b1f4591a8207ca6748ff";
...
function validateFrozenResources(protocol) {
  ...
  if (fold?.squaredResidualExclusionFloor !== 1e-10 ||
    ...
    throw new TypeError(
      "coincident-midpoint common-frequency three-axis circular configuration independent verifier may not alter frozen resources or floors.",
    );
  }
}

export function validateCoincidentMidpointCommonFrequencyHistoryPolicyExtensionIndependentProtocol(
  rawProtocol,
) {
  if (!rawProtocol || typeof rawProtocol !== "object" ||
      Array.isArray(rawProtocol) ||
      rawProtocol.schema !== COINCIDENT_MIDPOINT_COMMON_FREQUENCY_HISTORY_EXTENSION_INDEPENDENT_PROTOCOL_SCHEMA) {
    throw new TypeError(
      `independent verifier requires schema ` +
      `${COINCIDENT_MIDPOINT_COMMON_FREQUENCY_HISTORY_EXTENSION_INDEPENDENT_PROTOCOL_SCHEMA}.`,
    );
  }
  ...
  if (rawProtocol.claimGrade !==
    ...
    throw new TypeError(
      "coincident-midpoint common-frequency three-axis circular configuration independent verifier must remain diagnostic-only and null-score.",
    );
  }
  exactArray(
  ...
  if (rawProtocol.relativePhaseLock?.relativePhaseOffsetsVary !== false ||
    ...
    throw new TypeError("coincident-midpoint common-frequency three-axis circular configuration independent relative-phase lock drifted.");
  }
  ...
  if (rawProtocol.rootSheet?.leftBoundaryOwnership !==
    ...
    throw new TypeError("coincident-midpoint common-frequency three-axis circular configuration independent root-sheet declaration drifted.");
  }
  exactArray(
  ...
  if (JSON.stringify(rawProtocol.endpointInversionReuse) !==
    ...
    throw new TypeError("coincident-midpoint common-frequency three-axis circular configuration independent endpoint-inversion map drifted.");
  }
  ...
  if (anchor?.point?.alpha1 !== 29 / 32 ||
    ...
    throw new TypeError("coincident-midpoint common-frequency three-axis circular configuration independent anchor declaration drifted.");
  }
  ...
  if (JSON.stringify(projection?.endpointInversionReuse) !==
    ...
    throw new TypeError("coincident-midpoint common-frequency three-axis circular configuration independent projection inversion map drifted.");
  }
  exactArray(
  ...
  if (analytic?.method !==
    ...
    throw new TypeError("coincident-midpoint common-frequency three-axis circular configuration independent projection bounds drifted.");
  }
  ...
  if (originalRoot?.protocolHash !== EXPECTED_ROOT_PROTOCOL_HASH ||
    ...
    throw new TypeError("coincident-midpoint common-frequency three-axis circular configuration independent sealed control identity drifted.");
  }
  ...
  if (controls?.originalVerifierExactReplayRequired !== true ||
    ...
    throw new TypeError(
      "coincident-midpoint common-frequency three-axis circular configuration independent verification/advancement controls drifted.",
    );
  }
...
function runOriginalVerifierReplay({
  ...
  if (sha256CoincidentMidpointCommonFrequencyInterval(originalRootProtocol) !==
        rootDeclaration.protocolHash ||
      sha256CoincidentMidpointCommonFrequencyInterval(originalProjectionProtocol) !==
  ...
  return {
    id: "coincident-midpoint-common-frequency-original-full-domain-verifier-exact-replay.v1",
    rootSheet: {
...
function validateSubjectControl(protocol, subjectProtocol, subjectSummary) {
  ...
  if (sha256CoincidentMidpointCommonFrequencyInterval(subjectProtocol) !== declaration.protocolHash) {
  ...
  return {
    id: "coincident-midpoint-common-frequency-history-extension-sealed-subject-identity-control.v1",
...
function validatePreviousBoundaryReplay(protocol, replay) {
  ...
  const passed =
    ...
    replay?.passed === true;
  return {
    id: "coincident-midpoint-common-frequency-previous-history-edge-boundary-exact-replay-control.v1",
    ...replay,
    passed,
  };
}
...
function runIndependentTopology({
  ...
  const passed =
    ...
    unresolved.length === 0;
  return {
    id: "coincident-midpoint-common-frequency-history-extension-independent-root-topology.v1",
    passed,
    topologyById,
...
function projectionPointWitnesses({
  ...
  return {
    id: "coincident-midpoint-common-frequency-history-extension-independent-projection-point-controls.v1",
    rows,
...
function runIndependentProjection({
  ...
  const representativeResults = representatives.map((channel) =>
    certifyCoincidentMidpointCommonFrequencyProjectionAnalyticRepresentative(channel, view));
  const endpointInversion = runCoincidentMidpointCommonFrequencyProjectionEndpointInversionControl({
    protocol: view,
    channelById,
    evaluator,
  });
  const phaseSeam = runCoincidentMidpointCommonFrequencyProjectionPhaseSeamControl({
    protocol: view,
    representatives,
    evaluator,
  });
  const synthetic = runCoincidentMidpointCommonFrequencyProjectionSyntheticControls(view);
  const resourcePacket = { boxes: 0, evaluations: 0 };
  const resourceResult = certifyCoincidentMidpointCommonFrequencyProjectionRepresentativeInterval({
  ...
  const resourceExhaustion = {
    id: "coincident-midpoint-common-frequency-history-extension-independent-projection-resource-control.v1",
  ...
  return {
    id: "coincident-midpoint-common-frequency-history-extension-independent-positive-projection.v1",
    passed,
...
export function evaluateCoincidentMidpointCommonFrequencyHistoryPolicyExtensionIndependentVerifier({
  ...
  const protocol =
    validateCoincidentMidpointCommonFrequencyHistoryPolicyExtensionIndependentProtocol(rawVerifierProtocol);
  const baseProtocol =
    validateCoincidentMidpointCommonFrequencyContinuousRootInventoryProtocol(rawBaseProtocol);
  if (sha256CoincidentMidpointCommonFrequencyInterval(rawBaseProtocol) !== protocol.baseProtocol.sha256) {
  ...
  const resultWithoutHash = {
    schema: COINCIDENT_MIDPOINT_COMMON_FREQUENCY_HISTORY_EXTENSION_INDEPENDENT_RESULT_SCHEMA,
    scientificIdentity: protocol.sourceConfiguration.scientificIdentity,
    verifier: {
      id: "coincident-midpoint-common-frequency-history-policy-extension-independent-full-domain-verifier",
      version: 1,
      extends:
        "coincident-midpoint-common-frequency-root-sheet-and-receiver-phase-projection-verifiers.v1",
    ...
    verifierProtocolHash: sha256CoincidentMidpointCommonFrequencyInterval(rawVerifierProtocol),
    baseProtocolHash: sha256CoincidentMidpointCommonFrequencyInterval(rawBaseProtocol),
    status: {
      code: statusCode,
      score: null,
...
function compactTopology(result) {
  return {
    ...
    representativeRows: result.representativeResults.map((row) => ({
      ...
      foldLedgerHash: sha256CoincidentMidpointCommonFrequencyInterval(row.foldExclusion.ledger),
      anchorLedgerHash: sha256CoincidentMidpointCommonFrequencyInterval(row.anchorRootInventory.ledger),
    })),
  };
}

export function summarizeCoincidentMidpointCommonFrequencyHistoryPolicyExtensionIndependentVerifier(result) {
  if (!result ||
      result.schema !== COINCIDENT_MIDPOINT_COMMON_FREQUENCY_HISTORY_EXTENSION_INDEPENDENT_RESULT_SCHEMA) {
    throw new TypeError(
      `result must use schema ` +
      `${COINCIDENT_MIDPOINT_COMMON_FREQUENCY_HISTORY_EXTENSION_INDEPENDENT_RESULT_SCHEMA}.`,
    );
  }
  const summaryWithoutHash = {
    schema: COINCIDENT_MIDPOINT_COMMON_FREQUENCY_HISTORY_EXTENSION_INDEPENDENT_SUMMARY_SCHEMA,
    ...
    rawLedger: {
      ...
      location:
        ".local-data/braid-program/coincident-midpoint-common-frequency/" +
        "coincident-midpoint-common-frequency-history-policy-extension-independent-verifier.v1.json.gz",
    },
