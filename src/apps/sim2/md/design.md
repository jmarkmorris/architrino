...
- **Renderer**: Maps field values to RGB with a sim2-specific white zero-field background; positive and negative signed contributions tint away from white toward red or blue while overlays draw architrino markers, emitter markers, causal shells, history lines, and hit connectors.
