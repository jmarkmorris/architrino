import { createPdgeditTileReviewAppRuntime } from "../PdgeditTileReviewAppRuntime.js?v=2026-04-10-composite-label-tiles";
...
const runtime = createPdgeditTileReviewAppRuntime({
  ...
  labelGridElement: document.getElementById("pdgedit-review-label-grid"),
