const defaultComposerViewportDisplayState = Object.freeze({
...
export function createComposerViewportDisplayRuntime(options = {}) {
  const bindings = Array.isArray(options.bindings) ? options.bindings : [];
  const state = {
    ...defaultComposerViewportDisplayState,
