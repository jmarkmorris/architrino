export function createComposerAssemblyInspectorRuntime(options = {}) {
  ...
  function clearComposerAssemblyHoverTooltipState() {
  ...
  function updateComposerAssemblyHoverTooltip(assemblyId, event) {
    ...
    if (hoveredStructureTooltipAssemblyId !== assemblyId || !hoveredStructureTooltipContent) {
      ...
      hoveredStructureTooltipContent = createComposerAssemblyStructureTooltipContent(assembly);
  ...
  function renderComposerAssemblyEditor() {
    ...
    const composerAssemblyList = getAssemblyListElement();
    const composerAssemblyDetail = getAssemblyDetailElement();
