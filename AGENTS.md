...
- In operator/developer communication and authored markdown, avoid obscuring jargon or vague placeholder terms such as `shape`, `fixture`, `surface`, and similar stand-ins when a proper project term exists. Use the correct product or project terminology. If no project-specific term has been established yet, pause and ask the operator/developer before introducing new terminology.
