...
- Runtime payloads declared in [scripts/config/generated-runtime-assets.json](scripts/config/generated-runtime-assets.json) are ignored build outputs, not tracked generated documents. Local setup, tests, and Pages builds may prepare them with `node scripts/prepare-runtime-assets.mjs --write`; this command must not edit authored sources. Never force-add these payloads. The [machine-artifact retention policy](reference/op/machine-artifact-retention.md) owns file, collection, and branch growth limits.
