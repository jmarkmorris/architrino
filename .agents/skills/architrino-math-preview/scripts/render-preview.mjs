...
async function main() {
  ...
  if (values.help) {
    console.log("Usage: node .agents/skills/architrino-math-preview/scripts/render-preview.mjs --input FILE.md --output FILE.html [--section 'Exact heading'] [--title TITLE] [--theme purple|light] [--serve] [--port 0]");
    return;
  }
