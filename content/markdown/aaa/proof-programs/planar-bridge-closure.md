...
- [Nested Shell Braid Dynamics](../noether-braid/explored-braid-geometries.md#nested-shell-braid-dynamics): higher-dimensional geometric target that eventually inherits the planar bridge machinery.
