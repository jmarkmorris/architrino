...
1. The outer precessing binary of a Noether core defines the effective exclusion volume boundary; see [Nested Shell Swarm Geometry](../noether-swarm/nested-shell-swarm-geometry.md).
...
Terminology guardrail: $\xi$ is the Noether-core envelope shape ratio, inherited from [Nested Shell Swarm Geometry](../noether-swarm/nested-shell-swarm-geometry.md#canonical-geometry-variables). It is not defined as the clock-rate factor. In the homogeneous Lorentz-closure regime the proof target is
$$
