...
Native-confirmation claim level: seed-grade, small-drift evidence rather than full Lorentz closure. A release of the drifting rigid family confirms the ruler law in that regime: the relative flattening approaches $\xi(v)/\xi(0)\to1/\gamma_\star$ and agrees within about two parts in a thousand at $v=0.2\,c_\star$. The same release gives the cadence law $\omega(v)=\omega_0/\gamma_\star$ and a leg-difference simultaneity offset that is zero at rest and grows with drift in step with $v\gamma_\star^2$. Confirmation across the full drift range remains open because the moving assembly's axis orientation must then be maintained through the Noether sea response rather than by the isolated assembly alone.
