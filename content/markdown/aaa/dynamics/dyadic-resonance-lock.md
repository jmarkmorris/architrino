...
It should be read together with [Binary Dynamics](binary-dynamics.md), [Tri-Binary Dynamics](tri-binary-dynamics.md), [Mapping the Planck Scale](../philosophy-history/theory-bridges/planck-scale-tri-binary-alignment.md), and [Noether Core](../spacetime/noether-swarm.md), which provide the assembly geometry and scale-setting context for the lock relations derived here.
