...
It should be read together with [Binary Dynamics](binary-dynamics.md), [Dyadic Resonance Lock](dyadic-resonance-lock.md), [Mapping the Planck Scale](../philosophy-history/theory-bridges/planck-scale-tri-binary-alignment.md), [Noether Core](../spacetime/noether-swarm.md), and [Noether Core Geometry](../spacetime/noether-core-geometry.md), since those notes supply the binary precursor, lock structure, alignment target, assembly carrier, and exclusion-envelope geometry.
