...
2. **Inertia**: Matter moving through the Noether Sea experiences zero resistance (superfluidity) until a critical velocity or acceleration is reached (inertia/mass onset).


## Superfluid Noether Sea

* **Analogy:** The Noether Sea (composed of He-like coupled binaries) behaves as a superfluid.
* **Inertia:** Matter moves without resistance until a critical velocity (related to $c_f$) or acceleration is applied.

For the dynamical side of the transport threshold picture, see [Energy](../dynamics/energy.md) and [Tri-Binary Dynamics](../dynamics/tri-binary-dynamics.md).
