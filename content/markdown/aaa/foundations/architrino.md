...
This chapter stops before the force law. Exact causal wake surfaces, density representations, causal emission-time roots, Jacobian weights, inverse-square kernels, and regularization belong in [Master Equation](../dynamics/master-equation.md).
...
The complete path history of an architrino matters to its identity ledger. The law that converts path history into acceleration belongs in [Master Equation](../dynamics/master-equation.md).
...
- [Tri-Binary Dynamics](../dynamics/tri-binary-dynamics.md) for coupled three-binary speed regimes, alignment behavior, and assembly-stability mechanisms.
- [Noether Core](../spacetime/noether-core.md) for the assembly-level Noether-core architecture built from those dynamics.

## Determinism and Multistability

$\mathbb{A}\mathbb{A}\mathbb{A}$ is deterministic in its laws. Given the complete architrino identity set, positions, velocities, polarities, and relevant path-history ledger on a slice, subsequent evolution is fixed by the dynamical law stated in [Master Equation](../dynamics/master-equation.md).
