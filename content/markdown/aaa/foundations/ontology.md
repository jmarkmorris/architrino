...
$$
T_\parallel(v)=\frac{2L_0}{c_f}\frac{C(v)}{1-\beta^2},\qquad
T_\perp(v)=\frac{2L_0}{c_f}\frac{1}{\sqrt{1-\beta^2}}.
$$
Imposing operational isotropy ($T_\parallel=T_\perp$) yields
$$
