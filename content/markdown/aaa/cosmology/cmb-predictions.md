...
- The Euclidean void is fixed; CMB evolution is a medium-history statement inside that fixed substrate.
- Standard spectral observables are retained; only ontology and mechanism language changes.
