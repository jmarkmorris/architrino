...
The receiver cannot intrinsically distinguish between the attractive pull of an opposite charge and the repulsive push of a like charge located on the diametrically opposite side of the line of action. Furthermore, because the local potential is a dense superposition of hits from countless Noether Sea cores, the exact origin and path-history of any single perturbation is irretrievable. 
