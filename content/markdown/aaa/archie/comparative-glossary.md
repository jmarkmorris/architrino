...
| Axial Layer | No direct standard term; roughly analogous to an internal electroweak-structure layer of a composite model. | The six-site organization formed by the six axial architrinos on a fermion assembly. Use as the canonical replacement for the older `personality layer` wording. |
| Axial Pattern | No direct standard equivalent; closest would be an internal constituent arrangement governing effective quantum numbers. | The sign/layout arrangement of the six axial architrinos across the three core axes. It is the preferred term for what older notes often called a `personality pattern`. |
| Axial Inventory | No direct standard equivalent beyond constituent bookkeeping. | The count/composition of axial architrinos in a given assembly or branch. Use for ledger and catalog language where older notes referred to `personality counts` or `personality inventory`. |
...
| personality charge / personality architrino | older fermion-decoration wording | axial architrino | Phase out the older anthropomorphic terminology in canonical textbook-facing prose. |
| personality layer / personality pattern / personality frame | older fermion-decoration wording | axial layer / axial pattern / axial frame | Use `axial` for the system-level organization and `polar` for the specific site geometry. |
