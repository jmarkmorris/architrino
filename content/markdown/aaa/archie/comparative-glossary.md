...
| Axial Layer | No direct standard term; roughly analogous to an internal electroweak-structure layer of a composite model. | The six-site organization formed by the six axial architrinos on a fermion assembly. Use as the canonical system-level term for fermion decoration. |
...
| axial layer / axial pattern / axial frame | older fermion-decoration wording | axial layer / axial pattern / axial frame | Use `axial` for the system-level organization and `polar` for the specific site geometry. |
