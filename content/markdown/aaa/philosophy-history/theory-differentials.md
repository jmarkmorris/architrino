...
- Do not praise a theory merely because it is mainstream; state what layer it actually occupies.
- Distinguish clearly between:
  - predictive success,
  - ontological correctness,
  - computational convenience,
  - historical influence.
- Prefer explicit layer language:
  - **fundamental**
  - **assembly-level**
  - **effective**
  - **bulk statistical**
...
- what ontological work it attempted to do,
- whether it belongs above or below $\mathbb{A}\mathbb{A}\mathbb{A}$,
- what survives if $\mathbb{A}\mathbb{A}\mathbb{A}$ is correct,
- and whether the theory is a foundation, an effective summary, a transition tool, or a historical dead end.
