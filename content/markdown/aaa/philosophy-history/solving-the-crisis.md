...
**Problem detail.** Perturbative quantization of the Einstein-Hilbert metric action produces loop divergences that cannot be absorbed into its original finite set of couplings. This is narrower than saying that every modified gravitational action has the same power-counting problem. Higher-derivative or quadratic-curvature actions can improve perturbative power counting, but then they must answer ghost, unitarity, and ontology questions raised by their extra modes. A UV-complete theory is required to describe the quantum behavior of spacetime, particularly at singularities (Big Bang, black holes). String theory and loop quantum gravity are prominent candidates, but they differ fundamentally on background independence and the nature of dimensionality. The low-energy effective-field-theory treatment of GR is already predictive at long distance; the unresolved problem is ultraviolet completion and microscopic ontology, not a blanket failure of GR and quantum theory to speak to one another. The lack of experimental data at Planckian energies makes it difficult to falsify these theories or check consistency conditions (like the Swampland conjectures) that conjecturally distinguish ultraviolet-compatible effective theories.

**Where it appears.** Quantizing the Einstein-Hilbert action as a standard field theory leads to non-renormalizable divergences, so the ordinary low-energy expansion requires higher-order effective operators. This does not rule out a nonperturbative ultraviolet completion. Black hole thermodynamics and entropy hint that spacetime has microscopic degrees of freedom, but their nature is unknown. Higher-derivative completions change the divergence bookkeeping but must still justify their additional mode content rather than merely shifting the problem. String theory supplies controlled ultraviolet constructions and holographic examples, with extra dimensions in standard formulations, while loop quantum gravity seeks a background-independent quantization of geometry; asymptotic safety and emergent gravity are additional routes. Potential observational windows include quantum corrections to black hole spectra, Lorentz-violation tests, or subtle signatures in primordial cosmology and gravitational waves.

**Core non-closure.** The ordinary perturbative Einstein-Hilbert expansion does not itself supply ultraviolet completion, and canonical gravity tends to obscure the role of time. Higher-derivative completions can improve power counting, but then must answer ghost, unitarity, and ontology questions. String theory, loop quantum gravity, asymptotic safety, causal-set programs, and holographic programs each supply comparison structures, but no candidate has produced decisive empirical separation.
...
**$\mathbb{A}\mathbb{A}\mathbb{A}$ architecture.** Spacetime enters as an observer-level accounting structure. Proper time, distance, curvature, and null propagation are to be recovered from moving assemblies, clock/ruler retuning, causal-delay structure, and Noether sea response. The inversion is direct: the Euclidean void and absolute time belong to the ontology, while the effective metric belongs to the organized limit seen by physical observers.
...
**$\mathbb{A}\mathbb{A}\mathbb{A}$ architecture.** The ontology separates ordering from experienced time. Absolute time orders updates in the Euclidean void, while observer proper time is to be recovered as a clock variable of assemblies embedded in the Noether sea. Absolute ordering permits ordered records; a derived clock response must explain their disagreements and agreement with relativistic tests.
...
**$\mathbb{A}\mathbb{A}\mathbb{A}$ architecture.** Trans-Planckian censorship is a comparison conjecture; deriving an assembly cutoff need not establish it. Sub-assembly excitations should not become arbitrary classical modes if Noether braid structure imposes a minimum curvature radius and derived phase-coherence constraints. A useful swampland analogue would be an allowed-effective-theory region derived from assembly consistency, not imported as string ontology.

**Detailed architecture route.** In $\mathbb{A}\mathbb{A}\mathbb{A}$, trans-Planckian censorship is a comparison conjecture; deriving an assembly cutoff need not establish it. The proposal is that sub-assembly excitations cannot be promoted into arbitrary classical modes because Noether braid structure imposes a minimum curvature radius and derived phase-coherence constraints. The "swampland" analogy is therefore useful only if the allowed effective descriptions can be derived from assembly-consistency conditions rather than asserted from analogy with string-theory bounds. A derived cutoff model fails if its forward predictions cannot reproduce the primordial record within its declared assumptions. Observations do not uniquely require trans-Planckian mode stretching without an inflationary reconstruction.

**Resolution tests.** Test the predictions of a declared cutoff and inflationary reconstruction; a contradiction falsifies that model, not every possible ultraviolet completion. A successful derivation would recover the allowed effective window from native assembly and Noether sea conditions.
...
**Core non-closure.** Under stated causal and energy assumptions, classical singularity theorems establish geodesic incompleteness. Familiar black-hole solutions also have divergent curvature, but incompleteness need not entail curvature blowup. The question is whether this marks a real physical endpoint or a failure of the effective metric description.

**$\mathbb{A}\mathbb{A}\mathbb{A}$ architecture.** Singularities are treated as failures of the effective metric description, not as substrate endpoints. Strong-field collapse must be expressed through Noether braid dynamics, terminal alignment, causal-delay ledgers, topology changes, medium loading, and release channels. The endpoint is a boundary-condition and continuation problem in native variables. Euclidean space and absolute time alone do not establish existence, uniqueness, bounded acceleration, or continuation of delayed trajectories.
...
**Core non-closure.** Standard cosmology extrapolates to an early hot dense state, but extrapolated singular boundaries and low-entropy initial conditions remain unresolved. Creation from nothing is an additional interpretation, not a consequence of the hot Big Bang model.

**$\mathbb{A}\mathbb{A}\mathbb{A}$ architecture.** The route avoids treating the Big Bang as creation from nothing. It proposes the early hot state as a high-density transition in the Noether sea and assembly ledger: redshift, thermalization, expansion-like observer variables, and early structure emerge from a substrate state change rather than an absolute beginning of spacetime.
...
**Core non-closure.** Weak cosmic censorship concerns naked singularities visible from infinity; strong cosmic censorship concerns inextendibility of generic maximal Cauchy developments in a specified regularity class. Cauchy horizons, rather than event horizons in general, threaten uniqueness of continuation.
...
**Problem detail.** According to Hawking's semiclassical analysis, black holes radiate thermally and evaporate, seemingly destroying the quantum information of the matter that formed them. A pure initial state evolving to a genuinely mixed complete final state would violate unitarity. Probability preservation alone is weaker than unitarity. Recent theoretical breakthroughs involving the "island proposal" and the calculation of the Page curve using holographic entanglement entropy suggest information is conserved. However, the exact mechanism by which information is encoded in the Hawking radiation, and how this relates to the smooth structure of the event horizon (firewall paradox), remains a debated frontier.

**Where it appears.** Hawking's calculation treats matter collapse and evaporation semiclassically, producing thermal radiation that appears independent of the initial state. If complete evaporation leaves only exactly thermal radiation with no purifying correlations or other degrees of freedom, a pure initial state has a mixed complete final state; if information escapes, one must explain how it is encoded without violating locality or the equivalence principle. In controlled holographic models and specified semiclassical gravitational path-integral settings, AdS/CFT and replica-wormhole calculations reproduce Page-curve behavior, suggesting information recovery, but the microscopic mechanism remains debated (soft hair, islands, or nonlocality). The paradox is sharpened by the firewall argument, which forces a choice between unitarity, smooth horizons, or effective field theory near the horizon.
...
**Problem detail.** In standard cosmological fits, approximately 27% of the present total energy density is assigned to a predominantly non-baryonic dark-matter component. This is a model-dependent gravitational inference, not a direct inventory or proof of exactly zero electromagnetic coupling. The "WIMP miracle," which motivates thermal weakly interacting massive relics, including but not restricted to supersymmetric candidates, has been the leading paradigm, and direct detection experiments such as LZ and XENONnT have not yet identified a decisive particle signal. The focus is broadening to a wider mass range and interaction spectrum, including ultralight axions, sterile neutrinos, macroscopic Primordial Black Holes, or complex "dark sectors" with their own gauge forces. The challenge is to distinguish particle, compact-object, modified-gravity, and combined explanations across the same data.

**Where it appears.** The case for dark matter comes from galaxy rotation curves, cluster dynamics, gravitational lensing (including the Bullet Cluster offset of lensing-inferred mass from the dominant X-ray-emitting gas), and the acoustic peak structure in the CMB. Successful standard cosmological structure simulations use a predominantly cold component; known Standard Model particles do not supply the full inferred abundance with its required behavior. Theoretical candidates span thermal relics (WIMPs), non-thermal axions, sterile neutrinos, and primordial black holes, each with distinct predictions for small-scale structure and astrophysical signatures. Direct detection, indirect searches, and collider probes continue to exclude large regions of parameter space, widening the gap between the gravitational evidence and particle-physics identification.
...
**Unresolved residue.** Within the standard cosmological reconstruction, the unresolved point is not whether acceleration is inferred, but why the inferred component has its observed magnitude and near-$w=-1$ behavior without a persuasive microphysical account.
...
**Resolution tests.** Use supernova light-curve time dilation, BAO, CMB distance priors, cosmic chronometers, weak lensing, growth data, supernova directionality, BAO anisotropy, and CMB/matter dipole consistency. The architecture must reproduce the DESI DR2 and DES Y6 likelihood surfaces with one shared physical transfer model and calibrated survey-specific response and nuisance parameters, rather than fitting only a headline $w_0$-$w_a$ contour. It must preserve the successful distance ladder while offering discriminating residuals.
...
**Problem detail.** This is a radiative-stability and scale-separation problem. A naive zero-point integral cut off at the Planck scale gives a vacuum-density estimate of order $10^{120}$ times the inferred dark-energy density. That regulator-dependent estimate is not a renormalized QFT prediction for the observed cosmological constant. The difficulty is explaining its small renormalized value in the presence of large threshold contributions without unexplained cancellations. Landscape selection and modified gravitational responses are proposals; unimodular gravity does not by itself establish radiative stability.

**Where it appears.** Vacuum contributions and their counterterms enter the effective gravitational coupling, while the measured late-time curvature constrains the renormalized total. Estimates sometimes expressed as cancellations of 1 part in $10^{60}$ to $10^{120}$ depend on the assumed cutoff and field content; they are illustrative hierarchies, not universal measured factors. Exact unbroken supersymmetry can cancel contributions in appropriate settings, but supersymmetry has not been observed; if present and broken, its residual vacuum contribution still requires explanation. Sequestering, landscape selection, and modified gravity remain candidate responses.

**Core non-closure.** Field-theoretic zero-point estimates overshoot the observed dark-energy scale by an enormous factor. The unresolved issue is why the renormalized gravitational vacuum contribution is small and radiatively stable, and why the large-scale curvature source is tiny but nonzero instead of naturally huge or exactly absent.
...
**Detailed architecture route.** A possible $\mathbb{A}\mathbb{A}\mathbb{A}$ reframing treats the cosmological constant problem as a mismatch between QFT zero-point bookkeeping and the actual degrees of freedom available in the Noether sea. Space is not an empty stage in this ontology; the relevant question is how Noether braid assemblies in the Noether sea store, shield, recycle, and expose energy at the effective metric level. Absolute time, global polarity balance, and wake propagation at $c_f$ may constrain how vacuum-like contributions enter the exposed assembly envelope, but neither polarity balance nor a propagation speed alone entails energy cancellation, and this is not yet a completed solution. The vacuum-exposure mismatch becomes a quantitative shielding target: the theory must show whether the indexed binary structure of a retained branch can suppress the effective large-scale energy density by the factor required by its independently derived unscreened contribution while preserving successful low-energy field calculations. It must also supply an exposure rule for the slow sector, so that shielding does not erase the observed late-time stress signal.
...
**Secure record.** Suitable inflationary models explain the horizon and flatness problems and organize the nearly scale-invariant, nearly Gaussian CMB perturbation spectrum. Tensor bounds, scalar tilt, non-Gaussianity constraints, and reheating uncertainty all remain informative.

Current physics already gets something important right here: the survey pipeline, background expansion fits, lensing structure, and large-scale inference machinery are strong enough to isolate a genuine residual problem rather than a purely speculative gap.

**Problem detail.** While suitable inflationary models address the horizon and flatness problems, the particle physics identity of the "inflaton" field is unknown. We lack a definitive model for the shape of the potential $V(\phi)$, the energy scale of inflation, and the reheating process that transferred energy from the inflaton to the Standard Model plasma. Furthermore, the detection of primordial B-mode polarization in the CMB—a "smoking gun" for gravitational waves generated during inflation—remains elusive. These would be valuable discriminants, although tensor modes have other possible sources and scalar tilt, running, and consistency tests already distinguish some models. Current data do not uniquely select a mechanism.
...
**Resolution tests.** Use CMB acoustic peaks, scalar spectral index, non-Gaussianity, tensor bounds, spatial curvature, reheating constraints, and large-angle anomalies. Recovering those data would make the native early-state model a viable competitor; refuting a particular inflationary model additionally requires a discriminating contradiction.
...
**Problem detail.** Standard Big Bang Nucleosynthesis (BBN) predicts the abundance of primordial Lithium-7 to be roughly three times higher than the surface abundance observed in metal-poor Population II halo stars (the Spite plateau). Inferring the primordial abundance from those surfaces requires a stellar-depletion model. While BBN is highly successful for Hydrogen and Helium, the Lithium mismatch persists despite decades of study. It suggests either unknown stellar astrophysics (turbulent mixing depleting Lithium), inaccurate nuclear cross-sections, or non-standard particle physics in the early universe, such as decaying dark matter particles injecting neutrons that destroy Lithium.
...
**Standard repairs.** Stellar mixing and diffusion, revised nuclear cross sections, decaying-particle injections, and inhomogeneous nucleosynthesis scenarios face different constraints: exotic nuclear injections often disturb deuterium, while stellar mixing and diffusion must explain the plateau and other stellar abundance records. These are not uniformly excluded mechanisms.
...
**Detailed architecture route.** In $\mathbb{A}\mathbb{A}\mathbb{A}$, the measurement problem is treated as a physical transition from a prepared assembly regime whose observer-level compression supports coherent superposition to a stable apparatus record in the Noether sea. For a durable macroscopic record, the proposal seeks an effectively irreversible coupling of the prepared assembly and its effective state description to a dense, many-assembly environment that can select a stable attractor through self-hit dynamics and retained history. Microscopic irreversibility does not follow from delayed history or environmental coupling alone, and reversible premeasurement interactions remain part of the benchmark. The route proposes that outcome selection occurs at the level of assembly attractor basins, where **meta-stable branching** reflects deterministic multistability under microstate and wake-phase sensitivity. The first-stage obligation is to derive the attractor threshold and coherence-time scaling from a declared apparatus, environment, and preparation family. Only then does persistence of the interference record beyond that registered threshold falsify the proposed basin-selection account.
...
**$\mathbb{A}\mathbb{A}\mathbb{A}$ architecture.** The route is not a naive local hidden-variable model. It uses pair provenance, path-history correlation, detector basins, source measures, and no-signaling constraints. Born weights must be derived from preparation-dependent measures and calibrated basin response; invariance or metastability alone does not select the required weights. The provisionally selected Bell route allows live coupled-apparatus response mediated at $c_f>c_0$, outside the effective photon cone. Pair provenance alone does not evade Bell factorization, and the finite-speed multipartite obstruction remains open. Bell closure additionally requires the observer-level joint law to remain nonfactorizable,
$$
...
for some tested contexts on a set of nonzero preparation measure, where $\lambda$ is a complete pre-setting hidden state and admitted boundary history, with one setting-independent preparation measure. The record must not include later settings or outcomes under the same measurement-independence claim. Nonfactorization must survive completion of the model, not merely omission of hidden variables. Operational marginals must remain independent of the remote setting relative to the effective photon cone at $c_0$, a stronger condition than forbidding signals faster than $c_f$. A shared preparation is not sufficient if it merely screens the two apparatus responses into independent local laws.
...
**$\mathbb{A}\mathbb{A}\mathbb{A}$ architecture.** Entropy is a basin-count, record-growth, and coarse-graining object over assembly dynamics. Absolute ordering, path-history accumulation, Noether sea updates, wake-phase memory, and stable record formation are ingredients of a proposed arrow mechanism; ordering alone does not imply entropy increase. A finite subsystem admits ordinary thermodynamic entropy only after a measure, coarse-graining, and access window have been declared.

**Detailed architecture route.** The $\mathbb{A}\mathbb{A}\mathbb{A}$ arrow-of-time proposal starts from absolute time, then seeks the thermodynamic arrow in Noether sea history, wake-phase memory, and effective self-hit dissipation. The candidate mechanism is that macroscopic reversal would require reconstructing micro-wake phases and assembly histories with inaccessible precision after dissipation has dispersed them. The "Past Hypothesis" would be replaced only if the theory can derive an initially low-entropy preparation with a justified measure and coarse-graining, and explain its subsequent evolution. A low-defect assembly configuration is not automatically low entropy, nor does increasing defect count prove entropy growth. A falsifier would be a measured reversal frequency incompatible with a derived finite-window probability bound; rare fluctuations or recurrences alone do not contradict statistical irreversibility.

**Resolution tests.** Use fluctuation-dissipation, Brownian motion, thermalization, blackbody radiation, irreversible detector records, and cosmological entropy accounting. Compare reversal frequencies with a derived finite-window probability bound, accounting for fluctuations and recurrences.
...
**Secure record.** Planck's law resolves the historical blackbody divergence, and quantum theory accurately models thermal radiation. The modern lesson is not that blackbody physics remains unsolved, but that classical equipartition fails for high-frequency thermal mode occupation.
...
**Unresolved residue.** The unresolved residue is no longer the historical blackbody spectrum itself, but the general lesson about why classical thermal occupation fails and how microscopic dynamics recover the high-frequency spectrum.
...
**$\mathbb{A}\mathbb{A}\mathbb{A}$ architecture.** The UV catastrophe excludes unrestricted classical equipartition, not continuum mode counting by itself; Planck theory retains the electromagnetic mode density. Noether braid assemblies should impose a geometric cutoff at the maximal-curvature scale, with high-frequency excitations mapping to finite maximal-curvature binary configurations rather than arbitrarily small wavelengths.

**Detailed architecture route.** The $\mathbb{A}\mathbb{A}\mathbb{A}$ closure path treats the UV catastrophe as a thermal-occupation recovery benchmark, not proof that continuum mode counting is intrinsically invalid. Noether braid assemblies would have to impose a geometric cutoff at the minimum curvature radius $R_{\text{minlimit}}$, with high-frequency excitations mapping to finite maximal-curvature binary configurations rather than arbitrarily small wavelengths. A finite cavity still has infinitely many modes, and even a finite mode count does not fix their thermal weights. This remains a derivation target: the theory must recover the Planck spectrum and show why finite-mode geometry supplies the correct saturation without becoming a post hoc quantization rule.
...
**Problem detail.** The mass of the Higgs boson (125 GeV) is orders of magnitude lighter than the Planck scale ($10^{19}$ GeV). Because scalar masses in the Standard Model are quadratically sensitive to high-energy quantum corrections, a high-scale completion with heavy coupled thresholds creates a sensitivity problem unless its dynamics protect the weak scale. The absence of detected "stabilizing" physics in searched LHC channels—such as Supersymmetric partners (top squarks) or Composite Higgs resonances—suggests that the electroweak scale is technically unnatural. This motivates physicists to reconsider the principle of naturalness or investigate relaxion mechanisms and cosmological selection effects.

**Where it appears.** The Higgs mass receives loop corrections from every heavy particle it couples to, with the top contribution large within the Standard Model. In a theory valid up to a high cutoff, the corresponding mass-squared corrections can be much larger than the squared weak scale unless there is a symmetry or partner spectrum to stabilize them. Naturalness motivated predictions for top partners, SUSY, or composite Higgs states at the TeV scale, yet LHC searches have not found them. Possible responses include tuning, new protection structures such as neutral naturalness, lower ultraviolet thresholds, or environmental selection; current null results do not choose among them.
...
**Problem detail.** Oscillation experiments confirm neutrinos have mass, contradicting the original Standard Model. It is unknown whether they are Dirac fermions (distinct particle/antiparticle) or Majorana fermions (own antiparticle). The Majorana hypothesis allows for the See-Saw Mechanism, linking light neutrino masses to additional states whose masses and experimental accessibility are model-dependent, and is testable via neutrinoless double-beta decay ($0\nu\beta\beta$). Furthermore, the absolute mass scale and the ordering of the mass eigenstates (normal vs. inverted hierarchy), for which global-fit preferences remain dataset-dependent, are critical unknowns that affect both particle physics models and the formation of large-scale structure in the cosmos.

**Where it appears.** Neutrino oscillation experiments (solar, atmospheric, reactor, accelerator) measure mass splittings and mixing angles, but not the absolute mass scale or the Majorana/Dirac nature. KATRIN bounds the effective electron-neutrino mass, while cosmological data constrain the sum of masses via structure suppression. An established neutrinoless double-beta decay would signal lepton-number violation and, under the standard field-theoretic assumptions, a Majorana mass contribution. It would not alone identify the dominant exchange mechanism or establish leptogenesis. Long-baseline experiments (DUNE, Hyper-K) aim to resolve mass ordering and possible CP violation in the lepton sector.
...
**Detailed architecture route.** In $\mathbb{A}\mathbb{A}\mathbb{A}$, neutrinos are currently treated as near-photon neutral polarity-conjugate Noether braid pairings, not as ordinary charged-fermion axial-layer assemblies. On that candidate mapping, their small observer-facing mass would be the residual exposed response of an almost locked neutral pair. Oscillation would be represented as changing weak-channel exposure of internal phase and energy modes, not as a stable six-site axial inventory flipping among charged-fermion configurations. The current architecture therefore keeps the Dirac/Majorana question open at the empirical gate: a confirmed neutrinoless double-beta signal would require a lepton-number-violating neutral-pair provenance channel, while null results tighten that channel without proving the current Dirac-like geometry. A sterile or right-handed branch remains optional rather than part of the minimal architecture.
...
**Resolution standard.** Resolution would require a consistent account of the mass scale and ordering together with decisive evidence about the Majorana or Dirac nature, with neutrinoless double-beta decay testing lepton-number violation and cosmology or direct kinematics constraining mass combinations. Mass measurements alone do not establish Dirac or Majorana character. The same resolution should state how $\sum_i m_i$, the lightest-neutrino mass, and any sterile-branch evidence enter any independently justified near-photon effective evolution law without separate flavor-specific fitting.
...
**Problem detail.** A hot Big Bang model does not by itself require zero initial baryon asymmetry. Generating the observed asymmetry dynamically from a symmetric initial state under the usual CPT-invariant framework requires the Sakharov ingredients: baryon-number violation, C and CP violation, and departure from thermal equilibrium. The Standard Model's CP violation (in the CKM matrix) is insufficient to explain the observed baryon-to-photon ratio. In such baryogenesis scenarios, additional effective CP violation is required, potentially linked to the neutrino sector (leptogenesis) or electroweak symmetry breaking, but the specific mechanism remains undiscovered.
...
**$\mathbb{A}\mathbb{A}\mathbb{A}$ architecture.** The route is event provenance, branch chirality, weak-sector asymmetry, early-state boundary conditions, and reaction-ledger bias. Matter dominance should be treated as a Noether sea chiral-bias closure target, not as a primitive shortage of one architrino polarity. The proposed early-environment selection must be derived without contradicting the measured longevity and CPT constraints on ordinary matter and antimatter; present-day antimatter is not generically unstable.

**Detailed architecture route.** A cautious $\mathbb{A}\mathbb{A}\mathbb{A}$ route treats baryon asymmetry as a Noether sea chiral-bias closure target. The required mechanism would be an orientation-dependent difference in how pro-aligned and anti-aligned Noether braid assemblies couple to the ambient Noether sea state, not a primitive shortage of one architrino polarity. An early-environment bias would have to distinguish assembly production or survival rates while recovering present-day matter–antimatter lifetime constraints and the finite free-neutron lifetime. Such a mechanism could supply the effective baryon-number bias required by Sakharov's conditions only if it quantitatively reproduces the baryon-to-photon ratio and remains compatible with CP-violation, neutrino, and electric-dipole-moment bounds. If the current coaxial contra-rotating polarity-conjugate planar-pair photon candidate closes, its polarity ledger will further constrain whether radiation can mediate net polarity leakage between clusters; that candidate geometry is not a premise of the asymmetry mechanism.
...
**Problem detail.** QCD permits a CP-violating topological term. In a conventional quark-mass convention the physical combination is $\bar\theta=\theta_{\rm QCD}+\arg\det M_q$, not the bare angle alone. Neutron electric-dipole-moment bounds imply an approximate $|\bar\theta|\lesssim10^{-10}$ constraint when interpreted through the corresponding hadronic matrix elements. The Peccei–Quinn mechanism is a prominent candidate explanation that dynamically relaxes this combination and predicts an axion, which can also supply dark matter in suitable cosmological histories.

**Where it appears.** The QCD Lagrangian allows a CP-violating $\theta$ term; unless the physical combination $\bar\theta$ is small, it induces a neutron electric dipole moment far above experimental limits. The Peccei-Quinn mechanism makes the physical effective angle dynamical, predicting the axion whose mass and couplings are constrained by astrophysical cooling and laboratory searches. Lattice quark-mass determinations disfavor the massless-up-quark proposal. Spontaneous-CP constructions remain distinct, constrained alternatives whose radiative corrections must be controlled; an axion is not the only logically available explanation.

**Core non-closure.** The unresolved issue is why a parameter permitted by the theory is constrained to be very small. Peccei-Quinn symmetry and axions offer the leading repair, but the axion has not been decisively found, and alternatives are tightly constrained.

**Unresolved residue.** The unresolved issue is why a parameter permitted by the theory is constrained to be very small. Without a mechanism, the near-vanishing of the neutron electric dipole moment looks like unexplained tuning.

**Standard repairs.** Standard repairs include the Peccei-Quinn mechanism and its axion consequence, along with alternatives such as spontaneous CP structure, while a massless up quark is strongly disfavored. The problem remains open because the axion has not been decisively found and the alternatives are increasingly constrained.
...
**Detailed architecture route.** A candidate $\mathbb{A}\mathbb{A}\mathbb{A}$ account treats the smallness of the physical CP-violating angle $\bar\theta$ as a possible assembly-stability selection effect rather than as a free coincidence. On this reading, a non-zero neutron electric dipole moment would correspond to an asymmetric axial-charge distribution relative to the Noether braid rotation structure, and sufficiently large asymmetry could destabilize the assembly through torque, Noether sea coupling, or self-hit imbalance. This remains a derivation target. The theory must compute the allowed asymmetry, recover the electric-dipole-moment bounds and finite free-neutron lifetime, distinguish intrinsic CP violation from environmental polarization, and show whether any Peccei-Quinn-like effective behavior emerges from assembly relaxation rather than from a new fundamental axion field.
...
**Problem detail.** Grand Unified Theories (GUTs) that unify strong and electroweak forces generally predict baryon number violation, leading to proton decay. The stability of the proton is a key constraint on high-energy physics. Mode-specific Super-Kamiokande partial-lifetime limits reach beyond $10^{34}$ years; these exclude simple minimal SU(5) predictions in their stated parameter ranges, not every unification model. The observation of a baryon-number-violating proton channel would establish new baryon-violating physics, without uniquely establishing unification or its energy scale, while its continued absence forces GUT models into more complex, fine-tuned territories or higher-dimensional representations.

**Where it appears.** Many GUTs predict proton decay through heavy gauge boson exchange or dimension-5 operators in SUSY GUTs, leading to specific decay modes and lifetimes. Experimental limits from Super-Kamiokande already exclude minimal SU(5) and place strong bounds on supersymmetric unification. Hyper-K and DUNE target improved, mode-dependent sensitivity; translating lifetime bounds into scales near $10^{15}$-$10^{16}$ GeV requires a declared operator, coupling, and flavor model. The absence of decay forces model builders toward more complex symmetry breaking or protective mechanisms, weakening the simplicity of unification.
...
**Problem detail.** Given the measured masses of the Higgs boson and the top quark, the Standard Model effective potential appears to turn over and become negative at ultra-high energies ($\sim 10^{11}$ GeV). Within that Standard Model extrapolation and its input scheme, this favors a metastable electroweak vacuum; it is not a measurement of the actual ultraviolet potential. While the tunneling lifetime to the true vacuum is calculated to be longer than the age of the universe, this metastability is highly sensitive to the precise top quark mass and new physics. The existential implication is that a bubble of true vacuum could theoretically nucleate and expand at the speed of light, altering the laws of physics.

**Where it appears.** For commonly used central inputs and a Standard Model extrapolation without new thresholds, renormalization-group running can drive the Higgs quartic coupling negative. The boundary between stability and metastability is highly sensitive to the top quark mass and strong coupling, which are measured with finite uncertainties; converting a reconstructed top-mass parameter to a short-distance mass adds theoretical uncertainty. Early-universe inflation and reheating could have pushed the Higgs field into the unstable region unless new physics stabilizes the potential. This makes vacuum stability a precise probe of physics above the weak scale and motivates searches for stabilizing dynamics.
...
**Detailed architecture route.** The $\mathbb{A}\mathbb{A}\mathbb{A}$ candidate interpretation is that "vacuum instability" may reflect extrapolation of a continuum Higgs potential beyond its domain. The required mechanism is a derived microphysical cutoff and bounded assembly energy density; neither is established by a braid-taxonomy label. On this unproved interpretation, what appears as a negative high-energy potential in the EFT could instead mark a phase-transition boundary between retained assembly configurations. One proposed suppression route excludes dynamically accessible lower-energy phases or coherent rethreading across persistent support indices in a declared regime. Absence of a lower phase is not necessary for suppression: a derived barrier can make a transition sufficiently slow. A measured decay rate or Higgs-field fluctuation inconsistent with that declared accessibility and rate law would reject the particular model, not every bounded-cutoff architecture.

**Resolution tests.** Compare any metastable transition or Higgs-field fluctuation with the particular derived accessibility, barrier, and rate law; a transition alone does not falsify every bounded-cutoff model. A successful account would derive the cutoff and reproduce the measured Higgs/top constraints.
...
**Detailed architecture route.** A cautious $\mathbb{A}\mathbb{A}\mathbb{A}$ reading treats lepton magnetic moments and universality anomalies as a scale-sensitive medium-coupling closure target, not as established evidence for Noether sea microstructure. The electron, muon, and tau have different assembly scales and shielding patterns, so a completed model could in principle produce distinct residual couplings to Noether sea density, strain, and causal-wake history. That possibility must be derived as a correction to the effective QED and flavor ledger, not inferred from a literal spatial discretization. Convergence of the anomaly data and hadronic/flavor calculations to the Standard Model expectation would reject a predicted nonzero residual beyond the resulting bound, while preserving the recovery target. A falsifier of a particular response law would be a required correction whose sign, scale, or channel dependence cannot be produced by the same Noether sea response record used elsewhere.

**Resolution tests.** A predicted nonzero anomalous correction fails if data converge to the Standard Model with an uncertainty excluding it. The shared recovery route fails if a required correction has a sign, scale, or channel dependence that cannot be produced by the same Noether sea response record used elsewhere.
...
**Problem detail.** The Clay Millennium problem asks for the construction of four-dimensional quantum Yang–Mills theory with a positive mass gap. Pure Yang–Mills has no dynamical quarks; its glueball spectrum must be distinguished from full QCD, whose lightest hadrons include pions. Confinement, chiral dynamics, and hadron mass generation are related nonperturbative questions, but neither the absence of isolated color charge nor a numerical glueball spectrum alone proves the existence-and-gap theorem. Full QCD already has quantitative lattice calculations of hadron structure; the remaining burden includes mathematical control and deeper dynamical explanation.

**Where it appears.** QCD is asymptotically free and has no observed free asymptotic colored particles. Pure-gauge lattice calculations exhibit a long-distance static-source tension and a gapped glueball spectrum. In full QCD, dynamical quark-pair creation can break the static string into color-neutral hadrons, so an indefinitely linear potential is not the full theory's large-distance prediction. Most nucleon mass arises from nonperturbative quark and gluon dynamics rather than the sum of light current-quark masses; this includes more than a simple classical binding-energy contribution.
...
**$\mathbb{A}\mathbb{A}\mathbb{A}$ architecture.** Confinement is routed to branch topology, color exposure, allowed assemblies, energy ledgers, and residual-routing constraints. Quark-like decorations are candidate partial braid subassemblies that would exist as shared boundary conditions inside larger assemblies; no taxonomy member is assigned. Separating them should stretch a derived alignment-response channel and generate a restoring tension. A mass-gap claim would require a strictly positive lower bound over all allowed nonvacuum excitations in the declared pure-gauge effective sector, not just the energy of one stable loop.

**Detailed architecture route.** The candidate confinement mechanism is an assembly constraint: quark-like decorations would be partial braid subassemblies that exist only as shared boundary conditions within a larger assembly, so separation would stretch a branch-derived alignment-response channel and generate an approximately linear restoring tension in its declared regime, with string breaking when dynamical quark channels are present. A positive loop energy alone does not prove a gap: the infimum over every admissible nonvacuum excitation must remain positive in the required continuum and infinite-volume limits. This is an unproved assembly-geometry route, not a consequence of coincident-midpoint orthogonal-axis braid coordinates. A falsifier would be a confirmed observation of free, asymptotic color charge or a glueball spectrum with no finite gap in the pure-gauge limit.
