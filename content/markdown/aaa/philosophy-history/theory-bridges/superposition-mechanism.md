...
*   **Basis States ($|n\rangle$)**: Distinct, dynamically stable attractor basins of the nested shell swarm assembly. For example, these correspond to integer-indexed resonance bands or specific locked-phase geometries of the outer binary.
