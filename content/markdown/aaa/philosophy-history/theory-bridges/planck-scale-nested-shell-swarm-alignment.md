...
- The CFT-exterior role label "outer binary $v < c_f$" remains valid away from the terminal/horizon regime (see the regime map in [Nested Shell Braid Dynamics](../../noether-swarm/nested-shell-swarm-dynamics.md)).
