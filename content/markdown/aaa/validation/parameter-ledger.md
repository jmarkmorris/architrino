...
| G1 | $R_{\text{inner}},R_{\text{middle}},R_{\text{outer}}$ | Geometric closure target | Open | characteristic radii of the nested binaries in the Noether braid | [Noether Braid](../noether-braid/noether-braid.md), [Nested Shell Braid Geometry](../noether-braid/nested-shell-braid-geometry.md), [Nested Shell Braid Dynamics](../noether-braid/nested-shell-braid-dynamics.md) |
