...
1. **The Detection Threshold**: If the absolute frame (the "Ether rest frame") is detectable by any physical experiment (e.g., Michelson-Morley) at a level higher than $\Delta c/c > 10^{-17}$, the theory fails.
