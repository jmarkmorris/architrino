...
- Even linear constant-delay DDEs rarely admit elementary closed forms; state-dependent delays are the technical obstacle to a general exact solution in this treatment. The fixed-center problem is a special case that collapses to an ODE (see [Radial Attraction](radial-attraction.md)).
