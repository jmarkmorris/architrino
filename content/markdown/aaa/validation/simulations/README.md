...
Use it as the top orientation document before reading the more specialized simulation protocols, convergence checks, action-energy notes, the [$A_0$ branch certificate protocol](a0-branch-certificate-protocol.md), the [$A_0$ Tier 0 result interpretation](a0-tier0-result-interpretation.md), the [Tri-Binary Action-Increment Protocol](tri-binary-action-increment-protocol.md), the [Cosmology Shared Residual Fit Protocol](cosmology-shared-residual-fit.md), and the [Redshift-Budget Toy Model](redshift-budget-toy-model.md).
