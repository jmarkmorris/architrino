...
- mass-map and action closure: [$A_0$ Branch Certificate Protocol](a0-branch-certificate-protocol.md), [$A_0$ Tier 0 Result-Schema Interpretation](a0-tier0-result-interpretation.md), [A1 Action-Increment Protocol](a1-action-increment-protocol.md), [Retuning-Map Toy Model](retuning-map-toy-model.md), and the [Action-Energy Model](action-energy/action-model.md) with its sibling derivation notes;
