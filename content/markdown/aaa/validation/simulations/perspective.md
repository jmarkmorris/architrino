...
## Assembly grammar -> A1 and flux tubes

- What we assume:
  - Binary orbits are the base motif; binaries can occupy widely separated radii; an A1 candidate is hypothesized to be dynamically robust.
