...
- [axially separated 4:2:1 reference Doubling-Frequency Resonance Lock](three-binary-4-2-1-frequency-lock.md#assumption-2-exact-integer-phase-closure) supplies the axially separated 4:2:1 reference integer phase-closure data whose return-map degree pair is recorded as $c_1=(m,n)$; coincident-midpoint 4:2:1 reference is its zero-axial-offset locus, and coincident-axis three-binary locus does not inherit that rank-three entry.
