...
The same coincident-midpoint orthogonal-axis three-binary configuration motion that may supply shielding is the geometric footprint a retained branch would sweep into a dynamic exclusion envelope. That envelope is not the braid definition itself; it is the candidate excluded-region readout of the coincident-midpoint orthogonal-axis three-binary configuration assembly. For the oblate spheroidal form, exclusion-envelope interpretation, and deformation channels, see [Braid Envelope Geometry](braid-envelope-geometry.md).
