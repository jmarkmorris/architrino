...
The accessory-dressing applications that pair this shielding ladder with the Thomson quietness ladder — the electron, quark, and neutrino readings — live with the featured realization in [Symmetric Shell Braid](symmetric-shell-braid.md#accessory-dressing-and-apparent-energy), with the mechanism itself stated in [Braid Mathematics](braid-mathematics.md#thomson-dressing-mechanism).
