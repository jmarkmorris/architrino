...
This chapter carries the mechanism only. Its applications — the electron, quark, and neutrino readings, the charge-quantum orbit counting, and the confinement-flavored composites — are realization hypotheses that live with the [accessory-dressing interpretation](braid-families.md#accessory-dressing-and-apparent-energy) at their stated claim levels.
