...
A first reading should follow the table order: the family ladder, its realization-independent requirements, and the shared mathematics first, then the spindle braid and the configuration space, with the export chapters as the interface layer. Search progress is not tracked in these chapters.
