...
Muon and tau states are treated as higher-excitation charged lepton assemblies that share the same broad charge pattern as the [electron](./electron.md) while differing in shielding, excitation, and dissociation-accessible relaxation channels. In the present architecture they are the heavier charged-lepton branches of the same shielding ladder used in [Noether Swarm](../../spacetime/noether-swarm.md) and [Particle Masses: Emergent Inertia in the Noether Sea](../particle-masses.md).
