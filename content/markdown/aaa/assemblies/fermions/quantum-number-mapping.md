...
The current geometric picture needs a reason that the personality layer prefers the poles rather than wandering arbitrarily around the Noether core. The most conservative working hypothesis is that each binary axis creates a **polar calm region**: a local saddle or relative minimum in the rapidly varying superposed potential generated by the surrounding orbital motion.
...
This gives a provisional dwelling mechanism for personality sites:
...
This remains a geometric hypothesis rather than a finished derivation. Its value is that it ties the six-site personality architecture to the already-existing delayed superposition picture, instead of treating the decoration sites as unexplained labels pasted onto the core.
