...
2.  **The Axial Layer (Decoration):** A layer of 6 axial architrinos occupying polar sites on the nucleus, defining the effective electric-charge bookkeeping, weak isospin, and color-sector pattern.
...
- and the polar saddle structure selects six metastable docking regions for the decoration layer.

This remains a geometric hypothesis rather than a finished derivation. Its value is that it ties the six-site axial architecture to the already-existing delayed superposition picture, instead of treating the decoration sites as unexplained labels pasted onto the core.
...
| Particle | Nucleus Type | Decoration (Axial Layer) | Net Charge ($e$) | Total Architrinos |
| :--- | :--- | :--- | :--- | :--- |
...
*   **Axial Layer:** 6 decorations (unchanged).
...
| :--- | :---: | :--- | :--- |
| **Electric Charge** | $Q$ | Coupling strength to the Photon ($\gamma$). | **Net Decoration Count.** Sum of Positrinos ($+e/6$) and Electrinos ($-e/6$) in the Axial Layer. $Q = \sum P - \sum E$. |
