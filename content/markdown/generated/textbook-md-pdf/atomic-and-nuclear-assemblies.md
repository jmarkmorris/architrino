...
<!-- Generated by scripts/build-textbook-md-pdf.mjs from content/graph/textbook_toc.json. -->
...
Its natural companion notes are [Nucleon Structure](../../aaa/nuclear-atomic/nucleon-structure.md), [Nuclear Binding](../../aaa/nuclear-atomic/nuclear-binding.md), [Electron](../../aaa/assemblies/fermions/electron.md), [Atomic Spectra](../../aaa/nuclear-atomic/atomic-spectra.md), and [Condensed Matter](../../aaa/nuclear-atomic/condensed-matter.md).
...
For the underlying assembly carrier of this medium, see [Noether Core](../../aaa/assemblies/noether-core.md).
...
This chapter fixes the current proton and neutron picture used by the nuclear branch. Its purpose is to make the coarse-grained baryon architecture explicit enough that later nuclear notes can treat nucleons as stable units without re-deriving the same assembly assumptions each time. It is the baryon-side bridge between [Quarks](../../aaa/assemblies/fermions/quarks.md), [Color Charge and SU(3)](../../aaa/assemblies/fermions/color-charge-su3.md), and [Transient Hadrons: Mesons and Δ Resonances](../../aaa/assemblies/mesons/mesons.md).
...
Each constituent quark is itself a Noether-core assembly with an axial layer of the kind cataloged in [quarks.md](../../aaa/assemblies/fermions/quarks.md).
...
The nucleon is not three independent quarks sitting side by side. It is a color-closed tri-core braid, with the strong-sector closure picture matching the corridor and flux descriptions in [Gluons and the Strong Force: Geometric Origins](../../aaa/assemblies/bosons/gluons.md).
...
That is why this chapter feeds directly into [nuclear-binding.md](../../aaa/nuclear-atomic/nuclear-binding.md) and [mesons.md](../../aaa/assemblies/mesons/mesons.md).
...
- [../assemblies/fermions/quarks.md](../../aaa/assemblies/fermions/quarks.md)
- [../assemblies/fermions/color-charge-su3.md](../../aaa/assemblies/fermions/color-charge-su3.md)
- [../assemblies/mesons/mesons.md](../../aaa/assemblies/mesons/mesons.md)
- [nuclear-binding.md](../../aaa/nuclear-atomic/nuclear-binding.md)
...
- [nucleon-structure.md](../../aaa/nuclear-atomic/nucleon-structure.md) defines the baryonic building blocks,
- [mesons.md](../../aaa/assemblies/mesons/mesons.md) defines the transient exchange packets,
- this chapter defines the effective multi-nucleon binding problem.

### Related Chapters

- [nucleon-structure.md](../../aaa/nuclear-atomic/nucleon-structure.md)
- [../assemblies/mesons/mesons.md](../../aaa/assemblies/mesons/mesons.md)
- [../assemblies/fermions/quarks.md](../../aaa/assemblies/fermions/quarks.md)
- [../assemblies/particle-masses.md](../../aaa/assemblies/particle-masses.md)
...
It should be read alongside [Atomic Structure](../../aaa/nuclear-atomic/atomic-structure.md), [Electron](../../aaa/assemblies/fermions/electron.md), [Condensed Matter](../../aaa/nuclear-atomic/condensed-matter.md), [Proper Time and Time Dilation](../../aaa/spacetime/proper-time-and-time-dilation.md), and [Atomic Transition Radiation](../../aaa/reactions/atomic-transition-radiation.md), since the spectral shifts proposed here depend on local assembly structure, the effective clock/rate layer, and the photon-channel event record.
...
This chapter owns the envelope gap and observer-level spectral comparison. The emission, absorption, recoil, non-radiative alternatives, and Gate C transition-rate record belong to [Atomic Transition Radiation](../../aaa/reactions/atomic-transition-radiation.md).
...
For the medium-level gravitational side of that program, see [Emergent Metric](../../aaa/spacetime/emergent-metric.md) and [Black Holes](../../aaa/spacetime/black-holes.md).
...
It should be connected to [Atomic Structure](../../aaa/nuclear-atomic/atomic-structure.md), [Atomic Spectra](../../aaa/nuclear-atomic/atomic-spectra.md), [Condensed Matter](../../aaa/nuclear-atomic/condensed-matter.md), and [Medium Exclusion Volume](../../aaa/spacetime/medium-exclusion-volume.md), which together supply the atomic constituents, resonance behavior, medium response, and exclusion geometry that molecular shapes must reconcile.

Spin and Pauli language in this chapter is downstream of [Angular Momentum and Spin](../../aaa/theory-bridges/angular-momentum-and-spin.md) and [Fermi-Dirac and Bose-Einstein Statistics](../../aaa/quantum/quantum-statistics.md). Molecular singlet/triplet labels, bonding selection rules, electron-pair exclusion, and orbital-hybridization language should be treated as validation targets for those lower proofs, not as separate explanations.
...
At the constituent level this points back to [Electron](../../aaa/assemblies/fermions/electron.md) and [Nucleon Structure](../../aaa/nuclear-atomic/nucleon-structure.md).
...
The immediate derivation target is therefore a corridor-plus-exclusion functional that predicts equilibrium bond length and angle for those cases while remaining compatible with [Atomic Spectra](../../aaa/nuclear-atomic/atomic-spectra.md), [Condensed Matter](../../aaa/nuclear-atomic/condensed-matter.md), and [Medium Exclusion Volume](../../aaa/spacetime/medium-exclusion-volume.md).
...
This note bridges [Atomic Structure](../../aaa/nuclear-atomic/atomic-structure.md), [Particle Masses](../../aaa/assemblies/particle-masses.md), [Spacetime Assemblies](../../aaa/spacetime/spacetime-assemblies.md), and [Medium Exclusion Volume](../../aaa/spacetime/medium-exclusion-volume.md), since all four depend on how the background medium stores stress and permits transport.
...
For the dynamical side of the transport threshold picture, see [Energy](../../aaa/dynamics/energy.md) and [Tri-Binary Dynamics](../../aaa/dynamics/tri-binary-dynamics.md).
